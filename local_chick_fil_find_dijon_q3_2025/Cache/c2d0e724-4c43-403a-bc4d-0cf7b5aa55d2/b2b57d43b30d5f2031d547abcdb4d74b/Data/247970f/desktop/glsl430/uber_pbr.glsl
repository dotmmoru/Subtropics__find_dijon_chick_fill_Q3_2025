...
//sampler sampler sc_RayTracedReflectionTextureSmpSC 0:46
...
//texture texture2D sc_RayTracedReflectionTexture 0:24:0:46
...
//texture texture2DArray sc_RayTracedReflectionTextureArrSC 0:67:0:46
...
//spec_const bool sc_ProxyAlphaOne 120 0
//spec_const bool sc_RayTracedDiffIndTextureHasSwappedViews 121 0
//spec_const bool sc_RayTracedReflectionTextureHasSwappedViews 122 0
//spec_const bool sc_RayTracedShadowTextureHasSwappedViews 123 0
...
//spec_const int sc_RayTracedReflectionTextureLayout 190 0
//spec_const int sc_RayTracedShadowTextureLayout 191 0
//spec_const int sc_RenderingSpace 192 -1
//spec_const int sc_ScreenTextureLayout 193 0
//spec_const int sc_ShaderCacheConstant 194 0
//spec_const int sc_SkinBonesCount 195 0
//spec_const int sc_StereoRenderingMode 196 0
//spec_const int sc_StereoRendering_IsClipDistanceEnabled 197 0
//spec_const int sc_StereoViewID 198 0
//SG_REFLECTION_END
...
{
l9_1=texture(sc_RayTracedReflectionTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_0,sc_RayTracedReflectionTextureLayout,sc_RayTracedReflectionTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_1=texture(sc_RayTracedReflectionTexture,sc_SamplingCoordsViewToGlobal(l9_0,sc_RayTracedReflectionTextureLayout,sc_RayTracedReflectionTextureGetStereoViewIndex()).xy,0.0);
}
#endif
return l9_1;
}
...
{
l9_70=texture(sc_RayTracedShadowTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_69,sc_RayTracedShadowTextureLayout,sc_RayTracedShadowTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_70=texture(sc_RayTracedShadowTexture,sc_SamplingCoordsViewToGlobal(l9_69,sc_RayTracedShadowTextureLayout,sc_RayTracedShadowTextureGetStereoViewIndex()).xy,0.0);
}
#endif
vec3 l9_71=vec3(1.0)-vec3(l9_70.x);
l9_68=l9_62*l9_71;
l9_67=l9_63*l9_71;
}
else
...
l9_86=mix(l9_72,l9_87.xyz,vec3(l9_87.w));
}
else
{
l9_86=l9_72;
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_112=clamp(pow(l9_8,0.66666669),0.0,1.0)*5.0;
vec2 l9_113=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_3,reflect(-l9_5,l9_3),l9_8),sc_EnvmapRotation.y);
vec4 l9_114;
#if (SC_DEVICE_CLASS>=2)
{
float l9_115=floor(l9_112);
float l9_116=ceil(l9_112);
l9_114=mix(sc_EnvmapSpecularSampleViewLevel(calcSeamlessPanoramicUvsForSampling(l9_113,sc_EnvmapSpecularSize.xy,l9_115),l9_115),sc_EnvmapSpecularSampleViewLevel(calcSeamlessPanoramicUvsForSampling(l9_113,sc_EnvmapSpecularSize.xy,l9_116),l9_116),vec4(l9_112-l9_115));
}
#else
{
l9_114=sc_EnvmapSpecularSampleViewLevel(l9_113,l9_112);
}
#endif
vec3 l9_117=((l9_114.xyz*(1.0/l9_114.w))*sc_EnvmapExposure)+vec3(1e-06);
vec3 l9_118;
if (receivesRayTracedReflections)
{
vec4 l9_119=sampleRayTracedReflections();
l9_118=mix(l9_117,l9_119.xyz,vec3(l9_119.w));
}
else
{
l9_118=l9_117;
}
l9_111=vec3(0.0)+(l9_118*envBRDFApprox(l9_15,abs(dot(l9_3,l9_5))));
}
#else
{
l9_111=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_121=clamp(l9_8*l9_8,0.0099999998,1.0);
vec3 l9_122;
l9_122=sc_LightEstimationData.ambientLight*l9_13;
int l9_123=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_123<sc_LightEstimationSGCount)
{
float l9_124=l9_121*l9_121;
vec3 l9_125=reflect(-l9_5,l9_3);
float l9_126=dot(l9_3,l9_5);
float l9_127=(2.0/l9_124)/(4.0*max(l9_126,9.9999997e-05));
float l9_128=length((l9_125*l9_127)+(sc_LightEstimationData.sg[l9_123].axis*sc_LightEstimationData.sg[l9_123].sharpness));
float l9_129=clamp(dot(l9_3,l9_125),0.0,1.0);
float l9_130=clamp(l9_126,0.0,1.0);
float l9_131=1.0-l9_124;
l9_122+=((((((((vec3(1.0/(3.1415927*l9_124))*exp((l9_128-l9_127)-sc_LightEstimationData.sg[l9_123].sharpness))*sc_LightEstimationData.sg[l9_123].color)*6.2831855)*(1.0-exp((-2.0)*l9_128)))/vec3(l9_128))*((1.0/(l9_129+sqrt(l9_124+((l9_131*l9_129)*l9_129))))*(1.0/(l9_130+sqrt(l9_124+((l9_131*l9_130)*l9_130))))))*(l9_13+((vec3(1.0)-l9_13)*pow(1.0-clamp(dot(l9_125,normalize(l9_125+l9_5)),0.0,1.0),5.0))))*l9_129);
l9_123++;
continue;
}
else
...
l9_135=vec3(0.0);
l9_134=vec3(0.0);
l9_133=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_14,vec3(l9_0));
l9_132=1.0;
}
#else
{
...
#endif
vec3 l9_137=l9_134*l9_11;
vec3 l9_138=l9_135+l9_137;
vec3 l9_139=l9_14*l9_138;
vec3 l9_140=l9_120*l9_10;
vec3 l9_141=l9_67+l9_140;
vec3 l9_142;
if (l9_136)
{
l9_142=l9_139*srgbToLinear(l9_132);
}
else
{
l9_142=l9_139;
}
vec3 l9_143=l9_142+l9_141;
vec3 l9_144=(l9_143+l9_6)+l9_133;
float l9_145=l9_144.x;
vec4 l9_146=vec4(l9_145,l9_144.yz,l9_132);
vec4 l9_147;
#if (sc_IsEditor)
{
vec4 l9_148=l9_146;
l9_148.x=l9_145+((l9_11.x*l9_10.x)*9.9999997e-06);
l9_147=l9_148;
}
#else
{
...
{
vec3 l9_150=l9_147.xyz*1.8;
vec3 l9_151=(l9_147.xyz*(l9_150+vec3(1.4)))/((l9_147.xyz*(l9_150+vec3(0.5)))+vec3(1.5));
l9_149=vec4(l9_151.x,l9_151.y,l9_151.z,l9_147.w);
}
#else
{
l9_149=l9_147;
...
#endif
vec3 l9_152=vec3(linearToSrgb(l9_149.x),linearToSrgb(l9_149.y),linearToSrgb(l9_149.z));
return vec4(l9_152.x,l9_152.y,l9_152.z,l9_149.w);
}
...
vec4 l9_540=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_538,vec4(0.0)));
vec4 l9_541=clamp(l9_540,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_542=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_542-0.0039215689)),min(1.0,l9_542+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_543=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_543).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_544=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_543).xy);
float l9_545=packValue(l9_544);
int l9_552=int(l9_541.w*255.0);
float l9_553=packValue(l9_552);
sc_writeFragData0Internal(vec4(packValue(l9_544),packValue(l9_544),packValue(l9_544),packValue(l9_544)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_545,packValue(l9_544),packValue(l9_544),packValue(l9_544)));
sc_writeFragData2(vec4(l9_553,packValue(l9_552),packValue(l9_552),packValue(l9_552)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_556=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_556).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_561==0)
{
l9_564=texture(sc_OITAlpha0,l9_556);
l9_563=texture(sc_OITDepthLow0,l9_556);
l9_562=texture(sc_OITDepthHigh0,l9_556);
}
else
{
l9_564=vec4(0.0);
...
if (l9_561==1)
{
l9_567=texture(sc_OITAlpha1,l9_556);
l9_566=texture(sc_OITDepthLow1,l9_556);
l9_565=texture(sc_OITDepthHigh1,l9_556);
}
else
{
l9_567=l9_564;
...
if (any(notEqual(l9_565,vec4(0.0)))||any(notEqual(l9_566,vec4(0.0))))
{
int l9_568[8]=l9_557;
unpackValues(l9_565.w,l9_561,l9_568);
unpackValues(l9_565.z,l9_561,l9_568);
unpackValues(l9_565.y,l9_561,l9_568);
unpackValues(l9_565.x,l9_561,l9_568);
unpackValues(l9_566.w,l9_561,l9_568);
unpackValues(l9_566.z,l9_561,l9_568);
unpackValues(l9_566.y,l9_561,l9_568);
unpackValues(l9_566.x,l9_561,l9_568);
int l9_577[8]=l9_558;
unpackValues(l9_567.w,l9_561,l9_577);
unpackValues(l9_567.z,l9_561,l9_577);
unpackValues(l9_567.y,l9_561,l9_577);
unpackValues(l9_567.x,l9_561,l9_577);
}
l9_561++;
continue;
}
...
vec4 l9_582=texture(sc_OITFilteredDepthBoundsTexture,l9_556);
vec2 l9_583=l9_582.xy;
int l9_584;
#if (sc_SkinBonesCount>0)
{
l9_584=encodeDepth(((1.0-l9_582.x)*1000.0)+getDepthOrderingEpsilon(),l9_583);
}
#else
{
l9_584=0;
...
#endif
int l9_585=encodeDepth(viewSpaceDepth(),l9_583);
vec4 l9_586;
l9_586=l9_541*l9_541.w;
vec4 l9_587;
int l9_588=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_588<8)
{
int l9_589=l9_557[l9_588];
int l9_590=l9_585-l9_584;
bool l9_591=l9_589<l9_590;
bool l9_592;
if (l9_591)
{
l9_592=l9_557[l9_588]>0;
}
else
{
l9_592=l9_591;
...
if (l9_592)
{
vec3 l9_593=l9_586.xyz*(1.0-(float(l9_558[l9_588])/255.0));
l9_587=vec4(l9_593.x,l9_593.y,l9_593.z,l9_586.w);
}
else
{
l9_587=l9_586;
...
sc_writeFragData0Internal(l9_586,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_541,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
