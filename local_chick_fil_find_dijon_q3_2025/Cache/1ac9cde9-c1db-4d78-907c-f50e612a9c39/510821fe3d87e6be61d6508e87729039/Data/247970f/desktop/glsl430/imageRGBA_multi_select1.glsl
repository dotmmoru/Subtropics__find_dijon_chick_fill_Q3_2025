...
{
vec4 l9_11;
Node59_If_else(0.0,vec4(0.0),vec4(0.0),l9_11,l9_2);
vec3 l9_12=vec3(l9_11.w);
vec4 l9_13=vec4(l9_12.x,l9_12.y,l9_12.z,vec4(0.0).w);
l9_13.w=Port_Value2_N013;
l9_10=l9_13;
}
else
{
...
{
vec4 l9_15;
Node59_If_else(0.0,vec4(0.0),vec4(0.0),l9_15,l9_2);
float l9_16;
if ((float(l9_3==Port_Input1_N035)*1.0)!=0.0)
{
l9_16=Port_Value1_N036;
}
else
{
vec4 l9_17;
Node59_If_else(0.0,vec4(0.0),vec4(0.0),l9_17,l9_2);
l9_16=l9_17.w;
}
l9_14=vec4(l9_4*l9_15.x,l9_5*l9_15.y,l9_15.z*l9_6,l9_16);
}
else
{
vec4 l9_18;
...
{
vec4 l9_20;
Node59_If_else(0.0,vec4(0.0),vec4(0.0),l9_20,l9_2);
float l9_21;
Node43_If_else(0.0,Port_Value1_N043,0.0,l9_21,l9_2);
l9_19=vec4(l9_20.xxx,l9_21);
}
else
{
vec4 l9_22;
...
{
vec4 l9_23;
Node59_If_else(0.0,vec4(0.0),vec4(0.0),l9_23,l9_2);
float l9_24;
Node43_If_else(0.0,Port_Value1_N043,0.0,l9_24,l9_2);
l9_22=vec4(l9_23.yyy,l9_24);
}
else
{
vec4 l9_25;
...
{
vec4 l9_26;
Node59_If_else(0.0,vec4(0.0),vec4(0.0),l9_26,l9_2);
float l9_27;
Node43_If_else(0.0,Port_Value1_N043,0.0,l9_27,l9_2);
l9_25=vec4(l9_26.zzz,l9_27);
}
else
{
l9_25=Port_Default_N055;
}
l9_22=l9_25;
}
l9_19=l9_22;
...
#endif
sc_writeFragData0Internal(max(l9_28,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_30;
...
{
l9_32=clamp(l9_10.w*2.0,0.0,1.0);
}
#else
{
float l9_33;
...
{
l9_33=clamp(dot(l9_10.xyz,vec3(l9_10.w)),0.0,1.0);
}
#else
{
float l9_34;
...
{
l9_35=(1.0-dot(l9_10.xyz,vec3(0.33333001)))*l9_10.w;
}
#else
{
float l9_36;
...
{
l9_36=(1.0-clamp(dot(l9_10.xyz,vec3(1.0)),0.0,1.0))*l9_10.w;
}
#else
{
float l9_37;
...
{
l9_37=clamp(dot(l9_10.xyz,vec3(1.0)),0.0,1.0)*l9_10.w;
}
#else
{
float l9_38;
#if (sc_BlendMode_Add)
{
l9_38=clamp(dot(l9_10.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_39;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_39=clamp(dot(l9_10.xyz,vec3(1.0)),0.0,1.0)*l9_10.w;
}
#else
{
float l9_40;
...
{
l9_40=dot(l9_10.xyz,vec3(0.33333001))*l9_10.w;
}
#else
{
float l9_41;
#if (sc_BlendMode_Min)
{
l9_41=1.0-clamp(dot(l9_10.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_42;
#if (sc_BlendMode_Max)
{
l9_42=clamp(dot(l9_10.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_42=1.0;
...
#endif
l9_30=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_10.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_31);
}
#else
{
vec4 l9_43;
...
{
l9_47=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_46,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_47=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_46,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_45=l9_47;
}
#endif
vec3 l9_48=mix(l9_45.xyz,definedBlend(l9_45.xyz,l9_10.xyz).xyz,vec3(l9_10.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_50=vec4(mix(vec3(1.0),l9_10.xyz,vec3(l9_10.w)),l9_10.w);
}
#else
{
vec4 l9_51;
...
#endif
l9_51=vec4(l9_10.xyz*l9_52,l9_52);
}
#else
{
l9_51=l9_10;
...
vec4 l9_55=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_53,vec4(0.0)));
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_57-0.0039215689)),min(1.0,l9_57+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_59),packValue(l9_59),packValue(l9_59),packValue(l9_59)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
sc_writeFragData0Internal(l9_56,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_55,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
