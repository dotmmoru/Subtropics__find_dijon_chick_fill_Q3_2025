...
//spec_const bool sc_ProxyAlphaOne 94 0
//spec_const bool sc_RayTracedDiffIndTextureHasSwappedViews 95 0
//spec_const bool sc_RayTracedShadowTextureHasSwappedViews 96 0
...
//spec_const int sc_PointLightsCount 140 0
//spec_const int sc_RayTracedDiffIndTextureLayout 141 0
//spec_const int sc_RayTracedShadowTextureLayout 142 0
...
vec3 l9_6=cross(l9_5,l9_4)*varTangent.w;
ssGlobals l9_7=ssGlobals(sc_Time.x,sc_Time.y,0.0,vec3(0.0),l9_0,varPos,varColor,varPackedTex.xy,varPackedTex.zw,l9_2,l9_4,l9_5,l9_6);
#if (NODE_38_DROPLIST_ITEM==1)
{
vec3 l9_8;
Node80_If_else(0.0,vec3(0.0),vec3(0.0),l9_8,l9_7);
}
#else
{
vec3 l9_9;
Node80_If_else(0.0,vec3(0.0),vec3(0.0),l9_9,l9_7);
}
#endif
vec4 param_3;
Node369_If_else(0.0,vec4(0.0),Port_Default_N369,param_3,l9_7);
vec4 l9_10=param_3;
float l9_11;
...
{
vec2 l9_15;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_15,l9_7);
l9_14=l9_15;
}
#else
{
...
{
vec2 l9_17;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_17,l9_7);
l9_16=l9_17;
}
#else
{
...
{
bool l9_19=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_20=l9_12.x;
...
float l9_35=l9_34.x;
float l9_36=l9_25;
sc_SoftwareWrapLate(l9_35,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_19,l9_36);
float l9_37=l9_34.y;
float l9_38=l9_36;
sc_SoftwareWrapLate(l9_37,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_19,l9_38);
float l9_39=l9_38;
...
#else
{
bool l9_43=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_44=l9_12.x;
...
float l9_59=l9_58.x;
float l9_60=l9_49;
sc_SoftwareWrapLate(l9_59,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_43,l9_60);
float l9_61=l9_58.y;
float l9_62=l9_60;
sc_SoftwareWrapLate(l9_61,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_43,l9_62);
float l9_63=l9_62;
...
#endif
float l9_68=(baseColor*l9_10).w*l9_11;
...
{
vec2 l9_74;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_74,l9_7);
l9_73=l9_74;
}
#else
{
...
{
vec2 l9_76;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_76,l9_7);
l9_75=l9_76;
}
#else
{
l9_75=varPackedTex.xy;
}
#endif
l9_73=l9_75;
}
...
{
bool l9_78=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0));
float l9_79=l9_71.x;
sc_SoftwareWrapEarly(l9_79,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x);
float l9_80=l9_79;
float l9_81=l9_71.y;
sc_SoftwareWrapEarly(l9_81,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y);
float l9_82=l9_81;
vec2 l9_83;
float l9_84;
...
{
l9_85=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x==3;
}
#else
{
...
float l9_86=l9_80;
float l9_87=1.0;
sc_ClampUV(l9_86,normalTexUvMinMax.x,normalTexUvMinMax.z,l9_85,l9_87);
float l9_88=l9_86;
float l9_89=l9_87;
bool l9_90;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_90=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y==3;
}
#else
{
l9_90=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_91=l9_82;
float l9_92=l9_89;
sc_ClampUV(l9_91,normalTexUvMinMax.y,normalTexUvMinMax.w,l9_90,l9_92);
l9_84=l9_92;
...
#endif
vec2 l9_93=sc_TransformUV(l9_83,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform);
float l9_94=l9_93.x;
float l9_95=l9_84;
sc_SoftwareWrapLate(l9_94,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x,l9_78,l9_95);
float l9_96=l9_93.y;
float l9_97=l9_95;
sc_SoftwareWrapLate(l9_96,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y,l9_78,l9_97);
float l9_98=l9_97;
vec3 l9_99=sc_SamplingCoordsViewToGlobal(vec2(l9_94,l9_96),normalTexLayout,normalTexGetStereoViewIndex());
vec4 l9_100=texture(normalTexArrSC,l9_99,0.0);
vec4 l9_101;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_101=mix(normalTexBorderColor,l9_100,vec4(l9_98));
}
#else
{
l9_101=l9_100;
...
#else
{
bool l9_102=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0));
float l9_103=l9_71.x;
sc_SoftwareWrapEarly(l9_103,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x);
float l9_104=l9_103;
float l9_105=l9_71.y;
sc_SoftwareWrapEarly(l9_105,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y);
float l9_106=l9_105;
vec2 l9_107;
float l9_108;
#if (SC_USE_UV_MIN_MAX_normalTex)
...
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_109=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x==3;
}
#else
{
l9_109=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_110=l9_104;
float l9_111=1.0;
sc_ClampUV(l9_110,normalTexUvMinMax.x,normalTexUvMinMax.z,l9_109,l9_111);
float l9_112=l9_110;
float l9_113=l9_111;
bool l9_114;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_114=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y==3;
}
#else
{
l9_114=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_115=l9_106;
float l9_116=l9_113;
sc_ClampUV(l9_115,normalTexUvMinMax.y,normalTexUvMinMax.w,l9_114,l9_116);
l9_108=l9_116;
...
#endif
vec2 l9_117=sc_TransformUV(l9_107,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform);
float l9_118=l9_117.x;
float l9_119=l9_108;
sc_SoftwareWrapLate(l9_118,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x,l9_102,l9_119);
float l9_120=l9_117.y;
float l9_121=l9_119;
sc_SoftwareWrapLate(l9_120,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y,l9_102,l9_121);
float l9_122=l9_121;
vec3 l9_123=sc_SamplingCoordsViewToGlobal(vec2(l9_118,l9_120),normalTexLayout,normalTexGetStereoViewIndex());
vec4 l9_124=texture(normalTex,l9_123.xy,0.0);
vec4 l9_125;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_125=mix(normalTexBorderColor,l9_124,vec4(l9_122));
}
#else
{
l9_125=l9_124;
...
{
vec2 l9_130;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_130,l9_7);
l9_129=l9_130;
}
#else
{
...
{
vec2 l9_132;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_132,l9_7);
l9_131=l9_132;
}
#else
{
l9_131=varPackedTex.xy;
}
#endif
l9_129=l9_131;
}
...
{
bool l9_134=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_detailNormalTex)!=0));
float l9_135=l9_127.x;
sc_SoftwareWrapEarly(l9_135,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x);
float l9_136=l9_135;
float l9_137=l9_127.y;
sc_SoftwareWrapEarly(l9_137,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y);
float l9_138=l9_137;
vec2 l9_139;
float l9_140;
...
{
l9_141=ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x==3;
}
#else
{
l9_141=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0);
}
#endif
float l9_142=l9_136;
float l9_143=1.0;
sc_ClampUV(l9_142,detailNormalTexUvMinMax.x,detailNormalTexUvMinMax.z,l9_141,l9_143);
float l9_144=l9_142;
float l9_145=l9_143;
bool l9_146;
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_146=ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y==3;
}
#else
{
l9_146=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0);
}
#endif
float l9_147=l9_138;
float l9_148=l9_145;
sc_ClampUV(l9_147,detailNormalTexUvMinMax.y,detailNormalTexUvMinMax.w,l9_146,l9_148);
l9_140=l9_148;
...
#endif
vec2 l9_149=sc_TransformUV(l9_139,(int(SC_USE_UV_TRANSFORM_detailNormalTex)!=0),detailNormalTexTransform);
float l9_150=l9_149.x;
float l9_151=l9_140;
sc_SoftwareWrapLate(l9_150,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x,l9_134,l9_151);
float l9_152=l9_149.y;
float l9_153=l9_151;
sc_SoftwareWrapLate(l9_152,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y,l9_134,l9_153);
float l9_154=l9_153;
vec3 l9_155=sc_SamplingCoordsViewToGlobal(vec2(l9_150,l9_152),detailNormalTexLayout,detailNormalTexGetStereoViewIndex());
vec4 l9_156=texture(detailNormalTexArrSC,l9_155,0.0);
vec4 l9_157;
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_157=mix(detailNormalTexBorderColor,l9_156,vec4(l9_154));
}
#else
{
l9_157=l9_156;
...
#else
{
bool l9_158=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_detailNormalTex)!=0));
float l9_159=l9_127.x;
sc_SoftwareWrapEarly(l9_159,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x);
float l9_160=l9_159;
float l9_161=l9_127.y;
sc_SoftwareWrapEarly(l9_161,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y);
float l9_162=l9_161;
vec2 l9_163;
float l9_164;
#if (SC_USE_UV_MIN_MAX_detailNormalTex)
...
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_165=ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x==3;
}
#else
{
l9_165=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0);
}
#endif
float l9_166=l9_160;
float l9_167=1.0;
sc_ClampUV(l9_166,detailNormalTexUvMinMax.x,detailNormalTexUvMinMax.z,l9_165,l9_167);
float l9_168=l9_166;
float l9_169=l9_167;
bool l9_170;
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_170=ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y==3;
}
#else
{
l9_170=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0);
}
#endif
float l9_171=l9_162;
float l9_172=l9_169;
sc_ClampUV(l9_171,detailNormalTexUvMinMax.y,detailNormalTexUvMinMax.w,l9_170,l9_172);
l9_164=l9_172;
...
#endif
vec2 l9_173=sc_TransformUV(l9_163,(int(SC_USE_UV_TRANSFORM_detailNormalTex)!=0),detailNormalTexTransform);
float l9_174=l9_173.x;
float l9_175=l9_164;
sc_SoftwareWrapLate(l9_174,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x,l9_158,l9_175);
float l9_176=l9_173.y;
float l9_177=l9_175;
sc_SoftwareWrapLate(l9_176,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y,l9_158,l9_177);
float l9_178=l9_177;
vec3 l9_179=sc_SamplingCoordsViewToGlobal(vec2(l9_174,l9_176),detailNormalTexLayout,detailNormalTexGetStereoViewIndex());
vec4 l9_180=texture(detailNormalTex,l9_179.xy,0.0);
vec4 l9_181;
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_181=mix(detailNormalTexBorderColor,l9_180,vec4(l9_178));
}
#else
{
l9_181=l9_180;
...
#endif
l9_126=((l9_133.xyz*1.9921875)-vec3(1.0)).xyz;
}
#else
{
l9_126=Port_Default_N113;
}
#endif
vec3 l9_182=mix(vec3(0.0,0.0,1.0),((l9_77.xyz*1.9921875)-vec3(1.0)).xyz,vec3(Port_Strength1_N200))+vec3(0.0,0.0,1.0);
vec3 l9_183=mix(vec3(0.0,0.0,1.0),l9_126,vec3(Port_Strength2_N200));
vec3 l9_184=l9_183*vec3(-1.0,-1.0,1.0);
vec3 l9_185=mat3(l9_4,l9_6,l9_5)*normalize((l9_182*dot(l9_182,l9_184))-(l9_184*l9_182.z));
float l9_186=dot(l9_185,l9_185);
float l9_187;
if (l9_186>0.0)
{
l9_187=1.0/sqrt(l9_186);
}
else
{
l9_187=0.0;
...
#else
{
float l9_188=dot(l9_5,l9_5);
float l9_189;
if (l9_188>0.0)
{
l9_189=1.0/sqrt(l9_188);
}
else
{
l9_189=0.0;
...
#endif
float l9_191=clamp(l9_69,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
if (l9_191<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_191<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
#endif
if (dot(l9_0,l9_190)>=(-0.050000001))
{
uvec3 l9_192=uvec3(round((varPos-OriginNormalizationOffset)*OriginNormalizationScale));
position_and_mask=uvec4(l9_192.x,l9_192.y,l9_192.z,position_and_mask.w);
position_and_mask.w=uint(receiver_mask);
vec3 l9_193=abs(l9_190);
vec3 l9_194=l9_190/vec3(dot(l9_193,vec3(1.0)));
float l9_195=clamp(-l9_194.z,0.0,1.0);
float l9_196=l9_194.x;
float l9_197;
if (l9_196>=0.0)
{
l9_197=l9_195;
...
uvec2 l9_201=uvec2(packHalf2x16(vec2(l9_198,0.0)),packHalf2x16(vec2(l9_199+l9_200,0.0)));
normal_and_more=uvec4(l9_201.x,l9_201.y,normal_and_more.z,normal_and_more.w);
normal_and_more.z=packHalf2x16(vec2(0.0));
normal_and_more.w=uint(1.0*1000.0)|uint((receiverId%32)<<int(10u));
}
else
{
...
{
l9_1=texture(sc_RayTracedDiffIndTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_0,sc_RayTracedDiffIndTextureLayout,sc_RayTracedDiffIndTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_1=texture(sc_RayTracedDiffIndTexture,sc_SamplingCoordsViewToGlobal(l9_0,sc_RayTracedDiffIndTextureLayout,sc_RayTracedDiffIndTextureGetStereoViewIndex()).xy,0.0);
}
#endif
return l9_1;
}
...
{
l9_67=texture(sc_RayTracedShadowTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_66,sc_RayTracedShadowTextureLayout,sc_RayTracedShadowTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_67=texture(sc_RayTracedShadowTexture,sc_SamplingCoordsViewToGlobal(l9_66,sc_RayTracedShadowTextureLayout,sc_RayTracedShadowTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_65=l9_61*(vec3(1.0)-vec3(l9_67.x));
}
else
{
l9_65=l9_61;
...
if (receivesRayTracedDiffuseIndirect)
{
vec4 l9_87=sampleRayTracedIndirectDiffuse();
l9_86=mix(l9_68,l9_87.xyz,vec3(l9_87.w));
}
else
{
l9_86=l9_68;
...
{
l9_89=l9_86+(sc_AmbientLights[0].color*sc_AmbientLights[0].intensity);
}
#else
{
vec3 l9_90=l9_86;
l9_90.x=l9_86.x+(1e-06*sc_AmbientLights[0].color.x);
l9_89=l9_90;
}
#endif
l9_88=l9_89;
...
{
l9_92=l9_88+(sc_AmbientLights[1].color*sc_AmbientLights[1].intensity);
}
#else
{
vec3 l9_93=l9_88;
l9_93.x=l9_88.x+(1e-06*sc_AmbientLights[1].color.x);
l9_92=l9_93;
}
#endif
l9_91=l9_92;
...
{
l9_95=l9_91+(sc_AmbientLights[2].color*sc_AmbientLights[2].intensity);
}
#else
{
vec3 l9_96=l9_91;
l9_96.x=l9_91.x+(1e-06*sc_AmbientLights[2].color.x);
l9_95=l9_96;
}
#endif
l9_94=l9_95;
...
{
vec3 l9_98;
l9_98=sc_LightEstimationData.ambientLight;
vec3 l9_99;
int l9_100=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_100<sc_LightEstimationSGCount)
{
float l9_101=dot(sc_LightEstimationData.sg[l9_100].axis,l9_3);
float l9_102=exp(-sc_LightEstimationData.sg[l9_100].sharpness);
float l9_103=l9_102*l9_102;
float l9_104=1.0/sc_LightEstimationData.sg[l9_100].sharpness;
float l9_105=(1.0+(2.0*l9_103))-l9_104;
float l9_106=sqrt(1.0-l9_105);
float l9_107=0.36000001*l9_101;
float l9_108=(1.0/(4.0*0.36000001))*l9_106;
float l9_109=l9_107+l9_108;
float l9_110;
if (step(abs(l9_107),l9_108)>0.5)
{
l9_110=(l9_109*l9_109)/l9_106;
}
else
{
l9_110=clamp(l9_101,0.0,1.0);
}
l9_99=l9_98+((((sc_LightEstimationData.sg[l9_100].color/vec3(sc_LightEstimationData.sg[l9_100].sharpness))*6.2831855)*((l9_105*l9_110)+(((l9_102-l9_103)*l9_104)-l9_103)))/vec3(3.1415927));
l9_98=l9_99;
l9_100++;
continue;
}
...
l9_114=vec3(0.0);
l9_113=vec3(0.0);
l9_112=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_13,vec3(l9_0));
l9_111=1.0;
}
#else
{
...
#endif
vec3 l9_116=l9_113*l9_11;
vec3 l9_117=l9_114+l9_116;
vec3 l9_118=l9_13*l9_117;
vec3 l9_119=l9_38*l9_10;
vec3 l9_120;
if (l9_115)
{
l9_120=l9_118*srgbToLinear(l9_111);
}
else
{
l9_120=l9_118;
}
vec3 l9_121=l9_120+(vec3(0.0)+l9_119);
vec3 l9_122=(l9_121+l9_6)+l9_112;
float l9_123=l9_122.x;
vec4 l9_124=vec4(l9_123,l9_122.yz,l9_111);
vec4 l9_125;
#if (sc_IsEditor)
{
vec4 l9_126=l9_124;
l9_126.x=l9_123+((l9_11.x*l9_10.x)*9.9999997e-06);
l9_125=l9_126;
}
#else
{
...
{
vec3 l9_128=l9_125.xyz*1.8;
vec3 l9_129=(l9_125.xyz*(l9_128+vec3(1.4)))/((l9_125.xyz*(l9_128+vec3(0.5)))+vec3(1.5));
l9_127=vec4(l9_129.x,l9_129.y,l9_129.z,l9_125.w);
}
#else
{
l9_127=l9_125;
...
#endif
vec3 l9_130=vec3(linearToSrgb(l9_127.x),linearToSrgb(l9_127.y),linearToSrgb(l9_127.z));
return vec4(l9_130.x,l9_130.y,l9_130.z,l9_127.w);
}
...
ssGlobals l9_17=ssGlobals(sc_Time.x,sc_Time.y,0.0,vec3(0.0),l9_8,l9_7,l9_6,l9_5,l9_4,l9_3,l9_2,l9_1,l9_0);
vec4 l9_18;
#if (NODE_38_DROPLIST_ITEM==1)
{
vec3 l9_19;
...
{
vec2 l9_28;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_28,l9_17);
l9_27=l9_28;
}
#else
{
...
#if (ENABLE_NORMALMAP)
{
mat3 l9_82=mat3(l9_2,l9_0,l9_1);
vec2 l9_83;
#if (NODE_181_DROPLIST_ITEM==0)
{
l9_83=l9_5;
...
{
vec2 l9_86;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_86,l9_17);
l9_85=l9_86;
}
#else
{
...
{
vec2 l9_88;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_88,l9_17);
l9_87=l9_88;
}
#else
{
...
#if (normalTexLayout==2)
{
bool l9_90=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0));
float l9_91=l9_83.x;
...
float l9_107=l9_96;
sc_SoftwareWrapLate(l9_106,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x,l9_90,l9_107);
float l9_108=l9_105.y;
float l9_109=l9_107;
sc_SoftwareWrapLate(l9_108,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y,l9_90,l9_109);
float l9_110=l9_109;
...
vec4 l9_136=texture(normalTex,l9_135.xy,0.0);
vec4 l9_137;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
...
{
vec2 l9_142;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_142,l9_17);
l9_141=l9_142;
}
#else
{
...
{
vec2 l9_144;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_144,l9_17);
l9_143=l9_144;
}
#else
{
...
#if (detailNormalTexLayout==2)
{
bool l9_146=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_detailNormalTex)!=0));
float l9_147=l9_139.x;
sc_SoftwareWrapEarly(l9_147,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x);
float l9_148=l9_147;
float l9_149=l9_139.y;
sc_SoftwareWrapEarly(l9_149,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y);
float l9_150=l9_149;
vec2 l9_151;
float l9_152;
#if (SC_USE_UV_MIN_MAX_detailNormalTex)
...
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_153=ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x==3;
}
#else
{
l9_153=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0);
}
#endif
float l9_154=l9_148;
float l9_155=1.0;
sc_ClampUV(l9_154,detailNormalTexUvMinMax.x,detailNormalTexUvMinMax.z,l9_153,l9_155);
float l9_156=l9_154;
float l9_157=l9_155;
bool l9_158;
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_158=ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y==3;
}
#else
{
l9_158=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0);
}
#endif
float l9_159=l9_150;
float l9_160=l9_157;
sc_ClampUV(l9_159,detailNormalTexUvMinMax.y,detailNormalTexUvMinMax.w,l9_158,l9_160);
l9_152=l9_160;
l9_151=vec2(l9_156,l9_159);
}
#else
{
l9_152=1.0;
l9_151=vec2(l9_148,l9_150);
}
#endif
vec2 l9_161=sc_TransformUV(l9_151,(int(SC_USE_UV_TRANSFORM_detailNormalTex)!=0),detailNormalTexTransform);
float l9_162=l9_161.x;
float l9_163=l9_152;
sc_SoftwareWrapLate(l9_162,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x,l9_146,l9_163);
float l9_164=l9_161.y;
float l9_165=l9_163;
sc_SoftwareWrapLate(l9_164,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y,l9_146,l9_165);
float l9_166=l9_165;
vec3 l9_167=sc_SamplingCoordsViewToGlobal(vec2(l9_162,l9_164),detailNormalTexLayout,detailNormalTexGetStereoViewIndex());
vec4 l9_168=texture(detailNormalTexArrSC,l9_167,0.0);
vec4 l9_169;
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_169=mix(detailNormalTexBorderColor,l9_168,vec4(l9_166));
}
#else
{
l9_169=l9_168;
...
#else
{
bool l9_170=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_detailNormalTex)!=0));
float l9_171=l9_139.x;
sc_SoftwareWrapEarly(l9_171,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x);
float l9_172=l9_171;
float l9_173=l9_139.y;
sc_SoftwareWrapEarly(l9_173,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y);
float l9_174=l9_173;
vec2 l9_175;
float l9_176;
#if (SC_USE_UV_MIN_MAX_detailNormalTex)
...
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_177=ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x==3;
}
#else
{
...
float l9_178=l9_172;
float l9_179=1.0;
sc_ClampUV(l9_178,detailNormalTexUvMinMax.x,detailNormalTexUvMinMax.z,l9_177,l9_179);
float l9_180=l9_178;
float l9_181=l9_179;
bool l9_182;
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_182=ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y==3;
}
#else
{
l9_182=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0);
}
#endif
float l9_183=l9_174;
float l9_184=l9_181;
sc_ClampUV(l9_183,detailNormalTexUvMinMax.y,detailNormalTexUvMinMax.w,l9_182,l9_184);
l9_176=l9_184;
...
#endif
vec2 l9_185=sc_TransformUV(l9_175,(int(SC_USE_UV_TRANSFORM_detailNormalTex)!=0),detailNormalTexTransform);
float l9_186=l9_185.x;
float l9_187=l9_176;
sc_SoftwareWrapLate(l9_186,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x,l9_170,l9_187);
float l9_188=l9_185.y;
float l9_189=l9_187;
sc_SoftwareWrapLate(l9_188,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y,l9_170,l9_189);
float l9_190=l9_189;
vec3 l9_191=sc_SamplingCoordsViewToGlobal(vec2(l9_186,l9_188),detailNormalTexLayout,detailNormalTexGetStereoViewIndex());
vec4 l9_192=texture(detailNormalTex,l9_191.xy,0.0);
vec4 l9_193;
#if (SC_USE_CLAMP_TO_BORDER_detailNormalTex)
{
l9_193=mix(detailNormalTexBorderColor,l9_192,vec4(l9_190));
}
#else
{
l9_193=l9_192;
...
#endif
l9_138=((l9_145.xyz*1.9921875)-vec3(1.0)).xyz;
}
#else
{
l9_138=Port_Default_N113;
}
#endif
vec3 l9_194=mix(vec3(0.0,0.0,1.0),((l9_89.xyz*1.9921875)-vec3(1.0)).xyz,vec3(Port_Strength1_N200))+vec3(0.0,0.0,1.0);
vec3 l9_195=mix(vec3(0.0,0.0,1.0),l9_138,vec3(Port_Strength2_N200));
vec3 l9_196=l9_195*vec3(-1.0,-1.0,1.0);
vec3 l9_197=l9_82*normalize((l9_194*dot(l9_194,l9_196))-(l9_196*l9_194.z));
float l9_198=dot(l9_197,l9_197);
float l9_199;
if (l9_198>0.0)
{
l9_199=1.0/sqrt(l9_198);
}
else
{
l9_199=0.0;
...
#else
{
float l9_200=dot(l9_1,l9_1);
float l9_201;
if (l9_200>0.0)
{
l9_201=1.0/sqrt(l9_200);
}
else
{
l9_201=0.0;
...
#endif
float l9_203=clamp(l9_80,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
if (l9_203<alphaTestThreshold)
{
discard;
}
}
...
#if (ENABLE_STIPPLE_PATTERN_TEST)
{
if (l9_203<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
#endif
vec3 l9_204=max(l9_18.xyz,vec3(0.0));
vec4 l9_205;
#if (sc_ProjectiveShadowsCaster)
{
l9_205=vec4(l9_204,l9_203);
}
#else
{
l9_205=ngsCalculateLighting(l9_204,l9_203,l9_202,l9_7,l9_8,Port_Emissive_N036,0.0,1.0,Port_AO_N036,vec3(1.0));
}
#endif
vec4 l9_206=max(l9_205,vec4(0.0));
if (isProxyMode)
{
vec4 l9_207;
#if (sc_ProxyAlphaOne)
...
#endif
sc_writeFragData0Internal(max(l9_207,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_209;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_211=clamp(l9_206.w*2.0,0.0,1.0);
}
#else
{
float l9_212;
...
{
l9_212=clamp(dot(l9_206.xyz,vec3(l9_206.w)),0.0,1.0);
}
#else
{
float l9_213;
...
#if (sc_BlendMode_Multiply)
{
l9_214=(1.0-dot(l9_206.xyz,vec3(0.33333001)))*l9_206.w;
}
#else
{
float l9_215;
...
{
l9_215=(1.0-clamp(dot(l9_206.xyz,vec3(1.0)),0.0,1.0))*l9_206.w;
}
#else
{
float l9_216;
#if (sc_BlendMode_ColoredGlass)
{
l9_216=clamp(dot(l9_206.xyz,vec3(1.0)),0.0,1.0)*l9_206.w;
}
#else
{
float l9_217;
#if (sc_BlendMode_Add)
{
l9_217=clamp(dot(l9_206.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_218;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_218=clamp(dot(l9_206.xyz,vec3(1.0)),0.0,1.0)*l9_206.w;
}
#else
{
float l9_219;
...
{
l9_219=dot(l9_206.xyz,vec3(0.33333001))*l9_206.w;
}
#else
{
float l9_220;
#if (sc_BlendMode_Min)
{
l9_220=1.0-clamp(dot(l9_206.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_221;
#if (sc_BlendMode_Max)
{
l9_221=clamp(dot(l9_206.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_221=1.0;
...
#endif
l9_209=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_206.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_210);
}
#else
{
vec4 l9_222;
...
{
vec3 l9_224=sc_GetFramebufferColor().xyz;
vec3 l9_225=mix(l9_224,definedBlend(l9_224,l9_206.xyz).xyz,vec3(l9_206.w));
vec4 l9_226=vec4(l9_225.x,l9_225.y,l9_225.z,vec4(0.0).w);
l9_226.w=1.0;
l9_223=l9_226;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_228=l9_206.w;
l9_227=vec4(mix(vec3(1.0),l9_206.xyz,vec3(l9_228)),l9_228);
}
#else
{
vec4 l9_229;
...
{
float l9_230=l9_206.w;
float l9_231;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_231=clamp(l9_230,0.0,1.0);
}
#else
{
l9_231=l9_230;
...
#endif
l9_229=vec4(l9_206.xyz*l9_231,l9_231);
}
#else
{
l9_229=l9_206;
...
vec4 l9_234=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_232,vec4(0.0)));
vec4 l9_235=clamp(l9_234,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_236=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_236-0.0039215689)),min(1.0,l9_236+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_237).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_238=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_237).xy);
float l9_239=packValue(l9_238);
int l9_246=int(l9_235.w*255.0);
float l9_247=packValue(l9_246);
sc_writeFragData0Internal(vec4(packValue(l9_238),packValue(l9_238),packValue(l9_238),packValue(l9_238)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_239,packValue(l9_238),packValue(l9_238),packValue(l9_238)));
sc_writeFragData2(vec4(l9_247,packValue(l9_246),packValue(l9_246),packValue(l9_246)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_250=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_250).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_255==0)
{
l9_258=texture(sc_OITAlpha0,l9_250);
l9_257=texture(sc_OITDepthLow0,l9_250);
l9_256=texture(sc_OITDepthHigh0,l9_250);
}
else
{
l9_258=vec4(0.0);
...
if (l9_255==1)
{
l9_261=texture(sc_OITAlpha1,l9_250);
l9_260=texture(sc_OITDepthLow1,l9_250);
l9_259=texture(sc_OITDepthHigh1,l9_250);
}
else
{
l9_261=l9_258;
...
if (any(notEqual(l9_259,vec4(0.0)))||any(notEqual(l9_260,vec4(0.0))))
{
int l9_262[8]=l9_251;
unpackValues(l9_259.w,l9_255,l9_262);
unpackValues(l9_259.z,l9_255,l9_262);
unpackValues(l9_259.y,l9_255,l9_262);
unpackValues(l9_259.x,l9_255,l9_262);
unpackValues(l9_260.w,l9_255,l9_262);
unpackValues(l9_260.z,l9_255,l9_262);
unpackValues(l9_260.y,l9_255,l9_262);
unpackValues(l9_260.x,l9_255,l9_262);
int l9_271[8]=l9_252;
unpackValues(l9_261.w,l9_255,l9_271);
unpackValues(l9_261.z,l9_255,l9_271);
unpackValues(l9_261.y,l9_255,l9_271);
unpackValues(l9_261.x,l9_255,l9_271);
}
l9_255++;
continue;
}
...
vec4 l9_276=texture(sc_OITFilteredDepthBoundsTexture,l9_250);
vec2 l9_277=l9_276.xy;
int l9_278;
#if (sc_SkinBonesCount>0)
{
l9_278=encodeDepth(((1.0-l9_276.x)*1000.0)+getDepthOrderingEpsilon(),l9_277);
}
#else
{
l9_278=0;
...
#endif
int l9_279=encodeDepth(viewSpaceDepth(),l9_277);
vec4 l9_280;
l9_280=l9_235*l9_235.w;
vec4 l9_281;
int l9_282=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_282<8)
{
int l9_283=l9_251[l9_282];
int l9_284=l9_279-l9_278;
bool l9_285=l9_283<l9_284;
bool l9_286;
if (l9_285)
{
l9_286=l9_251[l9_282]>0;
}
else
{
l9_286=l9_285;
...
if (l9_286)
{
vec3 l9_287=l9_280.xyz*(1.0-(float(l9_252[l9_282])/255.0));
l9_281=vec4(l9_287.x,l9_287.y,l9_287.z,l9_280.w);
}
else
{
l9_281=l9_280;
...
sc_writeFragData0Internal(l9_280,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_235,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_234,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
