...
//spec_const int sc_StereoViewID 144 0
//SG_REFLECTION_END
...
{
vec2 l9_15;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_15,l9_6);
l9_14=l9_15;
}
#else
{
...
{
vec2 l9_17;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_17,l9_6);
l9_16=l9_17;
}
#else
{
...
float l9_39=l9_38;
vec3 l9_40=sc_SamplingCoordsViewToGlobal(vec2(l9_35,l9_37),opacityTexLayout,l9_18);
vec4 l9_41=texture2D(opacityTex,l9_40.xy,0.0);
vec4 l9_42;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
...
#else
{
l9_43=Port_Input2_N072;
}
#endif
float l9_44=(baseColor*l9_10).w*l9_11;
float l9_45=l9_44*l9_43;
vec3 l9_46;
#if (ENABLE_NORMALMAP)
{
vec2 l9_47;
...
{
vec2 l9_50;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_50,l9_6);
l9_49=l9_50;
}
#else
{
...
{
vec2 l9_52;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_52,l9_6);
l9_51=l9_52;
}
#else
{
l9_51=varPackedTex.xy;
}
#endif
l9_49=l9_51;
}
...
#endif
bool l9_54=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0));
float l9_55=l9_47.x;
sc_SoftwareWrapEarly(l9_55,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x);
float l9_56=l9_55;
float l9_57=l9_47.y;
sc_SoftwareWrapEarly(l9_57,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y);
float l9_58=l9_57;
vec2 l9_59;
float l9_60;
...
{
l9_61=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x==3;
}
#else
{
l9_61=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_62=l9_56;
float l9_63=1.0;
sc_ClampUV(l9_62,normalTexUvMinMax.x,normalTexUvMinMax.z,l9_61,l9_63);
float l9_64=l9_62;
float l9_65=l9_63;
bool l9_66;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_66=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y==3;
}
#else
{
l9_66=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_67=l9_58;
float l9_68=l9_65;
sc_ClampUV(l9_67,normalTexUvMinMax.y,normalTexUvMinMax.w,l9_66,l9_68);
l9_60=l9_68;
...
#endif
vec2 l9_69=sc_TransformUV(l9_59,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform);
float l9_70=l9_69.x;
float l9_71=l9_60;
sc_SoftwareWrapLate(l9_70,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x,l9_54,l9_71);
float l9_72=l9_69.y;
float l9_73=l9_71;
sc_SoftwareWrapLate(l9_72,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y,l9_54,l9_73);
float l9_74=l9_73;
vec3 l9_75=sc_SamplingCoordsViewToGlobal(vec2(l9_70,l9_72),normalTexLayout,l9_53);
vec4 l9_76=texture2D(normalTex,l9_75.xy,0.0);
vec4 l9_77;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_77=mix(normalTexBorderColor,l9_76,vec4(l9_74));
}
#else
{
l9_77=l9_76;
...
{
vec2 l9_82;
Node1_If_else(0.0,vec2(0.0),vec2(0.0),l9_82,l9_6);
l9_81=l9_82;
}
#else
{
...
{
vec2 l9_84;
Node24_If_else(0.0,vec2(0.0),vec2(0.0),l9_84,l9_6);
l9_83=l9_84;
}
#else
{
l9_83=varPackedTex.xy;
}
#endif
l9_81=l9_83;
}
...
#endif
bool l9_86=(int(SC_USE_CLAMP_TO_BORDER_detailNormalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_detailNormalTex)!=0));
float l9_87=l9_79.x;
...
float l9_103=l9_92;
sc_SoftwareWrapLate(l9_102,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).x,l9_86,l9_103);
float l9_104=l9_101.y;
float l9_105=l9_103;
sc_SoftwareWrapLate(l9_104,ivec2(SC_SOFTWARE_WRAP_MODE_U_detailNormalTex,SC_SOFTWARE_WRAP_MODE_V_detailNormalTex).y,l9_86,l9_105);
float l9_106=l9_105;
vec3 l9_107=sc_SamplingCoordsViewToGlobal(vec2(l9_102,l9_104),detailNormalTexLayout,l9_85);
...
#endif
l9_78=((l9_109.xyz*1.9921875)-vec3(1.0)).xyz;
}
#else
{
l9_78=Port_Default_N113;
}
#endif
vec3 l9_110=mix(vec3(0.0,0.0,1.0),((l9_77.xyz*1.9921875)-vec3(1.0)).xyz,vec3(Port_Strength1_N200))+vec3(0.0,0.0,1.0);
vec3 l9_111=mix(vec3(0.0,0.0,1.0),l9_78,vec3(Port_Strength2_N200));
vec3 l9_112=l9_111*vec3(-1.0,-1.0,1.0);
vec3 l9_113=mat3(l9_3,l9_5,l9_4)*normalize((l9_110*dot(l9_110,l9_112))-(l9_112*l9_110.z));
...
#endif
float l9_119=clamp(l9_45,0.0,1.0);
...
#endif
vec3 l9_120=max(l9_7.xyz,vec3(0.0));
vec4 l9_121;
#if (sc_ProjectiveShadowsCaster)
{
...
SurfaceProperties l9_127=SurfaceProperties(l9_126,l9_119,l9_123,varPos,l9_0,0.0,1.0,l9_124,l9_125,vec3(1.0),vec3(1.0),vec3(0.039999999));
...
{
LightingComponents l9_148=accumulateLight(LightingComponents(l9_136,l9_137,l9_142,l9_140,l9_139,l9_138),LightProperties(sc_DirectionalLights[l9_147].direction,sc_DirectionalLights[l9_147].color.xyz,sc_DirectionalLights[l9_147].color.w*l9_128[(l9_141<3) ? l9_141 : 3]),l9_127,l9_0);
...
l9_158=l9_166+1;
LightingComponents l9_173=accumulateLight(LightingComponents(l9_152,l9_153,l9_157,l9_156,l9_155,l9_154),LightProperties(l9_168,sc_PointLights[l9_165].color.xyz,l9_172),l9_127,l9_0);
...
#endif
l9_184=texture2D(sc_EnvmapSpecular,sc_SamplingCoordsViewToGlobal(l9_185,sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex()).xy,13.0);
}
#else
{
vec4 l9_186;
...
#else
{
l9_186=texture2D(sc_EnvmapSpecular,sc_SamplingCoordsViewToGlobal(l9_183,sc_EnvmapSpecularLayout,sc_EnvmapSpecularGetStereoViewIndex()).xy,13.0);
}
#endif
l9_184=l9_186;
}
...
vec4 l9_263=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_261,vec4(0.0)));
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_266=sc_ScreenCoordsGlobalToView(l9_1);
...
#if (sc_OITCompositingPass)
{
vec2 l9_279=sc_ScreenCoordsGlobalToView(l9_1);
#if (sc_OITMaxLayers4Plus1)
{
