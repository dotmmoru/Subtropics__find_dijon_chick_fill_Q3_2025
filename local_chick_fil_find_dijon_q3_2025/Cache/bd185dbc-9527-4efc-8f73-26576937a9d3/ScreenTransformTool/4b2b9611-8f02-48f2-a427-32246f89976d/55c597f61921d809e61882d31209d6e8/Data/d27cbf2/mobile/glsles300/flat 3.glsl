...
#if (baseTexLayout==2)
{
l9_4=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTexArrSC);
}
#else
{
l9_4=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
...
#endif
vec3 l9_33=mix(l9_31.xyz,definedBlend(l9_31.xyz,l9_8.xyz).xyz,vec3(l9_6));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_35=vec4(mix(vec3(1.0),l9_8.xyz,vec3(l9_6)),l9_6);
}
#else
{
vec4 l9_36;
...
#endif
l9_36=vec4(l9_8.xyz*l9_37,l9_37);
}
#else
{
l9_36=l9_8;
...
#endif
vec4 l9_38=outputMotionVectorsIfNeeded(varPos,max(l9_9,vec4(0.0)));
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_41=sc_ScreenCoordsGlobalToView(l9_1);
...
#if (sc_OITCompositingPass)
{
vec2 l9_54=sc_ScreenCoordsGlobalToView(l9_1);
#if (sc_OITMaxLayers4Plus1)
{
...
mediump vec4 l9_80=texture(sc_OITFilteredDepthBoundsTexture,l9_54);
vec2 l9_81=l9_80.xy;
int l9_82;
#if (sc_SkinBonesCount>0)
{
