...
vec2 l9_31=vec2(fract(((floor(float(sc_GetLocalInstanceID())+0.5)*Port_Input1_N031)+1.0)/(Tweak_N1Size.x*Port_Input1_N032)),(((floor(float(sc_GetLocalInstanceID())+0.5)/Tweak_N1Size.y)*Port_Input1_N037)+1.0)/(Tweak_N1Size.y*Port_Input1_N039));
int l9_32;
...
#endif
vec4 l9_33=sc_SampleTextureLevel(Tweak_N1Dims.xy,Tweak_N1Layout,l9_32,l9_31,(int(SC_USE_UV_TRANSFORM_Tweak_N1)!=0),Tweak_N1Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1),(int(SC_USE_UV_MIN_MAX_Tweak_N1)!=0),Tweak_N1UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0),Tweak_N1BorderColor,0.0,Tweak_N1);
int l9_34;
...
#endif
vec4 l9_35=sc_SampleTextureLevel(baseTexDims.xy,baseTexLayout,l9_34,l9_31,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
vec3 l9_36=l9_35.xyz;
vec3 l9_37=l9_33.xyz-l9_36;
vec3 l9_38=vec3(l9_37.y,Port_Input0_N018-l9_37.x,Port_Value3_N012);
...
float l9_42=(Port_Value_N020+0.001)-0.001;
vec3 l9_43;
vec3 l9_44;
vec3 l9_45;
if (l9_27)
{
l9_45=varTangent.xyz;
l9_44=varNormal;
l9_43=varPos;
}
else
...
l9_45=varTangent.xyz;
l9_44=l9_30;
l9_43=((mix(l9_41,l9_41*vec3(smoothstep(Port_Input0_N049,l9_42,clamp(l9_42-length(l9_38),Port_Input1_N042,l9_42))),vec3(0.001-0.001))*vec3(l9_28.x+Port_Input1_N016))*vec3(width*(cameraSize/(Port_Input1_N047+1.234e-06))))+(l9_36+(l9_37*vec3(l9_28.y)));
}
varPos=l9_43;
varNormal=normalize(l9_44);
vec3 l9_46=normalize(l9_45);
varTangent=vec4(l9_46.x,l9_46.y,l9_46.z,varTangent.w);
...
#if (sc_RenderingSpace==3)
{
l9_47=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*l9_17;
}
#else
{
vec4 l9_48;
#if (sc_RenderingSpace==2)
{
l9_48=sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_17;
}
#else
{
vec4 l9_49;
#if (sc_RenderingSpace==1)
{
l9_49=sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_17;
}
#else
{
l9_49=l9_17;
...
#if (sc_RenderingSpace==4)
{
l9_51=(sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_17)*vec4(1.0/sc_Camera.aspect,1.0,1.0,1.0);
}
#else
{
vec4 l9_52;
...
#endif
vec4 l9_55=sc_ProjectorMatrix*l9_54;
varShadowTex=((l9_55.xy/vec2(l9_55.w))*0.5)+vec2(0.5);
}
#endif
vec4 l9_56;
...
{
vec4 l9_58=l9_50;
l9_58.z=((log2(max(sc_Camera.clipPlanes.x,1.0+l9_50.w))*(2.0/log2(sc_Camera.clipPlanes.y+1.0)))-1.0)*l9_50.w;
l9_57=l9_58;
}
else
{
...
{
float l9_59=dot(l9_56,sc_StereoClipPlanes[sc_StereoViewID]);
#if (sc_StereoRendering_IsClipDistanceEnabled==1)
{
sc_SetClipDistancePlatform(l9_59);
}
#else
{
varClipDistance=l9_59;
}
#endif
}
#endif
