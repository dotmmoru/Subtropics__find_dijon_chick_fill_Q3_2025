...
if (l9_0.x<l9_8)
{
l9_14=0.0+(((l9_0.x-0.0)*(sliceSizeLeft-0.0))/((l9_8-0.0)+1e-06));
}
else
{
l9_14=(l9_0.x<l9_9) ? (sliceSizeLeft+(((l9_0.x-l9_8)*(l9_12-sliceSizeLeft))/((l9_9-l9_8)+1e-06))) : (l9_12+(((l9_0.x-l9_9)*(1.0-l9_12))/((1.0-l9_9)+1e-06)));
}
float l9_15;
if (l9_0.y<l9_10)
{
l9_15=0.0+(((l9_0.y-0.0)*(sliceSizeBottom-0.0))/((l9_10-0.0)+1e-06));
}
else
{
l9_15=(l9_0.y<l9_11) ? (sliceSizeBottom+(((l9_0.y-l9_10)*(l9_13-sliceSizeBottom))/((l9_11-l9_10)+1e-06))) : (l9_13+(((l9_0.y-l9_11)*(1.0-l9_13))/((1.0-l9_11)+1e-06)));
}
vec4 l9_16;
#if (baseTexLayout==2)
{
...
#endif
vec4 l9_65=l9_16*shapeColor;
float l9_66=l9_65.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_66<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_66<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_67,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_69;
...
{
l9_72=clamp(dot(l9_65.xyz,vec3(l9_66)),0.0,1.0);
}
#else
{
float l9_73;
...
{
l9_74=(1.0-dot(l9_65.xyz,vec3(0.33333001)))*l9_66;
}
#else
{
float l9_75;
...
{
l9_75=(1.0-clamp(dot(l9_65.xyz,vec3(1.0)),0.0,1.0))*l9_66;
}
#else
{
float l9_76;
...
{
l9_76=clamp(dot(l9_65.xyz,vec3(1.0)),0.0,1.0)*l9_66;
}
#else
{
float l9_77;
#if (sc_BlendMode_Add)
{
l9_77=clamp(dot(l9_65.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_78;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_78=clamp(dot(l9_65.xyz,vec3(1.0)),0.0,1.0)*l9_66;
}
#else
{
float l9_79;
...
{
l9_79=dot(l9_65.xyz,vec3(0.33333001))*l9_66;
}
#else
{
float l9_80;
#if (sc_BlendMode_Min)
{
l9_80=1.0-clamp(dot(l9_65.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_81;
#if (sc_BlendMode_Max)
{
l9_81=clamp(dot(l9_65.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_81=1.0;
...
#endif
l9_69=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_65.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_70);
}
#else
{
vec4 l9_82;
...
#if (sc_FramebufferFetch)
{
l9_84=sc_readFragData0_Platform();
}
#else
{
...
{
l9_86=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_85,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_86=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_85,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_84=l9_86;
}
#endif
vec3 l9_87=mix(l9_84.xyz,definedBlend(l9_84.xyz,l9_65.xyz).xyz,vec3(l9_66));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_89=vec4(mix(vec3(1.0),l9_65.xyz,vec3(l9_66)),l9_66);
}
#else
{
vec4 l9_90;
...
#endif
l9_90=vec4(l9_65.xyz*l9_91,l9_91);
}
#else
{
l9_90=l9_65;
...
vec4 l9_94=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_92,vec4(0.0)));
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_96-0.0039215689)),min(1.0,l9_96+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_98),packValue(l9_98),packValue(l9_98),packValue(l9_98)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
#if (sc_OITCompositingPass)
{
vec2 l9_110=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
...
sc_writeFragData0Internal(l9_140,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_95,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_94,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
