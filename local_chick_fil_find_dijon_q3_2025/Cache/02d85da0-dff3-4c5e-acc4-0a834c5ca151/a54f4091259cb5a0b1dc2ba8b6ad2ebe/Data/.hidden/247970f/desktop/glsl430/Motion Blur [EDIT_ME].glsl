...
//sampler sampler screenTextureSmpSC 0:31
...
//texture texture2D screenTexture 0:19:0:31
//texture utexture2D z_hitIdAndBarycentric 0:20:0:32
//texture texture2D z_rayDirections 0:21:0:33
//texture texture2DArray intensityTextureArrSC 0:34:0:22
//texture texture2DArray opacityTexArrSC 0:35:0:23
//texture texture2DArray sc_ScreenTextureArrSC 0:38:0:28
//texture texture2DArray screenTextureArrSC 0:39:0:31
...
//spec_const bool sc_ProxyAlphaOne 73 0
...
uniform int samples;
uniform float Port_Default_N009;
uniform float Port_Default_N013;
...
void Node13_If_else(float Bool1,float Value1,float Default,out float Result,ssGlobals Globals)
{
#if (Tweak_N7)
{
Value1=float(samples);
Result=Value1;
}
#else
{
...
void Node9_If_else(float Bool1,float Value1,float Default,out float Result,ssGlobals Globals)
{
#if (Tweak_N7)
{
Value1=float(fit);
...
vec4 N8_Texture_sample(vec2 coords)
{
vec4 l9_0;
...
vec4 l9_2=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_1.positionWS,1.0);
l9_0=((l9_2.xy/vec2(l9_2.w))*0.5)+vec2(0.5);
}
else
{
l9_0=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
}
ssGlobals l9_3=ssGlobals(sc_Time.x,sc_Time.y,0.0,0.0,0.0,l9_0);
vec4 l9_4;
#if (Tweak_N16)
{
float l9_5;
Node9_If_else(0.0,0.0,Port_Default_N009,l9_5,l9_3);
vec2 l9_6;
if ((l9_5*1.0)!=0.0)
{
float l9_7;
Node13_If_else(0.0,0.0,Port_Default_N013,l9_7,l9_3);
float l9_8=l9_7;
float l9_9;
Node9_If_else(0.0,0.0,Port_Default_N009,l9_9,l9_3);
float l9_10=l9_9;
vec2 l9_11=screenTextureSize.xy*l9_0;
vec2 l9_12=l9_11/screenTextureSize.xy;
vec2 l9_13=vec2(1.0)/screenTextureSize.xy;
float l9_14=angle*(3.1415927/180.0);
vec2 l9_15=(vec2(cos(l9_14),sin(l9_14))*30.0)*factor;
vec2 l9_16=l9_15*l9_13;
float l9_17=abs(l9_16.x);
float l9_18=abs(l9_16.y);
float l9_19;
if (l9_17>l9_18)
{
l9_19=l9_17/2.0;
...
if (l9_21<l9_8)
{
vec2 l9_23=l9_15*l9_22;
vec2 l9_24=l9_12+(l9_23*l9_13);
vec2 l9_25;
if (l9_10!=0.0)
{
l9_25=((l9_24-vec2(0.5))*((1.0-l9_19)-(0.015*factor)))+vec2(0.5);
}
else
{
l9_25=l9_24;
}
l9_20=l9_22+(1.0/l9_8);
l9_22=l9_20;
l9_21+=1.0;
continue;
}
...
l9_6=((l9_12-vec2(0.5))*((1.0-l9_19)-(0.015*factor)))+vec2(0.5);
}
else
{
l9_6=l9_0;
...
#if (screenTextureLayout==2)
{
bool l9_27=(int(SC_USE_CLAMP_TO_BORDER_screenTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_screenTexture)!=0));
float l9_28=l9_6.x;
sc_SoftwareWrapEarly(l9_28,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).x);
float l9_29=l9_28;
float l9_30=l9_6.y;
sc_SoftwareWrapEarly(l9_30,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).y);
float l9_31=l9_30;
vec2 l9_32;
float l9_33;
#if (SC_USE_UV_MIN_MAX_screenTexture)
...
#if (SC_USE_CLAMP_TO_BORDER_screenTexture)
{
l9_34=ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).x==3;
}
#else
{
l9_34=(int(SC_USE_CLAMP_TO_BORDER_screenTexture)!=0);
}
#endif
float l9_35=l9_29;
float l9_36=1.0;
sc_ClampUV(l9_35,screenTextureUvMinMax.x,screenTextureUvMinMax.z,l9_34,l9_36);
float l9_37=l9_35;
float l9_38=l9_36;
bool l9_39;
#if (SC_USE_CLAMP_TO_BORDER_screenTexture)
{
l9_39=ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).y==3;
}
#else
{
l9_39=(int(SC_USE_CLAMP_TO_BORDER_screenTexture)!=0);
}
#endif
float l9_40=l9_31;
float l9_41=l9_38;
sc_ClampUV(l9_40,screenTextureUvMinMax.y,screenTextureUvMinMax.w,l9_39,l9_41);
l9_33=l9_41;
...
#endif
vec2 l9_42=sc_TransformUV(l9_32,(int(SC_USE_UV_TRANSFORM_screenTexture)!=0),screenTextureTransform);
float l9_43=l9_42.x;
float l9_44=l9_33;
sc_SoftwareWrapLate(l9_43,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).x,l9_27,l9_44);
float l9_45=l9_42.y;
float l9_46=l9_44;
sc_SoftwareWrapLate(l9_45,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).y,l9_27,l9_46);
float l9_47=l9_46;
vec3 l9_48=sc_SamplingCoordsViewToGlobal(vec2(l9_43,l9_45),screenTextureLayout,screenTextureGetStereoViewIndex());
vec4 l9_49=texture(screenTextureArrSC,l9_48,0.0);
vec4 l9_50;
#if (SC_USE_CLAMP_TO_BORDER_screenTexture)
{
l9_50=mix(screenTextureBorderColor,l9_49,vec4(l9_47));
}
#else
{
l9_50=l9_49;
...
#else
{
bool l9_51=(int(SC_USE_CLAMP_TO_BORDER_screenTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_screenTexture)!=0));
float l9_52=l9_6.x;
sc_SoftwareWrapEarly(l9_52,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).x);
float l9_53=l9_52;
float l9_54=l9_6.y;
sc_SoftwareWrapEarly(l9_54,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).y);
float l9_55=l9_54;
vec2 l9_56;
float l9_57;
#if (SC_USE_UV_MIN_MAX_screenTexture)
...
#if (SC_USE_CLAMP_TO_BORDER_screenTexture)
{
l9_58=ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).x==3;
}
#else
{
l9_58=(int(SC_USE_CLAMP_TO_BORDER_screenTexture)!=0);
}
#endif
float l9_59=l9_53;
float l9_60=1.0;
sc_ClampUV(l9_59,screenTextureUvMinMax.x,screenTextureUvMinMax.z,l9_58,l9_60);
float l9_61=l9_59;
float l9_62=l9_60;
bool l9_63;
#if (SC_USE_CLAMP_TO_BORDER_screenTexture)
{
l9_63=ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).y==3;
}
#else
{
l9_63=(int(SC_USE_CLAMP_TO_BORDER_screenTexture)!=0);
}
#endif
float l9_64=l9_55;
float l9_65=l9_62;
sc_ClampUV(l9_64,screenTextureUvMinMax.y,screenTextureUvMinMax.w,l9_63,l9_65);
l9_57=l9_65;
...
#endif
vec2 l9_66=sc_TransformUV(l9_56,(int(SC_USE_UV_TRANSFORM_screenTexture)!=0),screenTextureTransform);
float l9_67=l9_66.x;
float l9_68=l9_57;
sc_SoftwareWrapLate(l9_67,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).x,l9_51,l9_68);
float l9_69=l9_66.y;
float l9_70=l9_68;
sc_SoftwareWrapLate(l9_69,ivec2(SC_SOFTWARE_WRAP_MODE_U_screenTexture,SC_SOFTWARE_WRAP_MODE_V_screenTexture).y,l9_51,l9_70);
float l9_71=l9_70;
vec3 l9_72=sc_SamplingCoordsViewToGlobal(vec2(l9_67,l9_69),screenTextureLayout,screenTextureGetStereoViewIndex());
vec4 l9_73=texture(screenTexture,l9_72.xy,0.0);
vec4 l9_74;
#if (SC_USE_CLAMP_TO_BORDER_screenTexture)
{
l9_74=mix(screenTextureBorderColor,l9_73,vec4(l9_71));
}
#else
{
l9_74=l9_73;
...
#endif
float l9_75;
Node13_If_else(0.0,0.0,Port_Default_N013,l9_75,l9_3);
float l9_76=l9_75;
float l9_77;
Node9_If_else(0.0,0.0,Port_Default_N009,l9_77,l9_3);
float l9_78=l9_77;
bool l9_79=l9_78!=0.0;
vec2 l9_80=screenTextureSize.xy*l9_0;
vec2 l9_81=vec2(1.0)/screenTextureSize.xy;
float l9_82=angle*(3.1415927/180.0);
vec2 l9_83=vec2(cos(l9_82),sin(l9_82))*30.0;
vec2 l9_84=l9_83*factor;
float l9_85=1.0/l9_76;
vec2 l9_86=l9_84*l9_81;
float l9_87=abs(l9_86.x);
float l9_88=abs(l9_86.y);
float l9_89;
if (l9_87>l9_88)
{
l9_89=l9_87/2.0;
...
if (l9_93<l9_76)
{
vec2 l9_95=l9_84*l9_94;
vec2 l9_96=(l9_80/screenTextureSize.xy)+(l9_95*l9_81);
vec2 l9_97;
if (l9_79)
{
l9_97=((l9_96-vec2(0.5))*((1.0-l9_89)-(0.015*factor)))+vec2(0.5);
}
else
{
l9_97=l9_96;
}
l9_91=l9_90+N8_Texture_sample(l9_97).xyz;
l9_92=l9_94+l9_85;
l9_94=l9_92;
l9_90=l9_91;
l9_93+=1.0;
...
vec3 l9_98=vec3(l9_76);
vec3 l9_99=l9_90/l9_98;
vec2 l9_100=opacityTexSize.xy*l9_0;
vec2 l9_101=vec2(1.0)/opacityTexSize.xy;
vec2 l9_102=l9_83*opacityblurFactor;
vec2 l9_103=l9_102*l9_101;
float l9_104=abs(l9_103.x);
float l9_105=abs(l9_103.y);
float l9_106;
if (l9_104>l9_105)
{
l9_106=l9_104/2.0;
...
if (l9_110<l9_76)
{
vec2 l9_112=l9_102*l9_111;
vec2 l9_113=(l9_100/opacityTexSize.xy)+(l9_112*l9_101);
vec2 l9_114;
if (l9_79)
{
l9_114=((l9_113-vec2(0.5))*((1.0-l9_106)-(0.015*opacityblurFactor)))+vec2(0.5);
}
else
{
l9_114=l9_113;
...
vec4 l9_138=texture(opacityTexArrSC,l9_137,0.0);
vec4 l9_139;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
...
#else
{
bool l9_140=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_141=l9_114.x;
sc_SoftwareWrapEarly(l9_141,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_142=l9_141;
float l9_143=l9_114.y;
sc_SoftwareWrapEarly(l9_143,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_144=l9_143;
vec2 l9_145;
float l9_146;
#if (SC_USE_UV_MIN_MAX_opacityTex)
...
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_147=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
l9_147=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_148=l9_142;
float l9_149=1.0;
sc_ClampUV(l9_148,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_147,l9_149);
float l9_150=l9_148;
float l9_151=l9_149;
bool l9_152;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_152=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
l9_152=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_153=l9_144;
float l9_154=l9_151;
sc_ClampUV(l9_153,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_152,l9_154);
l9_146=l9_154;
...
#endif
vec2 l9_155=sc_TransformUV(l9_145,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_156=l9_155.x;
float l9_157=l9_146;
sc_SoftwareWrapLate(l9_156,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_140,l9_157);
float l9_158=l9_155.y;
float l9_159=l9_157;
sc_SoftwareWrapLate(l9_158,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_140,l9_159);
float l9_160=l9_159;
vec3 l9_161=sc_SamplingCoordsViewToGlobal(vec2(l9_156,l9_158),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_162=texture(opacityTex,l9_161.xy,0.0);
vec4 l9_163;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_163=mix(opacityTexBorderColor,l9_162,vec4(l9_160));
}
#else
{
l9_163=l9_162;
...
l9_4=mix(l9_26,vec4(l9_99,1.0),vec4((l9_107/l9_98).x));
}
#else
{
float l9_164;
Node13_If_else(0.0,0.0,Port_Default_N013,l9_164,l9_3);
float l9_165=l9_164;
float l9_166;
Node9_If_else(0.0,0.0,Port_Default_N009,l9_166,l9_3);
float l9_167=l9_166;
vec2 l9_168=screenTextureSize.xy*l9_0;
vec2 l9_169=vec2(1.0)/screenTextureSize.xy;
float l9_170=angle*(3.1415927/180.0);
vec2 l9_171=(vec2(cos(l9_170),sin(l9_170))*30.0)*factor;
vec2 l9_172=l9_171*l9_169;
float l9_173=abs(l9_172.x);
float l9_174=abs(l9_172.y);
float l9_175;
if (l9_173>l9_174)
{
l9_175=l9_173/2.0;
...
if (l9_179<l9_165)
{
vec2 l9_181=l9_171*l9_180;
vec2 l9_182=(l9_168/screenTextureSize.xy)+(l9_181*l9_169);
vec2 l9_183;
if (l9_167!=0.0)
{
l9_183=((l9_182-vec2(0.5))*((1.0-l9_175)-(0.015*factor)))+vec2(0.5);
}
else
{
l9_183=l9_182;
}
l9_177=l9_176+N8_Texture_sample(l9_183).xyz;
l9_178=l9_180+(1.0/l9_165);
l9_180=l9_178;
l9_176=l9_177;
l9_179+=1.0;
continue;
...
l9_4=vec4(l9_176/vec3(l9_165),1.0);
}
#endif
...
#endif
sc_writeFragData0Internal(max(l9_184,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_186;
...
{
l9_188=clamp(l9_4.w*2.0,0.0,1.0);
}
#else
{
float l9_189;
...
{
l9_189=clamp(dot(l9_4.xyz,vec3(l9_4.w)),0.0,1.0);
}
#else
{
float l9_190;
...
{
l9_191=(1.0-dot(l9_4.xyz,vec3(0.33333001)))*l9_4.w;
}
#else
{
float l9_192;
...
{
l9_192=(1.0-clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0))*l9_4.w;
}
#else
{
float l9_193;
...
{
l9_193=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0)*l9_4.w;
}
#else
{
float l9_194;
#if (sc_BlendMode_Add)
{
l9_194=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_195;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_195=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0)*l9_4.w;
}
#else
{
float l9_196;
...
{
l9_196=dot(l9_4.xyz,vec3(0.33333001))*l9_4.w;
}
#else
{
float l9_197;
#if (sc_BlendMode_Min)
{
l9_197=1.0-clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_198;
#if (sc_BlendMode_Max)
{
l9_198=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_198=1.0;
...
#endif
l9_186=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_4.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_187);
}
#else
{
vec4 l9_199;
...
#if (sc_FramebufferFetch)
{
l9_201=sc_readFragData0_Platform();
}
#else
{
vec2 l9_202=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
vec4 l9_203;
#if (sc_ScreenTextureLayout==2)
{
l9_203=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_202,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_203=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_202,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_201=l9_203;
}
#endif
vec3 l9_204=mix(l9_201.xyz,definedBlend(l9_201.xyz,l9_4.xyz).xyz,vec3(l9_4.w));
vec4 l9_205=vec4(l9_204.x,l9_204.y,l9_204.z,vec4(0.0).w);
l9_205.w=1.0;
l9_200=l9_205;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_206=vec4(mix(vec3(1.0),l9_4.xyz,vec3(l9_4.w)),l9_4.w);
}
#else
{
vec4 l9_207;
...
#endif
l9_207=vec4(l9_4.xyz*l9_208,l9_208);
}
#else
{
l9_207=l9_4;
...
vec4 l9_211=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_209,vec4(0.0)));
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_214).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_215=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_214).xy);
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_227).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_232==0)
{
l9_235=texture(sc_OITAlpha0,l9_227);
l9_234=texture(sc_OITDepthLow0,l9_227);
l9_233=texture(sc_OITDepthHigh0,l9_227);
}
else
{
l9_235=vec4(0.0);
...
if (l9_232==1)
{
l9_238=texture(sc_OITAlpha1,l9_227);
l9_237=texture(sc_OITDepthLow1,l9_227);
l9_236=texture(sc_OITDepthHigh1,l9_227);
}
else
{
l9_238=l9_235;
...
vec4 l9_253=texture(sc_OITFilteredDepthBoundsTexture,l9_227);
