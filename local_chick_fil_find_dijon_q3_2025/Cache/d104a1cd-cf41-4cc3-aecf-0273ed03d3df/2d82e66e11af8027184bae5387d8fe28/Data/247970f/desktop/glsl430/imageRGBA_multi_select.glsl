...
//spec_const bool sc_ProxyAlphaOne 68 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 74 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 75 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 76 -1
...
ssGlobals l9_2=ssGlobals(sc_Time.x,sc_Time.y,0.0,l9_0);
float l9_3=float(alpha_channel);
float l9_4=float(red_channel);
float l9_5=float(green_channel);
float l9_6=float(blue_channel);
float l9_7=(l9_4+l9_5)+l9_6;
bool l9_8=(l9_3*1.0)!=0.0;
bool l9_9;
if (l9_8)
{
l9_9=(float(l9_7<Port_Input1_N010)*1.0)!=0.0;
}
else
{
l9_9=l9_8;
...
vec4 l9_10;
if ((float(l9_9)*1.0)!=0.0)
{
vec4 l9_11;
#if (baseTexLayout==2)
{
bool l9_12=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0));
float l9_13=l9_0.x;
...
float l9_28=l9_27.x;
float l9_29=l9_18;
sc_SoftwareWrapLate(l9_28,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,l9_12,l9_29);
float l9_30=l9_27.y;
float l9_31=l9_29;
sc_SoftwareWrapLate(l9_30,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,l9_12,l9_31);
float l9_32=l9_31;
vec3 l9_33=sc_SamplingCoordsViewToGlobal(vec2(l9_28,l9_30),baseTexLayout,baseTexGetStereoViewIndex());
vec4 l9_34=texture(baseTexArrSC,l9_33,0.0);
vec4 l9_35;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
...
#else
{
bool l9_36=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0));
float l9_37=l9_0.x;
sc_SoftwareWrapEarly(l9_37,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x);
float l9_38=l9_37;
float l9_39=l9_0.y;
sc_SoftwareWrapEarly(l9_39,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y);
float l9_40=l9_39;
vec2 l9_41;
float l9_42;
#if (SC_USE_UV_MIN_MAX_baseTex)
...
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_43=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x==3;
}
#else
{
...
float l9_44=l9_38;
float l9_45=1.0;
sc_ClampUV(l9_44,baseTexUvMinMax.x,baseTexUvMinMax.z,l9_43,l9_45);
float l9_46=l9_44;
float l9_47=l9_45;
bool l9_48;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_48=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y==3;
}
#else
{
...
float l9_49=l9_40;
float l9_50=l9_47;
sc_ClampUV(l9_49,baseTexUvMinMax.y,baseTexUvMinMax.w,l9_48,l9_50);
l9_42=l9_50;
...
#endif
vec2 l9_51=sc_TransformUV(l9_41,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform);
float l9_52=l9_51.x;
float l9_53=l9_42;
sc_SoftwareWrapLate(l9_52,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,l9_36,l9_53);
float l9_54=l9_51.y;
float l9_55=l9_53;
sc_SoftwareWrapLate(l9_54,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,l9_36,l9_55);
float l9_56=l9_55;
vec3 l9_57=sc_SamplingCoordsViewToGlobal(vec2(l9_52,l9_54),baseTexLayout,baseTexGetStereoViewIndex());
vec4 l9_58=texture(baseTex,l9_57.xy,0.0);
vec4 l9_59;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_59=mix(baseTexBorderColor,l9_58,vec4(l9_56));
}
#else
{
l9_59=l9_58;
...
#endif
vec3 l9_60=vec3(l9_11.w);
vec4 l9_61=vec4(l9_60.x,l9_60.y,l9_60.z,vec4(0.0).w);
l9_61.w=Port_Value2_N013;
l9_10=l9_61;
}
else
{
vec4 l9_62;
if ((float(l9_7>Port_Input1_N009)*1.0)!=0.0)
{
vec4 l9_63;
#if (baseTexLayout==2)
{
bool l9_64=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0));
float l9_65=l9_0.x;
sc_SoftwareWrapEarly(l9_65,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x);
float l9_66=l9_65;
float l9_67=l9_0.y;
sc_SoftwareWrapEarly(l9_67,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y);
float l9_68=l9_67;
vec2 l9_69;
float l9_70;
#if (SC_USE_UV_MIN_MAX_baseTex)
...
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_71=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x==3;
}
#else
{
l9_71=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0);
}
#endif
float l9_72=l9_66;
float l9_73=1.0;
sc_ClampUV(l9_72,baseTexUvMinMax.x,baseTexUvMinMax.z,l9_71,l9_73);
float l9_74=l9_72;
float l9_75=l9_73;
bool l9_76;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_76=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y==3;
}
#else
{
l9_76=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0);
}
#endif
float l9_77=l9_68;
float l9_78=l9_75;
sc_ClampUV(l9_77,baseTexUvMinMax.y,baseTexUvMinMax.w,l9_76,l9_78);
l9_70=l9_78;
...
#endif
vec2 l9_79=sc_TransformUV(l9_69,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform);
float l9_80=l9_79.x;
float l9_81=l9_70;
sc_SoftwareWrapLate(l9_80,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,l9_64,l9_81);
float l9_82=l9_79.y;
float l9_83=l9_81;
sc_SoftwareWrapLate(l9_82,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,l9_64,l9_83);
float l9_84=l9_83;
vec3 l9_85=sc_SamplingCoordsViewToGlobal(vec2(l9_80,l9_82),baseTexLayout,baseTexGetStereoViewIndex());
vec4 l9_86=texture(baseTexArrSC,l9_85,0.0);
vec4 l9_87;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_87=mix(baseTexBorderColor,l9_86,vec4(l9_84));
}
#else
{
l9_87=l9_86;
...
#else
{
bool l9_88=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0));
float l9_89=l9_0.x;
sc_SoftwareWrapEarly(l9_89,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x);
float l9_90=l9_89;
float l9_91=l9_0.y;
sc_SoftwareWrapEarly(l9_91,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y);
float l9_92=l9_91;
vec2 l9_93;
float l9_94;
#if (SC_USE_UV_MIN_MAX_baseTex)
...
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_95=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x==3;
}
#else
{
l9_95=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0);
}
#endif
float l9_96=l9_90;
float l9_97=1.0;
sc_ClampUV(l9_96,baseTexUvMinMax.x,baseTexUvMinMax.z,l9_95,l9_97);
float l9_98=l9_96;
float l9_99=l9_97;
bool l9_100;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_100=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y==3;
}
#else
{
l9_100=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0);
}
#endif
float l9_101=l9_92;
float l9_102=l9_99;
sc_ClampUV(l9_101,baseTexUvMinMax.y,baseTexUvMinMax.w,l9_100,l9_102);
l9_94=l9_102;
...
#endif
vec2 l9_103=sc_TransformUV(l9_93,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform);
float l9_104=l9_103.x;
float l9_105=l9_94;
sc_SoftwareWrapLate(l9_104,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,l9_88,l9_105);
float l9_106=l9_103.y;
float l9_107=l9_105;
sc_SoftwareWrapLate(l9_106,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,l9_88,l9_107);
float l9_108=l9_107;
vec3 l9_109=sc_SamplingCoordsViewToGlobal(vec2(l9_104,l9_106),baseTexLayout,baseTexGetStereoViewIndex());
vec4 l9_110=texture(baseTex,l9_109.xy,0.0);
vec4 l9_111;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_111=mix(baseTexBorderColor,l9_110,vec4(l9_108));
}
#else
{
l9_111=l9_110;
...
#endif
float l9_112;
if ((float(l9_3==Port_Input1_N035)*1.0)!=0.0)
{
l9_112=Port_Value1_N036;
}
else
{
vec4 l9_113;
#if (baseTexLayout==2)
{
bool l9_114=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0));
float l9_115=l9_0.x;
sc_SoftwareWrapEarly(l9_115,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x);
float l9_116=l9_115;
float l9_117=l9_0.y;
sc_SoftwareWrapEarly(l9_117,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y);
float l9_118=l9_117;
vec2 l9_119;
float l9_120;
#if (SC_USE_UV_MIN_MAX_baseTex)
...
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_121=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x==3;
}
#else
{
l9_121=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0);
}
#endif
float l9_122=l9_116;
float l9_123=1.0;
sc_ClampUV(l9_122,baseTexUvMinMax.x,baseTexUvMinMax.z,l9_121,l9_123);
float l9_124=l9_122;
float l9_125=l9_123;
bool l9_126;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_126=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y==3;
}
#else
{
l9_126=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0);
}
#endif
float l9_127=l9_118;
float l9_128=l9_125;
sc_ClampUV(l9_127,baseTexUvMinMax.y,baseTexUvMinMax.w,l9_126,l9_128);
l9_120=l9_128;
...
#endif
vec2 l9_129=sc_TransformUV(l9_119,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform);
float l9_130=l9_129.x;
float l9_131=l9_120;
sc_SoftwareWrapLate(l9_130,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,l9_114,l9_131);
float l9_132=l9_129.y;
float l9_133=l9_131;
sc_SoftwareWrapLate(l9_132,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,l9_114,l9_133);
float l9_134=l9_133;
vec3 l9_135=sc_SamplingCoordsViewToGlobal(vec2(l9_130,l9_132),baseTexLayout,baseTexGetStereoViewIndex());
vec4 l9_136=texture(baseTexArrSC,l9_135,0.0);
vec4 l9_137;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_137=mix(baseTexBorderColor,l9_136,vec4(l9_134));
}
#else
{
l9_137=l9_136;
...
#else
{
bool l9_138=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0));
float l9_139=l9_0.x;
sc_SoftwareWrapEarly(l9_139,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x);
float l9_140=l9_139;
float l9_141=l9_0.y;
sc_SoftwareWrapEarly(l9_141,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y);
float l9_142=l9_141;
vec2 l9_143;
float l9_144;
#if (SC_USE_UV_MIN_MAX_baseTex)
...
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_145=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x==3;
}
#else
{
l9_145=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0);
}
#endif
float l9_146=l9_140;
float l9_147=1.0;
sc_ClampUV(l9_146,baseTexUvMinMax.x,baseTexUvMinMax.z,l9_145,l9_147);
float l9_148=l9_146;
float l9_149=l9_147;
bool l9_150;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_150=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y==3;
}
#else
{
l9_150=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0);
}
#endif
float l9_151=l9_142;
float l9_152=l9_149;
sc_ClampUV(l9_151,baseTexUvMinMax.y,baseTexUvMinMax.w,l9_150,l9_152);
l9_144=l9_152;
...
#endif
vec2 l9_153=sc_TransformUV(l9_143,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform);
float l9_154=l9_153.x;
float l9_155=l9_144;
sc_SoftwareWrapLate(l9_154,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,l9_138,l9_155);
float l9_156=l9_153.y;
float l9_157=l9_155;
sc_SoftwareWrapLate(l9_156,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,l9_138,l9_157);
float l9_158=l9_157;
vec3 l9_159=sc_SamplingCoordsViewToGlobal(vec2(l9_154,l9_156),baseTexLayout,baseTexGetStereoViewIndex());
vec4 l9_160=texture(baseTex,l9_159.xy,0.0);
vec4 l9_161;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_161=mix(baseTexBorderColor,l9_160,vec4(l9_158));
}
#else
{
l9_161=l9_160;
...
l9_62=vec4(l9_4*l9_63.x,l9_5*l9_63.y,l9_63.z*l9_6,l9_112);
}
else
{
vec4 l9_162;
if ((float(l9_7==Port_Input1_N046)*1.0)!=0.0)
{
vec4 l9_163;
if ((float(l9_4==Port_Input1_N051)*1.0)!=0.0)
{
vec4 l9_164;
#if (baseTexLayout==2)
{
bool l9_165=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0));
float l9_166=l9_0.x;
sc_SoftwareWrapEarly(l9_166,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x);
float l9_167=l9_166;
float l9_168=l9_0.y;
sc_SoftwareWrapEarly(l9_168,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y);
float l9_169=l9_168;
vec2 l9_170;
float l9_171;
#if (SC_USE_UV_MIN_MAX_baseTex)
...
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_172=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x==3;
}
#else
{
...
float l9_173=l9_167;
float l9_174=1.0;
sc_ClampUV(l9_173,baseTexUvMinMax.x,baseTexUvMinMax.z,l9_172,l9_174);
float l9_175=l9_173;
float l9_176=l9_174;
bool l9_177;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_177=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y==3;
}
#else
{
l9_177=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0);
}
#endif
float l9_178=l9_169;
float l9_179=l9_176;
sc_ClampUV(l9_178,baseTexUvMinMax.y,baseTexUvMinMax.w,l9_177,l9_179);
l9_171=l9_179;
...
#endif
vec2 l9_180=sc_TransformUV(l9_170,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform);
float l9_181=l9_180.x;
float l9_182=l9_171;
sc_SoftwareWrapLate(l9_181,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,l9_165,l9_182);
float l9_183=l9_180.y;
float l9_184=l9_182;
sc_SoftwareWrapLate(l9_183,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,l9_165,l9_184);
float l9_185=l9_184;
vec3 l9_186=sc_SamplingCoordsViewToGlobal(vec2(l9_181,l9_183),baseTexLayout,baseTexGetStereoViewIndex());
vec4 l9_187=texture(baseTexArrSC,l9_186,0.0);
vec4 l9_188;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_188=mix(baseTexBorderColor,l9_187,vec4(l9_185));
}
#else
{
l9_188=l9_187;
...
#else
{
bool l9_189=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0));
float l9_190=l9_0.x;
sc_SoftwareWrapEarly(l9_190,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x);
float l9_191=l9_190;
float l9_192=l9_0.y;
sc_SoftwareWrapEarly(l9_192,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y);
float l9_193=l9_192;
vec2 l9_194;
float l9_195;
#if (SC_USE_UV_MIN_MAX_baseTex)
...
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_196=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x==3;
}
#else
{
...
float l9_197=l9_191;
float l9_198=1.0;
sc_ClampUV(l9_197,baseTexUvMinMax.x,baseTexUvMinMax.z,l9_196,l9_198);
float l9_199=l9_197;
float l9_200=l9_198;
bool l9_201;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_201=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y==3;
}
#else
{
l9_201=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0);
}
#endif
float l9_202=l9_193;
float l9_203=l9_200;
sc_ClampUV(l9_202,baseTexUvMinMax.y,baseTexUvMinMax.w,l9_201,l9_203);
l9_195=l9_203;
...
#endif
vec2 l9_204=sc_TransformUV(l9_194,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform);
float l9_205=l9_204.x;
float l9_206=l9_195;
sc_SoftwareWrapLate(l9_205,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,l9_189,l9_206);
float l9_207=l9_204.y;
float l9_208=l9_206;
sc_SoftwareWrapLate(l9_207,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,l9_189,l9_208);
float l9_209=l9_208;
vec3 l9_210=sc_SamplingCoordsViewToGlobal(vec2(l9_205,l9_207),baseTexLayout,baseTexGetStereoViewIndex());
vec4 l9_211=texture(baseTex,l9_210.xy,0.0);
vec4 l9_212;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_212=mix(baseTexBorderColor,l9_211,vec4(l9_209));
}
#else
{
l9_212=l9_211;
...
#endif
float l9_213;
Node43_If_else(0.0,Port_Value1_N043,0.0,l9_213,l9_2);
l9_163=vec4(l9_164.xxx,l9_213);
}
else
{
vec4 l9_214;
if ((float(l9_5==Port_Input1_N052)*1.0)!=0.0)
{
vec4 l9_215;
#if (baseTexLayout==2)
{
bool l9_216=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0));
float l9_217=l9_0.x;
sc_SoftwareWrapEarly(l9_217,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x);
float l9_218=l9_217;
float l9_219=l9_0.y;
sc_SoftwareWrapEarly(l9_219,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y);
float l9_220=l9_219;
vec2 l9_221;
float l9_222;
#if (SC_USE_UV_MIN_MAX_baseTex)
...
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_223=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x==3;
}
#else
{
l9_223=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0);
}
#endif
float l9_224=l9_218;
float l9_225=1.0;
sc_ClampUV(l9_224,baseTexUvMinMax.x,baseTexUvMinMax.z,l9_223,l9_225);
float l9_226=l9_224;
float l9_227=l9_225;
bool l9_228;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_228=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y==3;
}
#else
{
l9_228=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0);
}
#endif
float l9_229=l9_220;
float l9_230=l9_227;
sc_ClampUV(l9_229,baseTexUvMinMax.y,baseTexUvMinMax.w,l9_228,l9_230);
l9_222=l9_230;
...
#endif
vec2 l9_231=sc_TransformUV(l9_221,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform);
float l9_232=l9_231.x;
float l9_233=l9_222;
sc_SoftwareWrapLate(l9_232,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,l9_216,l9_233);
float l9_234=l9_231.y;
float l9_235=l9_233;
sc_SoftwareWrapLate(l9_234,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,l9_216,l9_235);
float l9_236=l9_235;
vec3 l9_237=sc_SamplingCoordsViewToGlobal(vec2(l9_232,l9_234),baseTexLayout,baseTexGetStereoViewIndex());
vec4 l9_238=texture(baseTexArrSC,l9_237,0.0);
vec4 l9_239;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_239=mix(baseTexBorderColor,l9_238,vec4(l9_236));
}
#else
{
l9_239=l9_238;
...
#else
{
bool l9_240=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0));
float l9_241=l9_0.x;
sc_SoftwareWrapEarly(l9_241,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x);
float l9_242=l9_241;
float l9_243=l9_0.y;
sc_SoftwareWrapEarly(l9_243,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y);
float l9_244=l9_243;
vec2 l9_245;
float l9_246;
#if (SC_USE_UV_MIN_MAX_baseTex)
...
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_247=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x==3;
}
#else
{
l9_247=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0);
}
#endif
float l9_248=l9_242;
float l9_249=1.0;
sc_ClampUV(l9_248,baseTexUvMinMax.x,baseTexUvMinMax.z,l9_247,l9_249);
float l9_250=l9_248;
float l9_251=l9_249;
bool l9_252;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_252=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y==3;
}
#else
{
l9_252=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0);
}
#endif
float l9_253=l9_244;
float l9_254=l9_251;
sc_ClampUV(l9_253,baseTexUvMinMax.y,baseTexUvMinMax.w,l9_252,l9_254);
l9_246=l9_254;
...
#endif
vec2 l9_255=sc_TransformUV(l9_245,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform);
float l9_256=l9_255.x;
float l9_257=l9_246;
sc_SoftwareWrapLate(l9_256,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,l9_240,l9_257);
float l9_258=l9_255.y;
float l9_259=l9_257;
sc_SoftwareWrapLate(l9_258,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,l9_240,l9_259);
float l9_260=l9_259;
vec3 l9_261=sc_SamplingCoordsViewToGlobal(vec2(l9_256,l9_258),baseTexLayout,baseTexGetStereoViewIndex());
vec4 l9_262=texture(baseTex,l9_261.xy,0.0);
vec4 l9_263;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_263=mix(baseTexBorderColor,l9_262,vec4(l9_260));
}
#else
{
l9_263=l9_262;
...
#endif
float l9_264;
Node43_If_else(0.0,Port_Value1_N043,0.0,l9_264,l9_2);
l9_214=vec4(l9_215.yyy,l9_264);
}
else
{
vec4 l9_265;
if ((float(l9_6==Port_Input1_N053)*1.0)!=0.0)
{
vec4 l9_266;
#if (baseTexLayout==2)
{
bool l9_267=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0));
float l9_268=l9_0.x;
sc_SoftwareWrapEarly(l9_268,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x);
float l9_269=l9_268;
float l9_270=l9_0.y;
sc_SoftwareWrapEarly(l9_270,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y);
float l9_271=l9_270;
vec2 l9_272;
float l9_273;
#if (SC_USE_UV_MIN_MAX_baseTex)
...
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_274=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x==3;
}
#else
{
l9_274=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0);
}
#endif
float l9_275=l9_269;
float l9_276=1.0;
sc_ClampUV(l9_275,baseTexUvMinMax.x,baseTexUvMinMax.z,l9_274,l9_276);
float l9_277=l9_275;
float l9_278=l9_276;
bool l9_279;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_279=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y==3;
}
#else
{
l9_279=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0);
}
#endif
float l9_280=l9_271;
float l9_281=l9_278;
sc_ClampUV(l9_280,baseTexUvMinMax.y,baseTexUvMinMax.w,l9_279,l9_281);
l9_273=l9_281;
...
#endif
vec2 l9_282=sc_TransformUV(l9_272,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform);
float l9_283=l9_282.x;
float l9_284=l9_273;
sc_SoftwareWrapLate(l9_283,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,l9_267,l9_284);
float l9_285=l9_282.y;
float l9_286=l9_284;
sc_SoftwareWrapLate(l9_285,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,l9_267,l9_286);
float l9_287=l9_286;
vec3 l9_288=sc_SamplingCoordsViewToGlobal(vec2(l9_283,l9_285),baseTexLayout,baseTexGetStereoViewIndex());
vec4 l9_289=texture(baseTexArrSC,l9_288,0.0);
vec4 l9_290;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_290=mix(baseTexBorderColor,l9_289,vec4(l9_287));
}
#else
{
l9_290=l9_289;
...
#else
{
bool l9_291=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0));
float l9_292=l9_0.x;
sc_SoftwareWrapEarly(l9_292,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x);
float l9_293=l9_292;
float l9_294=l9_0.y;
sc_SoftwareWrapEarly(l9_294,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y);
float l9_295=l9_294;
vec2 l9_296;
float l9_297;
#if (SC_USE_UV_MIN_MAX_baseTex)
...
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_298=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x==3;
}
#else
{
l9_298=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0);
}
#endif
float l9_299=l9_293;
float l9_300=1.0;
sc_ClampUV(l9_299,baseTexUvMinMax.x,baseTexUvMinMax.z,l9_298,l9_300);
float l9_301=l9_299;
float l9_302=l9_300;
bool l9_303;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_303=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y==3;
}
#else
{
l9_303=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0);
}
#endif
float l9_304=l9_295;
float l9_305=l9_302;
sc_ClampUV(l9_304,baseTexUvMinMax.y,baseTexUvMinMax.w,l9_303,l9_305);
l9_297=l9_305;
...
#endif
vec2 l9_306=sc_TransformUV(l9_296,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform);
float l9_307=l9_306.x;
float l9_308=l9_297;
sc_SoftwareWrapLate(l9_307,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,l9_291,l9_308);
float l9_309=l9_306.y;
float l9_310=l9_308;
sc_SoftwareWrapLate(l9_309,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,l9_291,l9_310);
float l9_311=l9_310;
vec3 l9_312=sc_SamplingCoordsViewToGlobal(vec2(l9_307,l9_309),baseTexLayout,baseTexGetStereoViewIndex());
vec4 l9_313=texture(baseTex,l9_312.xy,0.0);
vec4 l9_314;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_314=mix(baseTexBorderColor,l9_313,vec4(l9_311));
}
#else
{
l9_314=l9_313;
...
#endif
float l9_315;
Node43_If_else(0.0,Port_Value1_N043,0.0,l9_315,l9_2);
l9_265=vec4(l9_266.zzz,l9_315);
}
else
{
l9_265=Port_Default_N055;
}
l9_214=l9_265;
}
l9_163=l9_214;
...
{
if (l9_10.w<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_316,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_318;
...
{
l9_320=clamp(l9_10.w*2.0,0.0,1.0);
}
#else
{
float l9_321;
...
{
l9_321=clamp(dot(l9_10.xyz,vec3(l9_10.w)),0.0,1.0);
}
#else
{
float l9_322;
...
{
l9_323=(1.0-dot(l9_10.xyz,vec3(0.33333001)))*l9_10.w;
}
#else
{
float l9_324;
...
{
l9_324=(1.0-clamp(dot(l9_10.xyz,vec3(1.0)),0.0,1.0))*l9_10.w;
}
#else
{
float l9_325;
...
{
l9_325=clamp(dot(l9_10.xyz,vec3(1.0)),0.0,1.0)*l9_10.w;
}
#else
{
float l9_326;
#if (sc_BlendMode_Add)
{
l9_326=clamp(dot(l9_10.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_327;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_327=clamp(dot(l9_10.xyz,vec3(1.0)),0.0,1.0)*l9_10.w;
}
#else
{
float l9_328;
...
{
l9_328=dot(l9_10.xyz,vec3(0.33333001))*l9_10.w;
}
#else
{
float l9_329;
#if (sc_BlendMode_Min)
{
l9_329=1.0-clamp(dot(l9_10.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_330;
#if (sc_BlendMode_Max)
{
l9_330=clamp(dot(l9_10.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_330=1.0;
...
#endif
l9_318=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_10.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_319);
}
#else
{
vec4 l9_331;
...
#if (sc_FramebufferFetch)
{
l9_333=sc_readFragData0_Platform();
}
#else
{
vec2 l9_334=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
vec4 l9_335;
#if (sc_ScreenTextureLayout==2)
{
l9_335=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_334,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_335=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_334,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_333=l9_335;
}
#endif
vec3 l9_336=mix(l9_333.xyz,definedBlend(l9_333.xyz,l9_10.xyz).xyz,vec3(l9_10.w));
vec4 l9_337=vec4(l9_336.x,l9_336.y,l9_336.z,vec4(0.0).w);
l9_337.w=1.0;
l9_332=l9_337;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_338=vec4(mix(vec3(1.0),l9_10.xyz,vec3(l9_10.w)),l9_10.w);
}
#else
{
vec4 l9_339;
...
#endif
l9_339=vec4(l9_10.xyz*l9_340,l9_340);
}
#else
{
l9_339=l9_10;
...
vec4 l9_343=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_341,vec4(0.0)));
vec4 l9_344=clamp(l9_343,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_345=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_345-0.0039215689)),min(1.0,l9_345+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_346=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_346).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_347=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_346).xy);
float l9_348=packValue(l9_347);
int l9_355=int(l9_344.w*255.0);
float l9_356=packValue(l9_355);
sc_writeFragData0Internal(vec4(packValue(l9_347),packValue(l9_347),packValue(l9_347),packValue(l9_347)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_348,packValue(l9_347),packValue(l9_347),packValue(l9_347)));
sc_writeFragData2(vec4(l9_356,packValue(l9_355),packValue(l9_355),packValue(l9_355)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_359=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_359).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_364==0)
{
l9_367=texture(sc_OITAlpha0,l9_359);
l9_366=texture(sc_OITDepthLow0,l9_359);
l9_365=texture(sc_OITDepthHigh0,l9_359);
}
else
{
l9_367=vec4(0.0);
...
if (l9_364==1)
{
l9_370=texture(sc_OITAlpha1,l9_359);
l9_369=texture(sc_OITDepthLow1,l9_359);
l9_368=texture(sc_OITDepthHigh1,l9_359);
}
else
{
l9_370=l9_367;
...
if (any(notEqual(l9_368,vec4(0.0)))||any(notEqual(l9_369,vec4(0.0))))
{
int l9_371[8]=l9_360;
unpackValues(l9_368.w,l9_364,l9_371);
unpackValues(l9_368.z,l9_364,l9_371);
unpackValues(l9_368.y,l9_364,l9_371);
unpackValues(l9_368.x,l9_364,l9_371);
unpackValues(l9_369.w,l9_364,l9_371);
unpackValues(l9_369.z,l9_364,l9_371);
unpackValues(l9_369.y,l9_364,l9_371);
unpackValues(l9_369.x,l9_364,l9_371);
int l9_380[8]=l9_361;
unpackValues(l9_370.w,l9_364,l9_380);
unpackValues(l9_370.z,l9_364,l9_380);
unpackValues(l9_370.y,l9_364,l9_380);
unpackValues(l9_370.x,l9_364,l9_380);
}
l9_364++;
continue;
}
...
vec4 l9_385=texture(sc_OITFilteredDepthBoundsTexture,l9_359);
vec2 l9_386=l9_385.xy;
int l9_387;
#if (sc_SkinBonesCount>0)
{
l9_387=encodeDepth(((1.0-l9_385.x)*1000.0)+getDepthOrderingEpsilon(),l9_386);
}
#else
{
l9_387=0;
...
#endif
int l9_388=encodeDepth(viewSpaceDepth(),l9_386);
vec4 l9_389;
l9_389=l9_344*l9_344.w;
vec4 l9_390;
int l9_391=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_391<8)
{
int l9_392=l9_360[l9_391];
int l9_393=l9_388-l9_387;
bool l9_394=l9_392<l9_393;
bool l9_395;
if (l9_394)
{
l9_395=l9_360[l9_391]>0;
}
else
{
l9_395=l9_394;
...
if (l9_395)
{
vec3 l9_396=l9_389.xyz*(1.0-(float(l9_361[l9_391])/255.0));
l9_390=vec4(l9_396.x,l9_396.y,l9_396.z,l9_389.w);
}
else
{
l9_390=l9_389;
...
sc_writeFragData0Internal(l9_389,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_344,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_343,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
