...
#if (baseTexLayout==2)
{
l9_15=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_7,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTexArrSC);
}
#else
{
l9_15=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_7,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
...
{
l9_26=sc_SampleTextureBiasOrLevel(opacityTexDims.xy,opacityTexLayout,opacityTexGetStereoViewIndex(),l9_18,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex),(int(SC_USE_UV_MIN_MAX_opacityTex)!=0),opacityTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0),opacityTexBorderColor,0.0,opacityTexArrSC);
}
#else
{
...
#if (sc_FramebufferFetch)
{
mediump vec4 l9_45=sc_readFragData0_Platform();
vec4 l9_46;
...
#endif
vec3 l9_53=mix(l9_51.xyz,definedBlend(l9_51.xyz,l9_28.xyz).xyz,vec3(l9_27));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_55=vec4(mix(vec3(1.0),l9_28.xyz,vec3(l9_27)),l9_27);
}
#else
{
vec4 l9_56;
...
#endif
vec4 l9_58=outputMotionVectorsIfNeeded(varPos,max(l9_29,vec4(0.0)));
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_61=sc_ScreenCoordsGlobalToView(l9_3);
...
#endif
int l9_62=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_61).xy);
...
#if (sc_OITCompositingPass)
{
vec2 l9_74=sc_ScreenCoordsGlobalToView(l9_3);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_79==0)
{
l9_82=texture(sc_OITAlpha0,l9_74);
l9_81=texture(sc_OITDepthLow0,l9_74);
l9_80=texture(sc_OITDepthHigh0,l9_74);
}
else
{
l9_82=vec4(0.0);
...
if (l9_79==1)
{
l9_85=texture(sc_OITAlpha1,l9_74);
l9_84=texture(sc_OITDepthLow1,l9_74);
l9_83=texture(sc_OITDepthHigh1,l9_74);
}
else
{
l9_85=l9_82;
...
mediump vec4 l9_100=texture(sc_OITFilteredDepthBoundsTexture,l9_74);
