...
uniform float Port_Multiplier_N033;
...
float l9_2=l9_0*Port_Multiplier_N033;
vec4 l9_3;
#if (ENABLE_BASE_TEX)
{
int l9_4;
...
#endif
l9_3=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,l9_4,varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
}
#else
{
...
#endif
vec4 l9_5=baseColor*l9_3;
float l9_6=l9_5.w*Port_Default_N204;
vec3 l9_7=vec3(sin(l9_2));
...
{
l9_12=clamp(dot(l9_8.xyz,vec3(l9_6)),0.0,1.0);
}
#else
{
float l9_13;
...
{
l9_14=(1.0-dot(l9_8.xyz,vec3(0.33333001)))*l9_6;
}
#else
{
float l9_15;
...
{
l9_15=(1.0-clamp(dot(l9_8.xyz,vec3(1.0)),0.0,1.0))*l9_6;
}
#else
{
float l9_16;
...
{
l9_16=clamp(dot(l9_8.xyz,vec3(1.0)),0.0,1.0)*l9_6;
}
#else
{
float l9_17;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_18=clamp(dot(l9_8.xyz,vec3(1.0)),0.0,1.0)*l9_6;
}
#else
{
float l9_19;
...
{
l9_19=dot(l9_8.xyz,vec3(0.33333001))*l9_6;
}
#else
{
float l9_20;
...
#if (sc_FramebufferFetch)
{
vec4 l9_25=sc_readFragData0_Platform();
vec4 l9_26;
...
#else
{
vec2 l9_28=sc_ScreenCoordsGlobalToView(l9_1);
int l9_29;
...
#endif
l9_24=sc_SampleView(sc_ScreenTextureDims.xy,l9_28,sc_ScreenTextureLayout,l9_29,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_30;
...
{
vec4 l9_31=l9_24;
l9_31.x=l9_24.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_30=l9_31;
}
#else
{
...
#endif
vec3 l9_32=mix(l9_30.xyz,definedBlend(l9_30.xyz,l9_8.xyz).xyz,vec3(l9_6));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_34=vec4(mix(vec3(1.0),l9_8.xyz,vec3(l9_6)),l9_6);
}
#else
{
vec4 l9_35;
...
#endif
l9_35=vec4(l9_8.xyz*l9_36,l9_36);
}
#else
{
l9_35=l9_8;
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_44=sc_ScreenCoordsGlobalToView(l9_1);
...
#if (sc_OITCompositingPass)
{
vec2 l9_57=sc_ScreenCoordsGlobalToView(l9_1);
#if (sc_OITMaxLayers4Plus1)
{
