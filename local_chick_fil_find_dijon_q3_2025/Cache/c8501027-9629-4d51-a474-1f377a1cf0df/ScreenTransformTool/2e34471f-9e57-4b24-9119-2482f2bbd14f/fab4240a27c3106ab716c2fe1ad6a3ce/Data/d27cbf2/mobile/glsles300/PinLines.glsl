...
vec2 l9_28=vec2(fract(((floor(float(sc_GetLocalInstanceID())+0.5)*2.0)+1.0)/(Tweak_N1Size.x*2.0)),(((floor(float(sc_GetLocalInstanceID())+0.5)/Tweak_N1Size.y)*2.0)+1.0)/(Tweak_N1Size.y*2.0));
vec4 l9_29;
#if (Tweak_N1Layout==2)
{
l9_29=sc_SampleTextureLevel(Tweak_N1Dims.xy,Tweak_N1Layout,Tweak_N1GetStereoViewIndex(),l9_28,(int(SC_USE_UV_TRANSFORM_Tweak_N1)!=0),Tweak_N1Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1),(int(SC_USE_UV_MIN_MAX_Tweak_N1)!=0),Tweak_N1UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0),Tweak_N1BorderColor,0.0,Tweak_N1ArrSC);
}
#else
{
...
#if (baseTexLayout==2)
{
l9_30=sc_SampleTextureLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_28,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTexArrSC);
}
#else
{
l9_30=sc_SampleTextureLevel(baseTexDims.xy,baseTexLayout,baseTexGetStereoViewIndex(),l9_28,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
...
#endif
vec3 l9_31=l9_29.xyz-l9_30.xyz;
vec3 l9_32=vec3(l9_31.y,0.0-l9_31.x,0.0);
...
vec3 l9_35=l9_32*l9_34;
varPos=((mix(l9_35,l9_35*vec3(smoothstep(-1.0,(4.2199998+0.001)-0.001,clamp(((4.2199998+0.001)-0.001)-length(l9_32),0.0,(4.2199998+0.001)-0.001))),vec3(0.001-0.001))*vec3(l9_3.x+(-0.5)))*vec3(width*(cameraSize/20.000002)))+(l9_30.xyz+(l9_31*vec3(l9_3.y)));
varNormal=normalize(l9_27);
vec3 l9_36=normalize(varTangent.xyz);
