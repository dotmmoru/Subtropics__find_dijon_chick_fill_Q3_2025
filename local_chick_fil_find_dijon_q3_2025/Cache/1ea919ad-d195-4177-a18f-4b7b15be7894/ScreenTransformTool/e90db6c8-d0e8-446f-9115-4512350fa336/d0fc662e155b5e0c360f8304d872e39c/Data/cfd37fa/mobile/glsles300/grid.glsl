...
#if (Tweak_N103)
{
vec2 l9_0=((Globals.Surface_UVCoord0-vec2(0.5))*vec2(1.0))+vec2(0.5);
float l9_1=l9_0.y;
float l9_2=zoom*gline_thickness;
float l9_3=l9_2*((0.75+0.001)-0.001);
float l9_4=l9_0.x;
float l9_5=divisions_guides*2.0;
float l9_6=l9_5+1.234e-06;
float l9_7=l9_2*2.0;
float l9_8=colorjs.w*(clamp(max(clamp((max(step(fract((l9_1*divisions_guides)+(l9_3/2.0000012)),l9_3),step(fract((l9_4*divisions_guides)+(l9_2/(divisions_guides+1.234e-06))),l9_2))*alpha1)+0.001,0.001,1.001)-0.001,(max(step(fract((l9_1*l9_5)+(l9_3/l9_6)),l9_3),step(fract((l9_4*l9_5)+(l9_7/l9_6)),l9_7))*alpha2)*(1.0/(zoom+1.234e-06)))+0.001,0.001,1.001)-0.001);
float l9_9=l9_2*center_l_thickness_js;
float l9_10=l9_9*((0.75+0.001)-0.001);
float l9_11=Tweak_N105.w*(clamp(max(step(fract((l9_1*2.0)+(l9_10/2.0000012)),l9_10)-max(float(l9_1<0.23999999),float(l9_1>0.79000002)),step(fract((l9_4*2.0)+(l9_9/2.0000012)),l9_9)-max(float(l9_4<0.23999999),float(l9_4>0.79000002)))+0.001,0.001,1.001)-0.001);
vec3 l9_12=mix(vec4(colorjs.xyz,l9_8).xyz,vec4(Tweak_N105.xyz,l9_11).xyz,vec3(l9_11));
vec4 l9_13=vec4(l9_12.x,l9_12.y,l9_12.z,vec4(0.0).w);
l9_13.w=clamp((l9_8+l9_11)+0.001,0.001,1.001)-0.001;
Value1=l9_13;
Result=Value1;
}
#else
{
vec2 l9_14=((Globals.Surface_UVCoord0-vec2(0.5))*vec2(1.0))+vec2(0.5);
float l9_15=l9_14.y;
float l9_16=zoom*gline_thickness;
float l9_17=l9_16*((0.75+0.001)-0.001);
float l9_18=l9_14.x;
float l9_19=divisions_guides*2.0;
float l9_20=l9_19+1.234e-06;
float l9_21=l9_16*2.0;
Default=vec4(colorjs.xyz,colorjs.w*(clamp(max(clamp((max(step(fract((l9_15*divisions_guides)+(l9_17/2.0000012)),l9_17),step(fract((l9_18*divisions_guides)+(l9_16/(divisions_guides+1.234e-06))),l9_16))*alpha1)+0.001,0.001,1.001)-0.001,(max(step(fract((l9_15*l9_19)+(l9_17/l9_20)),l9_17),step(fract((l9_18*l9_19)+(l9_21/l9_20)),l9_21))*alpha2)*(1.0/(zoom+1.234e-06)))+0.001,0.001,1.001)-0.001));
Result=Default;
}
#endif
}
...
#if (sc_FramebufferFetch)
{
mediump vec4 l9_20=sc_readFragData0_Platform();
vec4 l9_21;
...
{
l9_25=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_23,sc_ScreenTextureLayout,l9_24),0.0);
}
#else
{
l9_25=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_23,sc_ScreenTextureLayout,l9_24).xy,0.0);
}
#endif
l9_19=l9_25;
}
...
#endif
vec4 l9_33=outputMotionVectorsIfNeeded(varPos,max(l9_4,vec4(0.0)));
