...
uniform vec4 colorjs;
uniform float divisions_guides;
uniform float zoom;
uniform float gline_thickness;
uniform float alpha1;
uniform float alpha2;
uniform vec4 Tweak_N105;
uniform float center_l_thickness_js;
uniform vec2 Port_Scale_N143;
uniform vec2 Port_Center_N143;
uniform float Port_Value_N151;
uniform float Port_Input1_N027;
uniform float Port_Input1_N106;
uniform float Port_Input2_N106;
uniform float Port_Input1_N043;
uniform float Port_Input1_N019;
uniform float Port_Input0_N159;
uniform float Port_Input1_N068;
uniform float Port_Input2_N068;
uniform vec4 Port_Import_N115;
uniform float Port_Input1_N049;
uniform float Port_Input1_N072;
uniform float Port_Import_N140;
uniform vec2 Port_Import_N141;
uniform float Port_Import_N108;
uniform float Port_Import_N142;
uniform float Port_Input1_N081;
uniform float Port_Input1_N082;
uniform float Port_Import_N139;
uniform float Port_Input1_N137;
uniform float Port_Input2_N137;
uniform vec4 Port_Import_N117;
uniform float Port_Input1_N123;
uniform float Port_Input2_N123;
...
varying vec2 varScreenTexturePos;
varying vec4 varColor;
void Node100_If_else(float Bool1,vec4 Value1,vec4 Default,out vec4 Result,ssGlobals Globals)
{
#if (Tweak_N103)
{
vec2 l9_0=((Globals.Surface_UVCoord0-Port_Center_N143)*Port_Scale_N143)+Port_Center_N143;
float l9_1=l9_0.y;
float l9_2=zoom*gline_thickness;
float l9_3=(Port_Value_N151+0.001)-0.001;
float l9_4=l9_2*l9_3;
float l9_5=l9_0.x;
float l9_6=divisions_guides*Port_Input1_N043;
float l9_7=l9_6+1.234e-06;
float l9_8=l9_2*Port_Input1_N019;
float l9_9=colorjs.w*(clamp(max(clamp((max(step(fract((l9_1*divisions_guides)+(l9_4/(Port_Input1_N027+1.234e-06))),l9_4),step(fract((l9_5*divisions_guides)+(l9_2/(divisions_guides+1.234e-06))),l9_2))*alpha1)+0.001,Port_Input1_N106+0.001,Port_Input2_N106+0.001)-0.001,(max(step(fract((l9_1*l9_6)+(l9_4/l9_7)),l9_4),step(fract((l9_5*l9_6)+(l9_8/l9_7)),l9_8))*alpha2)*(Port_Input0_N159/(zoom+1.234e-06)))+0.001,Port_Input1_N068+0.001,Port_Input2_N068+0.001)-0.001);
float l9_10=l9_2*center_l_thickness_js;
float l9_11=l9_10*l9_3;
float l9_12=clamp(Port_Import_N108,0.0,1.0);
float l9_13=clamp(Port_Import_N142,0.0,1.0);
float l9_14=Tweak_N105.w*(clamp(max(step(fract((l9_1*Port_Input1_N049)+(l9_11/(Port_Input1_N072+1.234e-06))),l9_11)-max(float(l9_1<l9_12),float(l9_1>l9_13)),step(fract((l9_5*Port_Input1_N081)+(l9_10/(Port_Input1_N082+1.234e-06))),l9_10)-max(float(l9_5<l9_12),float(l9_5>l9_13)))+0.001,Port_Input1_N137+0.001,Port_Input2_N137+0.001)-0.001);
vec3 l9_15=mix(vec4(colorjs.xyz,l9_9).xyz,vec4(Tweak_N105.xyz,l9_14).xyz,vec3(l9_14));
vec4 l9_16=vec4(l9_15.x,l9_15.y,l9_15.z,vec4(0.0).w);
l9_16.w=clamp((l9_9+l9_14)+0.001,Port_Input1_N123+0.001,Port_Input2_N123+0.001)-0.001;
Value1=l9_16;
Result=Value1;
}
#else
{
vec2 l9_17=((Globals.Surface_UVCoord0-Port_Center_N143)*Port_Scale_N143)+Port_Center_N143;
float l9_18=l9_17.y;
float l9_19=zoom*gline_thickness;
float l9_20=l9_19*((Port_Value_N151+0.001)-0.001);
float l9_21=l9_17.x;
float l9_22=divisions_guides*Port_Input1_N043;
float l9_23=l9_22+1.234e-06;
float l9_24=l9_19*Port_Input1_N019;
Default=vec4(colorjs.xyz,colorjs.w*(clamp(max(clamp((max(step(fract((l9_18*divisions_guides)+(l9_20/(Port_Input1_N027+1.234e-06))),l9_20),step(fract((l9_21*divisions_guides)+(l9_19/(divisions_guides+1.234e-06))),l9_19))*alpha1)+0.001,Port_Input1_N106+0.001,Port_Input2_N106+0.001)-0.001,(max(step(fract((l9_18*l9_22)+(l9_20/l9_23)),l9_20),step(fract((l9_21*l9_22)+(l9_24/l9_23)),l9_24))*alpha2)*(Port_Input0_N159/(zoom+1.234e-06)))+0.001,Port_Input1_N068+0.001,Port_Input2_N068+0.001)-0.001));
Result=Default;
}
#endif
}
...
vec4 param_3;
Node100_If_else(0.0,vec4(0.0),vec4(0.0),param_3,ssGlobals(l9_1,l9_2,0.0,varPackedTex.xy));
vec4 l9_3=param_3;
