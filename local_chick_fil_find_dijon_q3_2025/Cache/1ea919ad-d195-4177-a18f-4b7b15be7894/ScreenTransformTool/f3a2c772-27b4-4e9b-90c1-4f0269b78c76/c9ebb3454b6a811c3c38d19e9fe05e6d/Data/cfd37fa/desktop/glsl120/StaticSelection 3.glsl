...
#endif
float l9_0=varPackedTex.x*Port_Input1_N031;
float l9_1=edgeSize*(Port_Value_N034.x/(Port_Value_N034.y+1.234e-06));
...
{
l9_27=vec3(l9_24.x,(l9_24.y*0.5)+(0.5-(float(l9_25)*0.5)),0.0);
}
#else
{
l9_27=vec3(l9_24,0.0);
}
#endif
l9_26=l9_27;
}
#endif
l9_20=texture2D(sc_ScreenTexture,l9_26.xy,0.0);
}
#endif
vec4 l9_28;
...
{
vec4 l9_29=l9_20;
l9_29.x=l9_20.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_28=l9_29;
}
#else
{
