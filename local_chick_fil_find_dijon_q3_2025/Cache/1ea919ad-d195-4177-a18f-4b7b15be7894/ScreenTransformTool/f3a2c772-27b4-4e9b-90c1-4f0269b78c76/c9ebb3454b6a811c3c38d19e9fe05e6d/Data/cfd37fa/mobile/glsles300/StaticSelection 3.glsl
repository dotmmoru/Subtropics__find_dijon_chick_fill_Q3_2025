...
#endif
float l9_0=varPackedTex.x*1.0;
float l9_1=edgeSize*(1.0/(1.0+1.234e-06));
bool l9_2=(float(min(l9_0,varPackedTex.y)<l9_1)*1.0)!=0.0;
bool l9_3;
if (!l9_2)
{
l9_3=(float((1.0-max(l9_0,varPackedTex.y))<l9_1)*1.0)!=0.0;
}
else
{
l9_3=l9_2;
...
vec4 l9_5=vec4(baseColor.xyz,l9_4);
...
#if (sc_FramebufferFetch)
{
mediump vec4 l9_21=sc_readFragData0_Platform();
vec4 l9_22;
...
{
l9_26=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_24,sc_ScreenTextureLayout,l9_25),0.0);
}
#else
{
l9_26=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_24,sc_ScreenTextureLayout,l9_25).xy,0.0);
}
#endif
l9_20=l9_26;
}
...
#endif
vec4 l9_31=outputMotionVectorsIfNeeded(varPos,max(l9_6,vec4(0.0)));
...
mediump vec4 l9_73=texture(sc_OITFilteredDepthBoundsTexture,l9_47);
vec2 l9_74=l9_73.xy;
int l9_75;
#if (sc_SkinBonesCount>0)
{
