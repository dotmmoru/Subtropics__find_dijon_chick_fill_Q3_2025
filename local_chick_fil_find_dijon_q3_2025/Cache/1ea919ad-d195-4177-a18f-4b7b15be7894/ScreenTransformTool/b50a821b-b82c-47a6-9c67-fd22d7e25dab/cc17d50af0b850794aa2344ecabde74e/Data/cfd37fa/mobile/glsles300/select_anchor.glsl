...
//texture texture2DArray opacityTexArrSC 0:29:0:19
...
uniform mediump sampler2DArray opacityTexArrSC;
...
float l9_54=l9_53.x;
float l9_55=l9_44;
sc_SoftwareWrapLate(l9_54,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_55);
float l9_56=l9_53.y;
float l9_57=l9_55;
sc_SoftwareWrapLate(l9_56,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_57);
float l9_58=l9_57;
...
{
vec2 l9_67;
Node122_If_else(0.0,vec2(0.0),vec2(0.0),l9_67,l9_5);
float l9_68;
Node67_Bool_Parameter(l9_68,l9_5);
l9_66=mix(varPackedTex.xy,l9_67,vec2(l9_68));
}
#else
{
vec2 l9_69;
...
{
vec2 l9_70;
Node64_If_else(0.0,vec2(0.0),vec2(0.0),l9_70,l9_5);
float l9_71;
Node11_Bool_Parameter(l9_71,l9_5);
l9_69=mix(varPackedTex.xy,l9_70,vec2(l9_71));
}
#else
{
...
{
float l9_73=l9_64.x;
sc_SoftwareWrapEarly(l9_73,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_74=l9_73;
float l9_75=l9_64.y;
sc_SoftwareWrapEarly(l9_75,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_76=l9_75;
vec2 l9_77;
float l9_78;
...
{
l9_79=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
l9_79=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_80=l9_74;
float l9_81=1.0;
sc_ClampUV(l9_80,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_79,l9_81);
float l9_82=l9_80;
float l9_83=l9_81;
bool l9_84;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_84=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
...
float l9_85=l9_76;
float l9_86=l9_83;
sc_ClampUV(l9_85,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_84,l9_86);
l9_78=l9_86;
l9_77=vec2(l9_82,l9_85);
}
#else
...
#endif
vec2 l9_87=sc_TransformUV(l9_77,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_88=l9_87.x;
float l9_89=l9_78;
sc_SoftwareWrapLate(l9_88,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_89);
float l9_90=l9_87.y;
float l9_91=l9_89;
sc_SoftwareWrapLate(l9_90,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_91);
float l9_92=l9_91;
vec3 l9_93=sc_SamplingCoordsViewToGlobal(vec2(l9_88,l9_90),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_94=texture(opacityTexArrSC,l9_93,0.0);
vec4 l9_95;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_95=mix(opacityTexBorderColor,l9_94,vec4(l9_92));
}
#else
{
l9_95=l9_94;
...
{
float l9_96=l9_64.x;
sc_SoftwareWrapEarly(l9_96,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_97=l9_96;
float l9_98=l9_64.y;
sc_SoftwareWrapEarly(l9_98,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_99=l9_98;
vec2 l9_100;
float l9_101;
#if (SC_USE_UV_MIN_MAX_opacityTex)
...
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_102=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
l9_102=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_103=l9_97;
float l9_104=1.0;
sc_ClampUV(l9_103,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_102,l9_104);
float l9_105=l9_103;
float l9_106=l9_104;
bool l9_107;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_107=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
...
float l9_108=l9_99;
float l9_109=l9_106;
sc_ClampUV(l9_108,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_107,l9_109);
l9_101=l9_109;
...
#endif
vec2 l9_110=sc_TransformUV(l9_100,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_111=l9_110.x;
float l9_112=l9_101;
sc_SoftwareWrapLate(l9_111,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_112);
float l9_113=l9_110.y;
float l9_114=l9_112;
sc_SoftwareWrapLate(l9_113,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0)),l9_114);
float l9_115=l9_114;
vec3 l9_116=sc_SamplingCoordsViewToGlobal(vec2(l9_111,l9_113),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_117=texture(opacityTex,l9_116.xy,0.0);
vec4 l9_118;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_118=mix(opacityTexBorderColor,l9_117,vec4(l9_115));
}
#else
{
l9_118=l9_117;
...
#endif
float l9_119=l9_62.w*l9_63;
vec4 l9_120=vec4(l9_62.x,l9_62.y,l9_62.z,vec4(0.0).w);
l9_120.w=l9_119;
...
{
l9_123=clamp(l9_119*2.0,0.0,1.0);
}
#else
{
float l9_124;
...
{
l9_124=clamp(dot(l9_120.xyz,vec3(l9_119)),0.0,1.0);
}
#else
{
float l9_125;
...
{
l9_126=(1.0-dot(l9_120.xyz,vec3(0.33333001)))*l9_119;
}
#else
{
float l9_127;
...
{
l9_127=(1.0-clamp(dot(l9_120.xyz,vec3(1.0)),0.0,1.0))*l9_119;
}
#else
{
float l9_128;
...
{
l9_128=clamp(dot(l9_120.xyz,vec3(1.0)),0.0,1.0)*l9_119;
}
#else
{
float l9_129;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_130=clamp(dot(l9_120.xyz,vec3(1.0)),0.0,1.0)*l9_119;
}
#else
{
float l9_131;
...
{
l9_131=dot(l9_120.xyz,vec3(0.33333001))*l9_119;
}
#else
{
float l9_132;
...
#if (sc_FramebufferFetch)
{
mediump vec4 l9_137=sc_readFragData0_Platform();
vec4 l9_138;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_139=l9_137;
l9_139.x=l9_137.x+_sc_framebufferFetchMarker;
l9_138=l9_139;
}
#else
{
...
#else
{
vec2 l9_140=sc_ScreenCoordsGlobalToView(l9_3);
int l9_141;
...
{
l9_142=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_140,sc_ScreenTextureLayout,l9_141),0.0);
}
#else
{
l9_142=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_140,sc_ScreenTextureLayout,l9_141).xy,0.0);
}
#endif
l9_136=l9_142;
}
...
{
vec4 l9_144=l9_136;
l9_144.x=l9_136.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_143=l9_144;
}
#else
{
...
#endif
vec3 l9_145=mix(l9_143.xyz,definedBlend(l9_143.xyz,l9_120.xyz).xyz,vec3(l9_119));
vec4 l9_146=vec4(l9_145.x,l9_145.y,l9_145.z,vec4(0.0).w);
l9_146.w=1.0;
l9_135=l9_146;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_147=vec4(mix(vec3(1.0),l9_120.xyz,vec3(l9_119)),l9_119);
}
#else
{
vec4 l9_148;
...
#endif
l9_148=vec4(l9_120.xyz*l9_149,l9_149);
}
#else
{
l9_148=l9_120;
...
#endif
vec4 l9_150=outputMotionVectorsIfNeeded(varPos,max(l9_121,vec4(0.0)));
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_153=sc_ScreenCoordsGlobalToView(l9_3);
...
#if (sc_OITCompositingPass)
{
vec2 l9_166=sc_ScreenCoordsGlobalToView(l9_3);
#if (sc_OITMaxLayers4Plus1)
{
