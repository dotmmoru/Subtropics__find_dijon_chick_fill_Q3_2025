...
#endif
vec4 l9_26=baseColor*l9_1;
float l9_27=l9_26.w*Port_Default_N204;
vec4 l9_28=vec4(l9_26.x,l9_26.y,l9_26.z,vec4(0.0).w);
l9_28.w=l9_27;
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_64=sc_ScreenCoordsGlobalToView(l9_0);
...
#if (sc_OITCompositingPass)
{
vec2 l9_77=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
