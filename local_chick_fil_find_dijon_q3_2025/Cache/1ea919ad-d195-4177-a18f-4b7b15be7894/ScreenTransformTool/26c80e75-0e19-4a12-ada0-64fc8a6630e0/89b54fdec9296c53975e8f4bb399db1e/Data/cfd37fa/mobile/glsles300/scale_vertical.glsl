...
float l9_1=mod(varPackedTex.y,l9_0);
float l9_2=1.0/(8.0+1.234e-06);
float l9_3=mod(varPackedTex.y,l9_2);
float l9_4=1.0/(40.0+1.234e-06);
float l9_5=mod(varPackedTex.y,l9_4);
float l9_6=(clamp(((clamp(((float(min(l9_1,l9_0-l9_1)<(0.003*widthScale))*step(varPackedTex.x,0.34999999))+(float(min(l9_3,l9_2-l9_3)<(0.0024999999*widthScale))*step(varPackedTex.x,0.25)))+0.001,0.001,1.001)-0.001)+(float(min(l9_5,l9_4-l9_5)<(0.0015*widthScale))*step(varPackedTex.x,0.15000001)))+0.001,0.001,1.001)-0.001)*colorjs.w;
