...
#endif
vec4 l9_49=baseColor*l9_1;
float l9_50=l9_49.w*1.0;
vec4 l9_51=vec4(l9_49.x,l9_49.y,l9_49.z,vec4(0.0).w);
l9_51.w=l9_50;
...
#if (sc_FramebufferFetch)
{
mediump vec4 l9_68=sc_readFragData0_Platform();
vec4 l9_69;
...
#else
{
vec2 l9_71=sc_ScreenCoordsGlobalToView(l9_0);
int l9_72;
...
{
l9_73=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_71,sc_ScreenTextureLayout,l9_72),0.0);
}
#else
{
l9_73=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_71,sc_ScreenTextureLayout,l9_72).xy,0.0);
}
#endif
l9_67=l9_73;
}
...
{
vec4 l9_75=l9_67;
l9_75.x=l9_67.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_74=l9_75;
}
#else
{
...
#endif
vec3 l9_76=mix(l9_74.xyz,definedBlend(l9_74.xyz,l9_51.xyz).xyz,vec3(l9_50));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_78=vec4(mix(vec3(1.0),l9_51.xyz,vec3(l9_50)),l9_50);
}
#else
{
vec4 l9_79;
...
#endif
vec4 l9_81=outputMotionVectorsIfNeeded(varPos,max(l9_52,vec4(0.0)));
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_84=sc_ScreenCoordsGlobalToView(l9_0);
...
#if (sc_OITCompositingPass)
{
vec2 l9_97=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
...
mediump vec4 l9_123=texture(sc_OITFilteredDepthBoundsTexture,l9_97);
