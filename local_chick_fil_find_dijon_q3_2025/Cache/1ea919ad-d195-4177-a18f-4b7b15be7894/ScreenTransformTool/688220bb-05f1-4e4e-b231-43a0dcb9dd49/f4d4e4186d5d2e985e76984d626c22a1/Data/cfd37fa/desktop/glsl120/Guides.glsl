...
uniform float Port_Input1_N039;
...
uniform float Port_Value3_N012;
uniform float Port_Value_N020;
uniform float Port_Input1_N042;
...
float l9_31=fract(((floor(float(sc_GetLocalInstanceID())+0.5)*Port_Input1_N031)+1.0)/(Tweak_N1Size.x*Port_Input1_N032));
float l9_32=(((floor(float(sc_GetLocalInstanceID())+0.5)/Tweak_N1Size.y)*Port_Input1_N037)+1.0)/(Tweak_N1Size.y*Port_Input1_N039);
int l9_33;
...
float l9_49=l9_48.x;
float l9_50=l9_39;
sc_SoftwareWrapLate(l9_49,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N1)!=0)),l9_50);
float l9_51=l9_48.y;
float l9_52=l9_50;
sc_SoftwareWrapLate(l9_51,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N1)!=0)),l9_52);
float l9_53=l9_52;
vec3 l9_54=sc_SamplingCoordsViewToGlobal(vec2(l9_49,l9_51),Tweak_N1Layout,l9_33);
vec4 l9_55;
#if (sc_CanUseTextureLod)
{
l9_55=texture2DLod(Tweak_N1,l9_54.xy,0.0);
}
#else
{
l9_55=vec4(0.0);
...
#endif
float l9_58=l9_31;
sc_SoftwareWrapEarly(l9_58,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x);
float l9_59=l9_58;
float l9_60=l9_32;
sc_SoftwareWrapEarly(l9_60,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y);
float l9_61=l9_60;
vec2 l9_62;
float l9_63;
...
{
l9_64=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x==3;
}
#else
{
...
float l9_65=l9_59;
float l9_66=1.0;
sc_ClampUV(l9_65,baseTexUvMinMax.x,baseTexUvMinMax.z,l9_64,l9_66);
float l9_67=l9_65;
float l9_68=l9_66;
bool l9_69;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_69=ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y==3;
}
#else
{
...
float l9_70=l9_61;
float l9_71=l9_68;
sc_ClampUV(l9_70,baseTexUvMinMax.y,baseTexUvMinMax.w,l9_69,l9_71);
l9_63=l9_71;
...
#endif
vec2 l9_72=sc_TransformUV(l9_62,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform);
float l9_73=l9_72.x;
float l9_74=l9_63;
sc_SoftwareWrapLate(l9_73,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_74);
float l9_75=l9_72.y;
float l9_76=l9_74;
sc_SoftwareWrapLate(l9_75,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0)),l9_76);
float l9_77=l9_76;
vec3 l9_78=sc_SamplingCoordsViewToGlobal(vec2(l9_73,l9_75),baseTexLayout,l9_57);
vec4 l9_79;
#if (sc_CanUseTextureLod)
{
l9_79=texture2DLod(baseTex,l9_78.xy,0.0);
}
#else
{
l9_79=vec4(0.0);
...
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
l9_80=mix(baseTexBorderColor,l9_79,vec4(l9_77));
}
#else
{
l9_80=l9_79;
...
#endif
vec3 l9_81=l9_56.xyz-l9_80.xyz;
vec3 l9_82=vec3(l9_81.y,Port_Input0_N018-l9_81.x,Port_Value3_N012);
float l9_83=dot(l9_82,l9_82);
float l9_84;
if (l9_83>0.0)
{
l9_84=1.0/sqrt(l9_83);
}
else
{
l9_84=0.0;
}
vec3 l9_85=l9_82*l9_84;
float l9_86=(Port_Value_N020+0.001)-0.001;
vec3 l9_87;
vec3 l9_88;
vec3 l9_89;
if (l9_27)
{
l9_89=varTangent.xyz;
l9_88=varNormal;
l9_87=varPos;
}
else
...
l9_89=varTangent.xyz;
l9_88=l9_30;
l9_87=((mix(l9_85,l9_85*vec3(smoothstep(Port_Input0_N049,l9_86,clamp(l9_86-length(l9_82),Port_Input1_N042,l9_86))),vec3(0.001-0.001))*vec3(l9_28.x+Port_Input1_N016))*vec3(width*(cameraSize/(Port_Input1_N047+1.234e-06))))+(l9_80.xyz+(l9_81*vec3(l9_28.y)));
}
varPos=l9_87;
varNormal=normalize(l9_88);
vec3 l9_90=normalize(l9_89);
varTangent=vec4(l9_90.x,l9_90.y,l9_90.z,varTangent.w);
...
#if (sc_RenderingSpace==3)
{
l9_91=sc_ProjectionMatrixInverseArray[sc_GetStereoViewIndex()]*l9_17;
}
#else
{
vec4 l9_92;
#if (sc_RenderingSpace==2)
{
l9_92=sc_ViewMatrixArray[sc_GetStereoViewIndex()]*l9_17;
}
#else
{
vec4 l9_93;
#if (sc_RenderingSpace==1)
{
l9_93=sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_17;
}
#else
{
l9_93=l9_17;
...
#if (sc_RenderingSpace==4)
{
l9_95=(sc_ModelViewMatrixArray[sc_GetStereoViewIndex()]*l9_17)*vec4(1.0/sc_Camera.aspect,1.0,1.0,1.0);
}
#else
{
vec4 l9_96;
#if (sc_RenderingSpace==2)
{
l9_96=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPos,1.0);
}
#else
{
vec4 l9_97;
#if (sc_RenderingSpace==1)
{
l9_97=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPos,1.0);
}
#else
{
l9_97=vec4(0.0);
...
#endif
vec4 l9_99=sc_ProjectorMatrix*l9_98;
varShadowTex=((l9_99.xy/vec2(l9_99.w))*0.5)+vec2(0.5);
}
#endif
vec4 l9_100;
...
{
vec4 l9_102=l9_94;
l9_102.z=((log2(max(sc_Camera.clipPlanes.x,1.0+l9_94.w))*(2.0/log2(sc_Camera.clipPlanes.y+1.0)))-1.0)*l9_94.w;
l9_101=l9_102;
}
else
{
...
{
vec4 l9_104=l9_100;
l9_104.x=l9_100.x+(sc_UniformConstants.x*float(sc_ShaderCacheConstant));
l9_103=l9_104;
}
#else
{
...
{
float l9_105=dot(l9_103,sc_StereoClipPlanes[sc_StereoViewID]);
#if (sc_StereoRendering_IsClipDistanceEnabled==1)
{
sc_SetClipDistancePlatform(l9_105);
}
#else
{
varClipDistance=l9_105;
}
#endif
}
#endif
