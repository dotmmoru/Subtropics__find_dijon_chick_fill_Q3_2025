...
float l9_113=((((((l9_108+l9_109)-max(l9_108,l9_109))+l9_109)-0.0)/(1.0-0.0))*(l9_111-l9_112))+l9_112;
float l9_114;
if (l9_111>l9_112)
{
l9_114=clamp(l9_113,l9_112,l9_111);
}
else
{
l9_114=clamp(l9_113,l9_111,l9_112);
}
vec4 l9_115=vec4(l9_114);
vec4 l9_116;
#if ((Tweak_N139)==0)
{
l9_116=vec4(0.0);
...
#else
{
l9_117=vec4(1.0,0.0,0.0,0.0);
}
#endif
l9_116=l9_117;
}
#endif
vec4 l9_118=mix(mix(mix(l9_101,vec4(0.0),vec4((0.001-0.001)*l9_105)),vec4(shapeColor.xyz,1.0),l9_115),l9_116,vec4(l9_108));
float l9_119=l9_118.w;
...
{
l9_122=clamp(l9_119*2.0,0.0,1.0);
}
#else
{
float l9_123;
...
{
l9_123=clamp(dot(l9_118.xyz,vec3(l9_119)),0.0,1.0);
}
#else
{
float l9_124;
...
{
l9_125=(1.0-dot(l9_118.xyz,vec3(0.33333001)))*l9_119;
}
#else
{
float l9_126;
...
{
l9_126=(1.0-clamp(dot(l9_118.xyz,vec3(1.0)),0.0,1.0))*l9_119;
}
#else
{
float l9_127;
...
{
l9_127=clamp(dot(l9_118.xyz,vec3(1.0)),0.0,1.0)*l9_119;
}
#else
{
float l9_128;
#if (sc_BlendMode_Add)
{
l9_128=clamp(dot(l9_118.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_129;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_129=clamp(dot(l9_118.xyz,vec3(1.0)),0.0,1.0)*l9_119;
}
#else
{
float l9_130;
...
{
l9_130=dot(l9_118.xyz,vec3(0.33333001))*l9_119;
}
#else
{
float l9_131;
#if (sc_BlendMode_Min)
{
l9_131=1.0-clamp(dot(l9_118.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_132;
#if (sc_BlendMode_Max)
{
l9_132=clamp(dot(l9_118.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_132=1.0;
...
#endif
l9_120=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_118.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_121);
}
#else
{
vec4 l9_133;
...
#if (sc_FramebufferFetch)
{
mediump vec4 l9_136=sc_readFragData0_Platform();
vec4 l9_137;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_138=l9_136;
l9_138.x=l9_136.x+_sc_framebufferFetchMarker;
l9_137=l9_138;
}
#else
{
...
{
l9_141=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_139,sc_ScreenTextureLayout,l9_140),0.0);
}
#else
{
l9_141=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_139,sc_ScreenTextureLayout,l9_140).xy,0.0);
}
#endif
l9_135=l9_141;
}
...
{
vec4 l9_143=l9_135;
l9_143.x=l9_135.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_142=l9_143;
}
#else
{
...
#endif
vec3 l9_144=mix(l9_142.xyz,definedBlend(l9_142.xyz,l9_118.xyz).xyz,vec3(l9_119));
vec4 l9_145=vec4(l9_144.x,l9_144.y,l9_144.z,vec4(0.0).w);
l9_145.w=1.0;
l9_134=l9_145;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_146=vec4(mix(vec3(1.0),l9_118.xyz,vec3(l9_119)),l9_119);
}
#else
{
vec4 l9_147;
...
#endif
l9_147=vec4(l9_118.xyz*l9_148,l9_148);
}
#else
{
l9_147=l9_118;
...
#endif
vec4 l9_149=outputMotionVectorsIfNeeded(varPos,max(l9_120,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_151-0.0039215689)),min(1.0,l9_151+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#endif
int l9_153=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_152).xy);
float l9_154=packValue(l9_153);
int l9_161=int(l9_150.w*255.0);
float l9_162=packValue(l9_161);
sc_writeFragData0(vec4(packValue(l9_153),packValue(l9_153),packValue(l9_153),packValue(l9_153)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_165).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_170==0)
{
l9_173=texture(sc_OITAlpha0,l9_165);
l9_172=texture(sc_OITDepthLow0,l9_165);
l9_171=texture(sc_OITDepthHigh0,l9_165);
}
else
{
l9_173=vec4(0.0);
...
if (l9_170==1)
{
l9_176=texture(sc_OITAlpha1,l9_165);
l9_175=texture(sc_OITDepthLow1,l9_165);
l9_174=texture(sc_OITDepthHigh1,l9_165);
}
else
{
l9_176=l9_173;
...
mediump vec4 l9_191=texture(sc_OITFilteredDepthBoundsTexture,l9_165);
