...
#endif
float l9_128=l9_127-0.001;
float l9_129=1.0-l9_128;
float l9_130=((((((l9_125+l9_126)-max(l9_125,l9_126))+l9_126)-Port_RangeMinA_N143)/(Port_RangeMaxA_N143-Port_RangeMinA_N143))*(l9_128-l9_129))+l9_129;
float l9_131;
if (l9_128>l9_129)
{
l9_131=clamp(l9_130,l9_129,l9_128);
}
else
{
l9_131=clamp(l9_130,l9_128,l9_129);
}
vec4 l9_132=vec4(l9_131);
vec4 l9_133;
#if ((Tweak_N139)==0)
{
l9_133=Port_Value0_N140;
}
#else
{
vec4 l9_134;
...
#else
{
l9_134=Port_Default_N140;
}
#endif
l9_133=l9_134;
}
#endif
vec4 l9_135=mix(mix(mix(l9_114,vec4(Port_Input1_N259),vec4((0.001-0.001)*l9_121)),vec4(shapeColor.xyz,1.0),l9_132),l9_133,vec4(l9_125));
float l9_136=l9_135.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_136<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_136<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_139=clamp(l9_136*2.0,0.0,1.0);
}
#else
{
float l9_140;
...
{
l9_140=clamp(dot(l9_135.xyz,vec3(l9_136)),0.0,1.0);
}
#else
{
float l9_141;
...
{
l9_142=(1.0-dot(l9_135.xyz,vec3(0.33333001)))*l9_136;
}
#else
{
float l9_143;
...
{
l9_143=(1.0-clamp(dot(l9_135.xyz,vec3(1.0)),0.0,1.0))*l9_136;
}
#else
{
float l9_144;
...
{
l9_144=clamp(dot(l9_135.xyz,vec3(1.0)),0.0,1.0)*l9_136;
}
#else
{
float l9_145;
#if (sc_BlendMode_Add)
{
l9_145=clamp(dot(l9_135.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_146;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_146=clamp(dot(l9_135.xyz,vec3(1.0)),0.0,1.0)*l9_136;
}
#else
{
float l9_147;
...
{
l9_147=dot(l9_135.xyz,vec3(0.33333001))*l9_136;
}
#else
{
float l9_148;
#if (sc_BlendMode_Min)
{
l9_148=1.0-clamp(dot(l9_135.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_149;
#if (sc_BlendMode_Max)
{
l9_149=clamp(dot(l9_135.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_149=1.0;
...
#endif
l9_137=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_135.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_138);
}
#else
{
vec4 l9_150;
...
#if (sc_FramebufferFetch)
{
vec4 l9_153=sc_readFragData0_Platform();
vec4 l9_154;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_155=l9_153;
l9_155.x=l9_153.x+_sc_framebufferFetchMarker;
l9_154=l9_155;
}
#else
{
...
#else
{
vec2 l9_156=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
int l9_157;
...
#endif
l9_152=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_156,sc_ScreenTextureLayout,l9_157).xy,0.0);
}
#endif
vec4 l9_158;
...
{
vec4 l9_159=l9_152;
l9_159.x=l9_152.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_158=l9_159;
}
#else
{
...
#endif
vec3 l9_160=mix(l9_158.xyz,definedBlend(l9_158.xyz,l9_135.xyz).xyz,vec3(l9_136));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_162=vec4(mix(vec3(1.0),l9_135.xyz,vec3(l9_136)),l9_136);
}
#else
{
vec4 l9_163;
...
#endif
l9_163=vec4(l9_135.xyz*l9_164,l9_164);
}
#else
{
l9_163=l9_135;
...
{
l9_167=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_167=vec4(0.0);
...
vec4 l9_169=outputMotionVectorsIfNeeded(varPos,max(l9_168,vec4(0.0)));
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_172).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_173=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_172).xy);
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_185).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_190==0)
{
l9_193=texture2D(sc_OITAlpha0,l9_185);
l9_192=texture2D(sc_OITDepthLow0,l9_185);
l9_191=texture2D(sc_OITDepthHigh0,l9_185);
}
else
{
l9_193=vec4(0.0);
...
if (l9_190==1)
{
l9_196=texture2D(sc_OITAlpha1,l9_185);
l9_195=texture2D(sc_OITDepthLow1,l9_185);
l9_194=texture2D(sc_OITDepthHigh1,l9_185);
}
else
{
l9_196=l9_193;
...
vec4 l9_211=texture2D(sc_OITFilteredDepthBoundsTexture,l9_185);
