...
uniform float Port_Input0_N052;
...
uniform float Port_Input0_N026;
uniform float Port_Import_N016;
...
#endif
float l9_0=Port_Input0_N052/(max(Port_Import_N051,1.0)+1.234e-06);
float l9_1=mod(varPackedTex.x,l9_0);
float l9_2=Port_Input0_N026/(max(Port_Import_N016,1.0)+1.234e-06);
float l9_3=mod(varPackedTex.x,l9_2);
float l9_4=Port_Input0_N028/(max(Port_Import_N006,1.0)+1.234e-06);
float l9_5=mod(varPackedTex.x,l9_4);
float l9_6=(clamp(((clamp(((float(min(l9_1,l9_0-l9_1)<(Port_Import_N056*widthScale))*step(varPackedTex.y,Port_Input1_N035))+(float(min(l9_3,l9_2-l9_3)<(Port_Import_N044*widthScale))*step(varPackedTex.y,Port_Input1_N014)))+0.001,Port_Input1_N001+0.001,Port_Input2_N001+0.001)-0.001)+(float(min(l9_5,l9_4-l9_5)<(Port_Import_N007*widthScale))*step(varPackedTex.y,Port_Input1_N021)))+0.001,Port_Input1_N031+0.001,Port_Input2_N031+0.001)-0.001)*colorjs.w;
