...
#endif
float l9_0=1.0/(4.0+1.234e-06);
float l9_1=mod(varPackedTex.x,l9_0);
float l9_2=1.0/(8.0+1.234e-06);
float l9_3=mod(varPackedTex.x,l9_2);
float l9_4=1.0/(40.0+1.234e-06);
float l9_5=mod(varPackedTex.x,l9_4);
float l9_6=(clamp(((clamp(((float(min(l9_1,l9_0-l9_1)<(0.003*widthScale))*step(varPackedTex.y,0.34999999))+(float(min(l9_3,l9_2-l9_3)<(0.0024999999*widthScale))*step(varPackedTex.y,0.25)))+0.001,0.001,1.001)-0.001)+(float(min(l9_5,l9_4-l9_5)<(0.0015*widthScale))*step(varPackedTex.y,0.15000001)))+0.001,0.001,1.001)-0.001)*colorjs.w;
vec4 l9_7=vec4(colorjs.xyz,l9_6);
...
#if (sc_FramebufferFetch)
{
mediump vec4 l9_24=sc_readFragData0_Platform();
vec4 l9_25;
...
{
l9_29=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_27,sc_ScreenTextureLayout,l9_28),0.0);
}
#else
{
l9_29=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_27,sc_ScreenTextureLayout,l9_28).xy,0.0);
}
#endif
l9_23=l9_29;
}
...
#endif
vec3 l9_32=mix(l9_30.xyz,definedBlend(l9_30.xyz,l9_7.xyz).xyz,vec3(l9_6));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_34=vec4(mix(vec3(1.0),l9_7.xyz,vec3(l9_6)),l9_6);
}
#else
{
vec4 l9_35;
...
#endif
l9_35=vec4(l9_7.xyz*l9_36,l9_36);
}
#else
{
l9_35=l9_7;
...
#endif
vec4 l9_37=outputMotionVectorsIfNeeded(varPos,max(l9_8,vec4(0.0)));
