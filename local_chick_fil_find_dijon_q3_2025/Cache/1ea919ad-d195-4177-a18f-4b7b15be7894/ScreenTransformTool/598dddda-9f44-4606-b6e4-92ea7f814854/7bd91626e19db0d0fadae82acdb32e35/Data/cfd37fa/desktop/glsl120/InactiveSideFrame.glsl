...
vec4 l9_1=baseColor*Port_Default_N369;
float l9_2=l9_1.w*Port_Default_N204;
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_39=sc_ScreenCoordsGlobalToView(l9_0);
...
#if (sc_OITCompositingPass)
{
vec2 l9_52=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
