...
vec4 l9_1=baseColor*vec4(1.0);
float l9_2=l9_1.w*1.0;
vec4 l9_3=vec4(l9_1.x,l9_1.y,l9_1.z,vec4(0.0).w);
l9_3.w=l9_2;
...
#else
{
vec2 l9_23=sc_ScreenCoordsGlobalToView(l9_0);
int l9_24;
...
#endif
vec3 l9_28=mix(l9_26.xyz,definedBlend(l9_26.xyz,l9_3.xyz).xyz,vec3(l9_2));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_30=vec4(mix(vec3(1.0),l9_3.xyz,vec3(l9_2)),l9_2);
}
#else
{
vec4 l9_31;
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_36=sc_ScreenCoordsGlobalToView(l9_0);
...
#if (sc_OITCompositingPass)
{
vec2 l9_49=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
