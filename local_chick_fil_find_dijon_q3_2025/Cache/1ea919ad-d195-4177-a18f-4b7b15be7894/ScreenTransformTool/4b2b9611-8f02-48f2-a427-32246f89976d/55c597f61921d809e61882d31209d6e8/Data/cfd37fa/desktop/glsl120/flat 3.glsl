...
float l9_24=l9_23;
vec3 l9_25=sc_SamplingCoordsViewToGlobal(vec2(l9_20,l9_22),baseTexLayout,l9_4);
vec4 l9_26=texture2D(baseTex,l9_25.xy,0.0);
vec4 l9_27;
#if (SC_USE_CLAMP_TO_BORDER_baseTex)
{
...
#endif
vec4 l9_28=baseColor*l9_3;
float l9_29=l9_28.w*Port_Default_N204;
vec3 l9_30=vec3(sin(l9_2));
...
{
l9_35=clamp(dot(l9_31.xyz,vec3(l9_29)),0.0,1.0);
}
#else
{
float l9_36;
...
{
l9_37=(1.0-dot(l9_31.xyz,vec3(0.33333001)))*l9_29;
}
#else
{
float l9_38;
...
{
l9_38=(1.0-clamp(dot(l9_31.xyz,vec3(1.0)),0.0,1.0))*l9_29;
}
#else
{
float l9_39;
...
{
l9_39=clamp(dot(l9_31.xyz,vec3(1.0)),0.0,1.0)*l9_29;
}
#else
{
float l9_40;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_41=clamp(dot(l9_31.xyz,vec3(1.0)),0.0,1.0)*l9_29;
}
#else
{
float l9_42;
...
{
l9_42=dot(l9_31.xyz,vec3(0.33333001))*l9_29;
}
#else
{
float l9_43;
...
#else
{
vec2 l9_51=sc_ScreenCoordsGlobalToView(l9_1);
int l9_52;
...
#endif
l9_47=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_51,sc_ScreenTextureLayout,l9_52).xy,0.0);
}
#endif
vec4 l9_53;
...
#endif
vec3 l9_55=mix(l9_53.xyz,definedBlend(l9_53.xyz,l9_31.xyz).xyz,vec3(l9_29));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_57=vec4(mix(vec3(1.0),l9_31.xyz,vec3(l9_29)),l9_29);
}
#else
{
vec4 l9_58;
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_67=sc_ScreenCoordsGlobalToView(l9_1);
...
#if (sc_OITCompositingPass)
{
vec2 l9_80=sc_ScreenCoordsGlobalToView(l9_1);
#if (sc_OITMaxLayers4Plus1)
{
