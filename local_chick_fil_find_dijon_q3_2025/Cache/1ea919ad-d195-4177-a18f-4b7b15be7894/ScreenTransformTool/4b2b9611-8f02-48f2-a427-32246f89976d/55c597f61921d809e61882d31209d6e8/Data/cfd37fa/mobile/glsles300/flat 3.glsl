...
#endif
vec4 l9_51=baseColor*l9_3;
float l9_52=l9_51.w*1.0;
vec3 l9_53=vec3(sin(l9_2));
...
{
l9_58=clamp(dot(l9_54.xyz,vec3(l9_52)),0.0,1.0);
}
#else
{
float l9_59;
...
{
l9_60=(1.0-dot(l9_54.xyz,vec3(0.33333001)))*l9_52;
}
#else
{
float l9_61;
...
{
l9_61=(1.0-clamp(dot(l9_54.xyz,vec3(1.0)),0.0,1.0))*l9_52;
}
#else
{
float l9_62;
...
{
l9_62=clamp(dot(l9_54.xyz,vec3(1.0)),0.0,1.0)*l9_52;
}
#else
{
float l9_63;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_64=clamp(dot(l9_54.xyz,vec3(1.0)),0.0,1.0)*l9_52;
}
#else
{
float l9_65;
...
{
l9_65=dot(l9_54.xyz,vec3(0.33333001))*l9_52;
}
#else
{
float l9_66;
...
#if (sc_FramebufferFetch)
{
mediump vec4 l9_71=sc_readFragData0_Platform();
vec4 l9_72;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_73=l9_71;
l9_73.x=l9_71.x+_sc_framebufferFetchMarker;
l9_72=l9_73;
}
#else
{
...
#else
{
vec2 l9_74=sc_ScreenCoordsGlobalToView(l9_1);
int l9_75;
...
{
l9_76=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_74,sc_ScreenTextureLayout,l9_75),0.0);
}
#else
{
l9_76=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_74,sc_ScreenTextureLayout,l9_75).xy,0.0);
}
#endif
l9_70=l9_76;
}
...
{
vec4 l9_78=l9_70;
l9_78.x=l9_70.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_77=l9_78;
}
#else
{
...
#endif
vec3 l9_79=mix(l9_77.xyz,definedBlend(l9_77.xyz,l9_54.xyz).xyz,vec3(l9_52));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_81=vec4(mix(vec3(1.0),l9_54.xyz,vec3(l9_52)),l9_52);
}
#else
{
vec4 l9_82;
...
#endif
l9_82=vec4(l9_54.xyz*l9_83,l9_83);
}
#else
{
l9_82=l9_54;
...
#endif
vec4 l9_84=outputMotionVectorsIfNeeded(varPos,max(l9_55,vec4(0.0)));
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_87=sc_ScreenCoordsGlobalToView(l9_1);
...
#if (sc_OITCompositingPass)
{
vec2 l9_100=sc_ScreenCoordsGlobalToView(l9_1);
#if (sc_OITMaxLayers4Plus1)
{
...
mediump vec4 l9_126=texture(sc_OITFilteredDepthBoundsTexture,l9_100);
