...
#endif
float l9_0=1.0-edgeSize;
bool l9_1=(float(l9_0<varPackedTex.y)*1.0)!=0.0;
bool l9_2;
if (!l9_1)
{
l9_2=(float(varPackedTex.y<edgeSize)*1.0)!=0.0;
}
else
{
l9_2=l9_1;
...
bool l9_4=(float(varPackedTex.x<edgeSize)*1.0)!=0.0;
bool l9_5;
if (!l9_4)
{
l9_5=(float(l9_0<varPackedTex.x)*1.0)!=0.0;
}
else
{
l9_5=l9_4;
}
float l9_6=float(l9_5);
bool l9_7=(l9_3*1.0)!=0.0;
bool l9_8;
if (!l9_7)
{
l9_8=(l9_6*1.0)!=0.0;
...
vec4 l9_10=vec4(baseColor.xyz,l9_9);
...
#if (sc_FramebufferFetch)
{
mediump vec4 l9_27=sc_readFragData0_Platform();
vec4 l9_28;
...
{
l9_32=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_30,sc_ScreenTextureLayout,l9_31),0.0);
}
#else
{
l9_32=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_30,sc_ScreenTextureLayout,l9_31).xy,0.0);
}
#endif
l9_26=l9_32;
}
...
#endif
vec4 l9_40=outputMotionVectorsIfNeeded(varPos,max(l9_11,vec4(0.0)));
...
mediump vec4 l9_82=texture(sc_OITFilteredDepthBoundsTexture,l9_56);
vec2 l9_83=l9_82.xy;
int l9_84;
#if (sc_SkinBonesCount>0)
{
