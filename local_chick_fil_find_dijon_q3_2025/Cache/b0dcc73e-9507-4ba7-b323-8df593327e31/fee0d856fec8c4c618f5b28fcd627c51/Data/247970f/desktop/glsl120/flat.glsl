...
//spec_const bool uv2EnableAnimation 81 0
//spec_const bool uv3EnableAnimation 82 0
//spec_const int NODE_13_DROPLIST_ITEM 83 0
//spec_const int NODE_27_DROPLIST_ITEM 84 0
//spec_const int NODE_49_DROPLIST_ITEM 85 0
//spec_const int NODE_69_DROPLIST_ITEM 86 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 87 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 88 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_opacityTex 89 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 90 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 91 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_opacityTex 92 -1
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_94=vec4(mix(vec3(1.0),l9_73.xyz,vec3(l9_72)),l9_72);
}
#else
{
vec4 l9_95;
...
#endif
l9_95=vec4(l9_73.xyz*l9_96,l9_96);
}
#else
{
l9_95=l9_73;
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_102=sc_ScreenCoordsGlobalToView(l9_0);
...
#endif
int l9_103=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_102).xy);
...
#if (sc_OITCompositingPass)
{
vec2 l9_115=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_115).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_120==0)
{
l9_123=texture2D(sc_OITAlpha0,l9_115);
l9_122=texture2D(sc_OITDepthLow0,l9_115);
l9_121=texture2D(sc_OITDepthHigh0,l9_115);
}
else
{
l9_123=vec4(0.0);
...
if (l9_120==1)
{
l9_126=texture2D(sc_OITAlpha1,l9_115);
l9_125=texture2D(sc_OITDepthLow1,l9_115);
l9_124=texture2D(sc_OITDepthHigh1,l9_115);
}
else
{
l9_126=l9_123;
...
vec4 l9_141=texture2D(sc_OITFilteredDepthBoundsTexture,l9_115);
