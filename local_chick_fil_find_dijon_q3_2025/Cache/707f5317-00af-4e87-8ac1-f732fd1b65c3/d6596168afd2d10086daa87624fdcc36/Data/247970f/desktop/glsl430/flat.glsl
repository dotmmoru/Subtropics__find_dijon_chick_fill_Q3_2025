...
//spec_const bool sc_ProxyAlphaOne 76 0
...
//spec_const bool uv2EnableAnimation 82 0
//spec_const bool uv3EnableAnimation 83 0
//spec_const int NODE_13_DROPLIST_ITEM 84 0
//spec_const int NODE_27_DROPLIST_ITEM 85 0
//spec_const int NODE_49_DROPLIST_ITEM 86 0
//spec_const int NODE_69_DROPLIST_ITEM 87 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 88 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 89 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_opacityTex 90 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 91 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 92 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_opacityTex 93 -1
//spec_const int baseTexLayout 94 0
//spec_const int intensityTextureLayout 95 0
//spec_const int opacityTexLayout 96 0
...
//spec_const int sc_StereoViewID 104 0
//SG_REFLECTION_END
...
#if (sc_FramebufferFetch)
{
l9_142=sc_readFragData0_Platform();
}
#else
{
vec2 l9_143=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
vec4 l9_144;
#if (sc_ScreenTextureLayout==2)
{
l9_144=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_143,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_144=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_143,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_142=l9_144;
}
#endif
vec3 l9_145=mix(l9_142.xyz,definedBlend(l9_142.xyz,l9_124.xyz).xyz,vec3(l9_123));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_147=vec4(mix(vec3(1.0),l9_124.xyz,vec3(l9_123)),l9_123);
}
#else
{
vec4 l9_148;
...
#endif
l9_148=vec4(l9_124.xyz*l9_149,l9_149);
}
#else
{
l9_148=l9_124;
...
vec4 l9_152=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_150,vec4(0.0)));
vec4 l9_153=clamp(l9_152,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_154=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_154-0.0039215689)),min(1.0,l9_154+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_155).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_156=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_155).xy);
float l9_157=packValue(l9_156);
int l9_164=int(l9_153.w*255.0);
float l9_165=packValue(l9_164);
sc_writeFragData0Internal(vec4(packValue(l9_156),packValue(l9_156),packValue(l9_156),packValue(l9_156)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_157,packValue(l9_156),packValue(l9_156),packValue(l9_156)));
sc_writeFragData2(vec4(l9_165,packValue(l9_164),packValue(l9_164),packValue(l9_164)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_168=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_168).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_173==0)
{
l9_176=texture(sc_OITAlpha0,l9_168);
l9_175=texture(sc_OITDepthLow0,l9_168);
l9_174=texture(sc_OITDepthHigh0,l9_168);
}
else
{
l9_176=vec4(0.0);
...
if (l9_173==1)
{
l9_179=texture(sc_OITAlpha1,l9_168);
l9_178=texture(sc_OITDepthLow1,l9_168);
l9_177=texture(sc_OITDepthHigh1,l9_168);
}
else
{
l9_179=l9_176;
...
if (any(notEqual(l9_177,vec4(0.0)))||any(notEqual(l9_178,vec4(0.0))))
{
int l9_180[8]=l9_169;
unpackValues(l9_177.w,l9_173,l9_180);
unpackValues(l9_177.z,l9_173,l9_180);
unpackValues(l9_177.y,l9_173,l9_180);
unpackValues(l9_177.x,l9_173,l9_180);
unpackValues(l9_178.w,l9_173,l9_180);
unpackValues(l9_178.z,l9_173,l9_180);
unpackValues(l9_178.y,l9_173,l9_180);
unpackValues(l9_178.x,l9_173,l9_180);
int l9_189[8]=l9_170;
unpackValues(l9_179.w,l9_173,l9_189);
unpackValues(l9_179.z,l9_173,l9_189);
unpackValues(l9_179.y,l9_173,l9_189);
unpackValues(l9_179.x,l9_173,l9_189);
}
l9_173++;
continue;
}
...
vec4 l9_194=texture(sc_OITFilteredDepthBoundsTexture,l9_168);
vec2 l9_195=l9_194.xy;
int l9_196;
#if (sc_SkinBonesCount>0)
{
l9_196=encodeDepth(((1.0-l9_194.x)*1000.0)+getDepthOrderingEpsilon(),l9_195);
}
#else
{
l9_196=0;
...
#endif
int l9_197=encodeDepth(viewSpaceDepth(),l9_195);
vec4 l9_198;
l9_198=l9_153*l9_153.w;
vec4 l9_199;
int l9_200=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_200<8)
{
int l9_201=l9_169[l9_200];
int l9_202=l9_197-l9_196;
bool l9_203=l9_201<l9_202;
bool l9_204;
if (l9_203)
{
l9_204=l9_169[l9_200]>0;
}
else
{
l9_204=l9_203;
...
if (l9_204)
{
vec3 l9_205=l9_198.xyz*(1.0-(float(l9_170[l9_200])/255.0));
l9_199=vec4(l9_205.x,l9_205.y,l9_205.z,l9_198.w);
}
else
{
l9_199=l9_198;
...
sc_writeFragData0Internal(l9_153,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
