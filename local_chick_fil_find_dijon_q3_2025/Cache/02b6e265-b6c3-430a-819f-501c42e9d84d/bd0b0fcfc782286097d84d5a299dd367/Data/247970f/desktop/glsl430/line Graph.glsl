...
//sampler sampler sc_RayTracedDiffIndTextureSmpSC 0:45
//sampler sampler sc_RayTracedShadowTextureSmpSC 0:47
//sampler sampler sc_SSAOTextureSmpSC 0:48
//sampler sampler sc_ScreenTextureSmpSC 0:49
//sampler sampler sc_ShadowTextureSmpSC 0:50
//sampler sampler z_hitIdAndBarycentricSmp 0:52
//sampler sampler z_rayDirectionsSmpSC 0:53
...
//texture texture2D sc_RayTracedDiffIndTexture 0:23:0:45
//texture texture2D sc_RayTracedShadowTexture 0:25:0:47
//texture texture2D sc_SSAOTexture 0:26:0:48
//texture texture2D sc_ScreenTexture 0:27:0:49
//texture texture2D sc_ShadowTexture 0:28:0:50
//texture utexture2D z_hitIdAndBarycentric 0:30:0:52
//texture texture2D z_rayDirections 0:31:0:53
...
//texture texture2DArray sc_RayTracedDiffIndTextureArrSC 0:66:0:45
//texture texture2DArray sc_RayTracedShadowTextureArrSC 0:68:0:47
//texture texture2DArray sc_ScreenTextureArrSC 0:69:0:49
...
//spec_const bool sc_ProjectiveShadowsCaster 117 0
//spec_const bool sc_ProjectiveShadowsReceiver 118 0
//spec_const bool sc_ProxyAlphaOne 119 0
//spec_const bool sc_RayTracedDiffIndTextureHasSwappedViews 120 0
//spec_const bool sc_RayTracedShadowTextureHasSwappedViews 121 0
//spec_const bool sc_RenderAlphaToColor 122 0
//spec_const bool sc_SSAOEnabled 123 0
//spec_const bool sc_ScreenTextureHasSwappedViews 124 0
//spec_const bool sc_TAAEnabled 125 0
//spec_const bool sc_VertexBlending 126 0
//spec_const bool sc_VertexBlendingUseNormals 127 0
...
//spec_const int sc_RayTracedShadowTextureLayout 188 0
...
{
bool l9_438=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0));
float l9_439=l9_437.x;
sc_SoftwareWrapEarly(l9_439,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_440=l9_439;
float l9_441=l9_437.y;
sc_SoftwareWrapEarly(l9_441,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_442=l9_441;
vec2 l9_443;
float l9_444;
...
{
l9_445=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
l9_445=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_446=l9_440;
float l9_447=1.0;
sc_ClampUV(l9_446,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_445,l9_447);
float l9_448=l9_446;
float l9_449=l9_447;
bool l9_450;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_450=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
l9_450=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_451=l9_442;
float l9_452=l9_449;
sc_ClampUV(l9_451,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_450,l9_452);
l9_444=l9_452;
l9_443=vec2(l9_448,l9_451);
}
#else
{
l9_444=1.0;
l9_443=vec2(l9_440,l9_442);
}
#endif
vec2 l9_453=sc_TransformUV(l9_443,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_454=l9_453.x;
float l9_455=l9_444;
sc_SoftwareWrapLate(l9_454,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,l9_438,l9_455);
float l9_456=l9_453.y;
float l9_457=l9_455;
sc_SoftwareWrapLate(l9_456,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,l9_438,l9_457);
}
#else
{
bool l9_458=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0));
float l9_459=l9_437.x;
sc_SoftwareWrapEarly(l9_459,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_460=l9_459;
float l9_461=l9_437.y;
...
#endif
float l9_479=clamp(l9_110,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
if (l9_479<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_479<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
#endif
if (dot(l9_5,l9_478)>=(-0.050000001))
{
uvec3 l9_480=uvec3(round((varPos-OriginNormalizationOffset)*OriginNormalizationScale));
position_and_mask=uvec4(l9_480.x,l9_480.y,l9_480.z,position_and_mask.w);
position_and_mask.w=uint(receiver_mask);
vec3 l9_481=abs(l9_478);
vec3 l9_482=l9_478/vec3(dot(l9_481,vec3(1.0)));
float l9_483=clamp(-l9_482.z,0.0,1.0);
float l9_484=l9_482.x;
float l9_485;
if (l9_484>=0.0)
{
l9_485=l9_483;
...
float l9_486=l9_484+l9_485;
float l9_487=l9_482.y;
float l9_488;
if (l9_487>=0.0)
{
l9_488=l9_483;
...
uvec2 l9_489=uvec2(packHalf2x16(vec2(l9_486,0.0)),packHalf2x16(vec2(l9_487+l9_488,0.0)));
normal_and_more=uvec4(l9_489.x,l9_489.y,normal_and_more.z,normal_and_more.w);
...
#if (ENABLE_MATERIAL_PARAM_TEX)
{
vec2 l9_453=N7_getUV(NODE_221_DROPLIST_ITEM);
vec4 l9_454;
#if (materialParamsTexLayout==2)
{
bool l9_455=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0));
float l9_456=l9_453.x;
sc_SoftwareWrapEarly(l9_456,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_457=l9_456;
float l9_458=l9_453.y;
sc_SoftwareWrapEarly(l9_458,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_459=l9_458;
vec2 l9_460;
float l9_461;
#if (SC_USE_UV_MIN_MAX_materialParamsTex)
...
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_462=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
l9_462=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_463=l9_457;
float l9_464=1.0;
sc_ClampUV(l9_463,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_462,l9_464);
float l9_465=l9_463;
float l9_466=l9_464;
bool l9_467;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_467=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
...
float l9_468=l9_459;
float l9_469=l9_466;
sc_ClampUV(l9_468,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_467,l9_469);
l9_461=l9_469;
...
#endif
vec2 l9_470=sc_TransformUV(l9_460,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_471=l9_470.x;
float l9_472=l9_461;
sc_SoftwareWrapLate(l9_471,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,l9_455,l9_472);
float l9_473=l9_470.y;
float l9_474=l9_472;
sc_SoftwareWrapLate(l9_473,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,l9_455,l9_474);
float l9_475=l9_474;
vec3 l9_476=sc_SamplingCoordsViewToGlobal(vec2(l9_471,l9_473),materialParamsTexLayout,materialParamsTexGetStereoViewIndex());
vec4 l9_477=texture(materialParamsTexArrSC,l9_476,0.0);
vec4 l9_478;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_478=mix(materialParamsTexBorderColor,l9_477,vec4(l9_475));
}
#else
{
l9_478=l9_477;
...
#else
{
bool l9_479=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0));
float l9_480=l9_453.x;
sc_SoftwareWrapEarly(l9_480,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_481=l9_480;
float l9_482=l9_453.y;
sc_SoftwareWrapEarly(l9_482,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_483=l9_482;
vec2 l9_484;
float l9_485;
#if (SC_USE_UV_MIN_MAX_materialParamsTex)
...
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_486=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
l9_486=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_487=l9_481;
float l9_488=1.0;
sc_ClampUV(l9_487,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_486,l9_488);
float l9_489=l9_487;
float l9_490=l9_488;
bool l9_491;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_491=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
l9_491=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_492=l9_483;
float l9_493=l9_490;
sc_ClampUV(l9_492,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_491,l9_493);
l9_485=l9_493;
l9_484=vec2(l9_489,l9_492);
}
#else
{
l9_485=1.0;
l9_484=vec2(l9_481,l9_483);
}
#endif
vec2 l9_494=sc_TransformUV(l9_484,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_495=l9_494.x;
float l9_496=l9_485;
sc_SoftwareWrapLate(l9_495,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,l9_479,l9_496);
float l9_497=l9_494.y;
float l9_498=l9_496;
sc_SoftwareWrapLate(l9_497,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,l9_479,l9_498);
float l9_499=l9_498;
vec3 l9_500=sc_SamplingCoordsViewToGlobal(vec2(l9_495,l9_497),materialParamsTexLayout,materialParamsTexGetStereoViewIndex());
vec4 l9_501=texture(materialParamsTex,l9_500.xy,0.0);
vec4 l9_502;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_502=mix(materialParamsTexBorderColor,l9_501,vec4(l9_499));
}
#else
{
l9_502=l9_501;
...
#endif
float l9_504=clamp(l9_123,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
if (l9_504<alphaTestThreshold)
{
discard;
}
}
...
#if (ENABLE_STIPPLE_PATTERN_TEST)
{
if (l9_504<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
#endif
vec3 l9_505=max(l9_122.xyz,vec3(0.0));
vec4 l9_506;
#if (sc_ProjectiveShadowsCaster)
{
l9_506=vec4(l9_505,l9_504);
}
#else
{
l9_506=ngsCalculateLighting(l9_505,l9_504,l9_503,l9_7,l9_8,max(l9_450,vec3(0.0)),0.0,1.0,clamp(l9_452,vec3(0.0),vec3(1.0)),vec3(1.0));
}
#endif
vec4 l9_507=max(l9_506,vec4(0.0));
if (isProxyMode)
{
vec4 l9_508;
#if (sc_ProxyAlphaOne)
...
#endif
sc_writeFragData0Internal(max(l9_508,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_510;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_512=clamp(l9_507.w*2.0,0.0,1.0);
}
#else
{
float l9_513;
...
{
l9_513=clamp(dot(l9_507.xyz,vec3(l9_507.w)),0.0,1.0);
}
#else
{
float l9_514;
...
#if (sc_BlendMode_Multiply)
{
l9_515=(1.0-dot(l9_507.xyz,vec3(0.33333001)))*l9_507.w;
}
#else
{
float l9_516;
...
{
l9_516=(1.0-clamp(dot(l9_507.xyz,vec3(1.0)),0.0,1.0))*l9_507.w;
}
#else
{
float l9_517;
#if (sc_BlendMode_ColoredGlass)
{
l9_517=clamp(dot(l9_507.xyz,vec3(1.0)),0.0,1.0)*l9_507.w;
}
#else
{
float l9_518;
#if (sc_BlendMode_Add)
{
l9_518=clamp(dot(l9_507.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_519;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_519=clamp(dot(l9_507.xyz,vec3(1.0)),0.0,1.0)*l9_507.w;
}
#else
{
float l9_520;
...
{
l9_520=dot(l9_507.xyz,vec3(0.33333001))*l9_507.w;
}
#else
{
float l9_521;
#if (sc_BlendMode_Min)
{
l9_521=1.0-clamp(dot(l9_507.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_522;
#if (sc_BlendMode_Max)
{
l9_522=clamp(dot(l9_507.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_522=1.0;
...
#endif
l9_510=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_507.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_511);
}
#else
{
vec4 l9_523;
...
{
vec3 l9_525=sc_GetFramebufferColor().xyz;
vec3 l9_526=mix(l9_525,definedBlend(l9_525,l9_507.xyz).xyz,vec3(l9_507.w));
vec4 l9_527=vec4(l9_526.x,l9_526.y,l9_526.z,vec4(0.0).w);
l9_527.w=1.0;
l9_524=l9_527;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_529=l9_507.w;
l9_528=vec4(mix(vec3(1.0),l9_507.xyz,vec3(l9_529)),l9_529);
}
#else
{
vec4 l9_530;
...
{
float l9_531=l9_507.w;
float l9_532;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_532=clamp(l9_531,0.0,1.0);
}
#else
{
l9_532=l9_531;
...
#endif
l9_530=vec4(l9_507.xyz*l9_532,l9_532);
}
#else
{
l9_530=l9_507;
...
vec4 l9_535=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_533,vec4(0.0)));
vec4 l9_536=clamp(l9_535,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_537=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_537-0.0039215689)),min(1.0,l9_537+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_538=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_538).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_539=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_538).xy);
float l9_540=packValue(l9_539);
int l9_547=int(l9_536.w*255.0);
float l9_548=packValue(l9_547);
sc_writeFragData0Internal(vec4(packValue(l9_539),packValue(l9_539),packValue(l9_539),packValue(l9_539)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_540,packValue(l9_539),packValue(l9_539),packValue(l9_539)));
sc_writeFragData2(vec4(l9_548,packValue(l9_547),packValue(l9_547),packValue(l9_547)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_551=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_551).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_556==0)
{
l9_559=texture(sc_OITAlpha0,l9_551);
l9_558=texture(sc_OITDepthLow0,l9_551);
l9_557=texture(sc_OITDepthHigh0,l9_551);
}
else
{
l9_559=vec4(0.0);
...
if (l9_556==1)
{
l9_562=texture(sc_OITAlpha1,l9_551);
l9_561=texture(sc_OITDepthLow1,l9_551);
l9_560=texture(sc_OITDepthHigh1,l9_551);
}
else
{
l9_562=l9_559;
...
if (any(notEqual(l9_560,vec4(0.0)))||any(notEqual(l9_561,vec4(0.0))))
{
int l9_563[8]=l9_552;
unpackValues(l9_560.w,l9_556,l9_563);
unpackValues(l9_560.z,l9_556,l9_563);
unpackValues(l9_560.y,l9_556,l9_563);
unpackValues(l9_560.x,l9_556,l9_563);
unpackValues(l9_561.w,l9_556,l9_563);
unpackValues(l9_561.z,l9_556,l9_563);
unpackValues(l9_561.y,l9_556,l9_563);
unpackValues(l9_561.x,l9_556,l9_563);
int l9_572[8]=l9_553;
unpackValues(l9_562.w,l9_556,l9_572);
unpackValues(l9_562.z,l9_556,l9_572);
unpackValues(l9_562.y,l9_556,l9_572);
unpackValues(l9_562.x,l9_556,l9_572);
}
l9_556++;
continue;
}
...
vec4 l9_577=texture(sc_OITFilteredDepthBoundsTexture,l9_551);
vec2 l9_578=l9_577.xy;
int l9_579;
#if (sc_SkinBonesCount>0)
{
l9_579=encodeDepth(((1.0-l9_577.x)*1000.0)+getDepthOrderingEpsilon(),l9_578);
}
#else
{
l9_579=0;
...
#endif
int l9_580=encodeDepth(viewSpaceDepth(),l9_578);
vec4 l9_581;
l9_581=l9_536*l9_536.w;
vec4 l9_582;
int l9_583=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_583<8)
{
int l9_584=l9_552[l9_583];
int l9_585=l9_580-l9_579;
bool l9_586=l9_584<l9_585;
bool l9_587;
if (l9_586)
{
l9_587=l9_552[l9_583]>0;
}
else
{
l9_587=l9_586;
...
if (l9_587)
{
vec3 l9_588=l9_581.xyz*(1.0-(float(l9_553[l9_583])/255.0));
l9_582=vec4(l9_588.x,l9_588.y,l9_588.z,l9_581.w);
}
else
{
l9_582=l9_581;
...
sc_writeFragData0Internal(l9_581,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_536,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_535,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
