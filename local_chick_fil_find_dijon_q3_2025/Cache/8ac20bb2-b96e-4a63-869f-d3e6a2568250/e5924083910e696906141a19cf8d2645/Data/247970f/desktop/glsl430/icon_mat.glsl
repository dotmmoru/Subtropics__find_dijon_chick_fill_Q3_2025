...
//sampler sampler shapeTextureSmpSC 0:32
//sampler sampler strokeTextureSmpSC 0:33
...
//texture texture2D shapeTexture 0:19:0:32
//texture texture2D strokeTexture 0:20:0:33
...
//texture texture2DArray sc_ScreenTextureArrSC 0:40:0:29
//texture texture2DArray shapeTextureArrSC 0:41:0:32
//texture texture2DArray strokeTextureArrSC 0:42:0:33
...
//spec_const bool sc_ProxyAlphaOne 77 0
...
//spec_const bool shapeAspectFix 83 0
//spec_const bool shapeColorInvert 84 0
//spec_const bool shapeTextureHasSwappedViews 85 0
//spec_const bool strokeTextureHasSwappedViews 86 0
//spec_const bool toQuadShapeGrad 87 0
//spec_const bool toQuadStrokeGrad 88 0
//spec_const int NODE_161_DROPLIST_ITEM 89 0
//spec_const int NODE_164_DROPLIST_ITEM 90 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 91 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 92 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_shapeTexture 93 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_strokeTexture 94 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 95 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 96 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_shapeTexture 97 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_strokeTexture 98 -1
//spec_const int baseTexLayout 99 0
//spec_const int intensityTextureLayout 100 0
...
//spec_const int shapeTextureLayout 109 0
//spec_const int strokeTextureLayout 110 0
//SG_REFLECTION_END
#ifdef Active
#undef Active
#endif
...
float l9_3=float(Active);
float l9_4=float(Hover);
vec4 l9_5;
if ((max(l9_3,l9_4)*1.0)!=0.0)
{
vec4 l9_6;
Node337_If_else(0.0,vec4(0.0),vec4(0.0),l9_6,l9_2);
l9_5=l9_6;
}
else
{
vec4 l9_7;
Node337_If_else(0.0,vec4(0.0),vec4(0.0),l9_7,l9_2);
l9_5=l9_7*Port_Input1_N345;
}
...
{
vec2 l9_11=l9_0-Port_Center_N340;
vec2 l9_12=(l9_11*Port_Scale_N340)+Port_Center_N340;
vec4 l9_13;
#if (baseTexLayout==2)
{
...
#endif
l9_10=vec4(Port_Input_N339.x,Port_Input_N339.y,Port_Input_N339.z,l9_13.w);
}
else
{
vec2 l9_62=l9_0-Port_Center_N340;
vec2 l9_63=(l9_62*Port_Scale_N340)+Port_Center_N340;
vec4 l9_64;
#if (baseTexLayout==2)
{
...
#endif
l9_10=vec4(Port_Input_N006.x,Port_Input_N006.y,Port_Input_N006.z,l9_64.w);
}
vec3 l9_113=mix(l9_5.xyz,l9_10.xyz,vec3(l9_10.w));
float l9_114=clamp((l9_5.w+l9_10.w)+0.001,Port_Input1_N361+0.001,Port_Input2_N361+0.001)-0.001;
vec4 l9_115=vec4(l9_113.x,l9_113.y,l9_113.z,vec4(0.0).w);
l9_115.w=l9_114;
#if (sc_BlendMode_AlphaTest)
{
if (l9_114<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_114<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_116,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_118;
...
{
l9_120=clamp(l9_114*2.0,0.0,1.0);
}
#else
{
float l9_121;
...
{
l9_121=clamp(dot(l9_115.xyz,vec3(l9_114)),0.0,1.0);
}
#else
{
float l9_122;
...
{
l9_123=(1.0-dot(l9_115.xyz,vec3(0.33333001)))*l9_114;
}
#else
{
float l9_124;
...
{
l9_124=(1.0-clamp(dot(l9_115.xyz,vec3(1.0)),0.0,1.0))*l9_114;
}
#else
{
float l9_125;
...
{
l9_125=clamp(dot(l9_115.xyz,vec3(1.0)),0.0,1.0)*l9_114;
}
#else
{
float l9_126;
#if (sc_BlendMode_Add)
{
l9_126=clamp(dot(l9_115.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_127;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_127=clamp(dot(l9_115.xyz,vec3(1.0)),0.0,1.0)*l9_114;
}
#else
{
float l9_128;
...
{
l9_128=dot(l9_115.xyz,vec3(0.33333001))*l9_114;
}
#else
{
float l9_129;
#if (sc_BlendMode_Min)
{
l9_129=1.0-clamp(dot(l9_115.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_130;
#if (sc_BlendMode_Max)
{
l9_130=clamp(dot(l9_115.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_130=1.0;
...
#endif
l9_118=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_115.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_119);
}
#else
{
vec4 l9_131;
...
#if (sc_FramebufferFetch)
{
l9_133=sc_readFragData0_Platform();
}
#else
{
...
{
l9_135=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_134,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_135=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_134,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_133=l9_135;
}
#endif
vec3 l9_136=mix(l9_133.xyz,definedBlend(l9_133.xyz,l9_115.xyz).xyz,vec3(l9_114));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_138=vec4(mix(vec3(1.0),l9_115.xyz,vec3(l9_114)),l9_114);
}
#else
{
vec4 l9_139;
...
#endif
l9_139=vec4(l9_115.xyz*l9_140,l9_140);
}
#else
{
l9_139=l9_115;
...
vec4 l9_143=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_141,vec4(0.0)));
vec4 l9_144=clamp(l9_143,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_145=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_145-0.0039215689)),min(1.0,l9_145+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_146).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_147=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_146).xy);
float l9_148=packValue(l9_147);
int l9_155=int(l9_144.w*255.0);
float l9_156=packValue(l9_155);
sc_writeFragData0Internal(vec4(packValue(l9_147),packValue(l9_147),packValue(l9_147),packValue(l9_147)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_148,packValue(l9_147),packValue(l9_147),packValue(l9_147)));
sc_writeFragData2(vec4(l9_156,packValue(l9_155),packValue(l9_155),packValue(l9_155)));
...
if (l9_164==0)
{
l9_167=texture(sc_OITAlpha0,l9_159);
l9_166=texture(sc_OITDepthLow0,l9_159);
l9_165=texture(sc_OITDepthHigh0,l9_159);
}
else
{
l9_167=vec4(0.0);
...
if (l9_164==1)
{
l9_170=texture(sc_OITAlpha1,l9_159);
l9_169=texture(sc_OITDepthLow1,l9_159);
l9_168=texture(sc_OITDepthHigh1,l9_159);
}
else
{
l9_170=l9_167;
...
if (any(notEqual(l9_168,vec4(0.0)))||any(notEqual(l9_169,vec4(0.0))))
{
int l9_171[8]=l9_160;
unpackValues(l9_168.w,l9_164,l9_171);
unpackValues(l9_168.z,l9_164,l9_171);
unpackValues(l9_168.y,l9_164,l9_171);
unpackValues(l9_168.x,l9_164,l9_171);
unpackValues(l9_169.w,l9_164,l9_171);
unpackValues(l9_169.z,l9_164,l9_171);
unpackValues(l9_169.y,l9_164,l9_171);
unpackValues(l9_169.x,l9_164,l9_171);
int l9_180[8]=l9_161;
unpackValues(l9_170.w,l9_164,l9_180);
unpackValues(l9_170.z,l9_164,l9_180);
unpackValues(l9_170.y,l9_164,l9_180);
unpackValues(l9_170.x,l9_164,l9_180);
}
l9_164++;
continue;
}
...
vec4 l9_185=texture(sc_OITFilteredDepthBoundsTexture,l9_159);
vec2 l9_186=l9_185.xy;
int l9_187;
#if (sc_SkinBonesCount>0)
{
l9_187=encodeDepth(((1.0-l9_185.x)*1000.0)+getDepthOrderingEpsilon(),l9_186);
}
#else
{
l9_187=0;
...
#endif
int l9_188=encodeDepth(viewSpaceDepth(),l9_186);
vec4 l9_189;
l9_189=l9_144*l9_144.w;
vec4 l9_190;
int l9_191=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_191<8)
{
int l9_192=l9_160[l9_191];
int l9_193=l9_188-l9_187;
bool l9_194=l9_192<l9_193;
bool l9_195;
if (l9_194)
{
l9_195=l9_160[l9_191]>0;
}
else
{
l9_195=l9_194;
...
if (l9_195)
{
vec3 l9_196=l9_189.xyz*(1.0-(float(l9_161[l9_191])/255.0));
l9_190=vec4(l9_196.x,l9_196.y,l9_196.z,l9_189.w);
}
else
{
l9_190=l9_189;
...
sc_writeFragData0Internal(l9_189,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
#else
{
sc_writeFragData0Internal(l9_143,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
