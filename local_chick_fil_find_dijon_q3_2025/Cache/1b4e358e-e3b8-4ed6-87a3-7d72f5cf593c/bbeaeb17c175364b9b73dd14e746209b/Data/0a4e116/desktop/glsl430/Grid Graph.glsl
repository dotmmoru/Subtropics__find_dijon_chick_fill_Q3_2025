...
#endif
sc_writeFragData0Internal(max(l9_126,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_128;
...
#if (sc_FramebufferFetch)
{
l9_143=sc_readFragData0_Platform();
}
#else
{
...
vec4 l9_156=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_154,vec4(0.0)));
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_158-0.0039215689)),min(1.0,l9_158+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_160),packValue(l9_160),packValue(l9_160),packValue(l9_160)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_161,packValue(l9_160),packValue(l9_160),packValue(l9_160)));
sc_writeFragData2(vec4(l9_169,packValue(l9_168),packValue(l9_168),packValue(l9_168)));
...
sc_writeFragData0Internal(l9_202,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
