...
#if (ENABLE_MATERIAL_PARAM_TEX)
{
vec2 l9_451=N7_getUV(NODE_221_DROPLIST_ITEM);
#if (materialParamsTexLayout==2)
{
bool l9_452=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0));
float l9_453=l9_451.x;
sc_SoftwareWrapEarly(l9_453,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_454=l9_453;
float l9_455=l9_451.y;
sc_SoftwareWrapEarly(l9_455,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_456=l9_455;
vec2 l9_457;
float l9_458;
#if (SC_USE_UV_MIN_MAX_materialParamsTex)
...
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_459=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
l9_459=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_460=l9_454;
float l9_461=1.0;
sc_ClampUV(l9_460,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_459,l9_461);
float l9_462=l9_460;
float l9_463=l9_461;
bool l9_464;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_464=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
...
float l9_465=l9_456;
float l9_466=l9_463;
sc_ClampUV(l9_465,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_464,l9_466);
l9_458=l9_466;
l9_457=vec2(l9_462,l9_465);
}
#else
{
l9_458=1.0;
l9_457=vec2(l9_454,l9_456);
}
#endif
vec2 l9_467=sc_TransformUV(l9_457,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_468=l9_467.x;
float l9_469=l9_458;
sc_SoftwareWrapLate(l9_468,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,l9_452,l9_469);
float l9_470=l9_467.y;
float l9_471=l9_469;
sc_SoftwareWrapLate(l9_470,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,l9_452,l9_471);
}
#else
{
bool l9_472=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0));
float l9_473=l9_451.x;
sc_SoftwareWrapEarly(l9_473,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_474=l9_473;
float l9_475=l9_451.y;
sc_SoftwareWrapEarly(l9_475,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_476=l9_475;
vec2 l9_477;
float l9_478;
#if (SC_USE_UV_MIN_MAX_materialParamsTex)
...
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_479=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
l9_479=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_480=l9_474;
float l9_481=1.0;
sc_ClampUV(l9_480,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_479,l9_481);
float l9_482=l9_480;
float l9_483=l9_481;
bool l9_484;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_484=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
l9_484=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_485=l9_476;
float l9_486=l9_483;
sc_ClampUV(l9_485,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_484,l9_486);
l9_478=l9_486;
...
#endif
vec2 l9_487=sc_TransformUV(l9_477,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_488=l9_487.x;
float l9_489=l9_478;
sc_SoftwareWrapLate(l9_488,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,l9_472,l9_489);
float l9_490=l9_487.y;
float l9_491=l9_489;
sc_SoftwareWrapLate(l9_490,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,l9_472,l9_491);
}
#endif
}
#endif
...
#endif
float l9_493=clamp(l9_123,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
...
#endif
vec3 l9_494=max(l9_122.xyz,vec3(0.0));
vec4 l9_495;
#if (sc_ProjectiveShadowsCaster)
{
...
#else
{
l9_495=ngsCalculateLighting(l9_494,l9_493,l9_492,l9_7,l9_8,max(l9_450,vec3(0.0)),0.0,1.0,Port_AO_N036,vec3(1.0));
}
#endif
...
#endif
sc_writeFragData0Internal(max(l9_497,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_499;
#if (sc_ProjectiveShadowsCaster)
...
vec4 l9_524=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_522,vec4(0.0)));
vec4 l9_525=clamp(l9_524,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_526=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_526-0.0039215689)),min(1.0,l9_526+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_527=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_527).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_528=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_527).xy);
float l9_529=packValue(l9_528);
int l9_536=int(l9_525.w*255.0);
float l9_537=packValue(l9_536);
sc_writeFragData0Internal(vec4(packValue(l9_528),packValue(l9_528),packValue(l9_528),packValue(l9_528)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_529,packValue(l9_528),packValue(l9_528),packValue(l9_528)));
sc_writeFragData2(vec4(l9_537,packValue(l9_536),packValue(l9_536),packValue(l9_536)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_540=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_540).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_545==0)
{
l9_548=texture(sc_OITAlpha0,l9_540);
l9_547=texture(sc_OITDepthLow0,l9_540);
l9_546=texture(sc_OITDepthHigh0,l9_540);
}
else
{
l9_548=vec4(0.0);
...
if (l9_545==1)
{
l9_551=texture(sc_OITAlpha1,l9_540);
l9_550=texture(sc_OITDepthLow1,l9_540);
l9_549=texture(sc_OITDepthHigh1,l9_540);
}
else
{
l9_551=l9_548;
...
if (any(notEqual(l9_549,vec4(0.0)))||any(notEqual(l9_550,vec4(0.0))))
{
int l9_552[8]=l9_541;
unpackValues(l9_549.w,l9_545,l9_552);
unpackValues(l9_549.z,l9_545,l9_552);
unpackValues(l9_549.y,l9_545,l9_552);
unpackValues(l9_549.x,l9_545,l9_552);
unpackValues(l9_550.w,l9_545,l9_552);
unpackValues(l9_550.z,l9_545,l9_552);
unpackValues(l9_550.y,l9_545,l9_552);
unpackValues(l9_550.x,l9_545,l9_552);
int l9_561[8]=l9_542;
unpackValues(l9_551.w,l9_545,l9_561);
unpackValues(l9_551.z,l9_545,l9_561);
unpackValues(l9_551.y,l9_545,l9_561);
unpackValues(l9_551.x,l9_545,l9_561);
}
l9_545++;
continue;
}
...
vec4 l9_566=texture(sc_OITFilteredDepthBoundsTexture,l9_540);
vec2 l9_567=l9_566.xy;
int l9_568;
#if (sc_SkinBonesCount>0)
{
l9_568=encodeDepth(((1.0-l9_566.x)*1000.0)+getDepthOrderingEpsilon(),l9_567);
}
#else
{
l9_568=0;
...
#endif
int l9_569=encodeDepth(viewSpaceDepth(),l9_567);
vec4 l9_570;
l9_570=l9_525*l9_525.w;
vec4 l9_571;
int l9_572=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_572<8)
{
int l9_573=l9_541[l9_572];
int l9_574=l9_569-l9_568;
bool l9_575=l9_573<l9_574;
bool l9_576;
if (l9_575)
{
l9_576=l9_541[l9_572]>0;
}
else
{
l9_576=l9_575;
...
if (l9_576)
{
vec3 l9_577=l9_570.xyz*(1.0-(float(l9_542[l9_572])/255.0));
l9_571=vec4(l9_577.x,l9_577.y,l9_577.z,l9_570.w);
}
else
{
l9_571=l9_570;
...
sc_writeFragData0Internal(l9_570,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_525,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_524,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
