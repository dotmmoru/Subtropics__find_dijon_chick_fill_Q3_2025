...
//spec_const bool sc_ProxyAlphaOne 82 0
...
//spec_const int NODE_38_DROPLIST_ITEM 92 0
//spec_const int NODE_49_DROPLIST_ITEM 93 0
//spec_const int NODE_69_DROPLIST_ITEM 94 0
//spec_const int NODE_76_DROPLIST_ITEM 95 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_baseTex 96 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_emissiveTex 97 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 98 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_opacityTex 99 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_baseTex 100 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_emissiveTex 101 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 102 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_opacityTex 103 -1
//spec_const int baseTexLayout 104 0
//spec_const int emissiveTexLayout 105 0
//spec_const int intensityTextureLayout 106 0
//spec_const int opacityTexLayout 107 0
//spec_const int sc_DepthBufferMode 108 0
//spec_const int sc_RenderingSpace 109 -1
//spec_const int sc_ScreenTextureLayout 110 0
//spec_const int sc_ShaderCacheConstant 111 0
//spec_const int sc_SkinBonesCount 112 0
...
l9_2=l9_4.uv1;
l9_1=l9_4.color;
l9_0=((l9_5.xy/vec2(l9_5.w))*0.5)+vec2(0.5);
}
else
{
...
tempGlobals=ssGlobals(sc_Time.x,sc_Time.y,0.0,vec2(0.0),vec2(0.0),l9_3,l9_2,l9_1,l9_0);
...
#if (ENABLE_RECOLOR)
{
vec3 l9_58=((recolorRed*l9_6.x)+(recolorGreen*l9_6.y))+(recolorBlue*l9_6.z);
l9_57=vec4(l9_58.x,l9_58.y,l9_58.z,l9_6.w);
}
#else
{
l9_57=l9_6;
...
{
bool l9_62=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_63=l9_60.x;
...
float l9_78=l9_77.x;
float l9_79=l9_68;
sc_SoftwareWrapLate(l9_78,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_62,l9_79);
float l9_80=l9_77.y;
float l9_81=l9_79;
sc_SoftwareWrapLate(l9_80,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_62,l9_81);
float l9_82=l9_81;
...
#else
{
bool l9_86=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_87=l9_60.x;
sc_SoftwareWrapEarly(l9_87,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_88=l9_87;
float l9_89=l9_60.y;
sc_SoftwareWrapEarly(l9_89,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_90=l9_89;
vec2 l9_91;
float l9_92;
#if (SC_USE_UV_MIN_MAX_opacityTex)
...
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_93=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
l9_93=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_94=l9_88;
float l9_95=1.0;
sc_ClampUV(l9_94,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_93,l9_95);
float l9_96=l9_94;
float l9_97=l9_95;
bool l9_98;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_98=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
...
float l9_99=l9_90;
float l9_100=l9_97;
sc_ClampUV(l9_99,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_98,l9_100);
l9_92=l9_100;
...
#endif
vec2 l9_101=sc_TransformUV(l9_91,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_102=l9_101.x;
float l9_103=l9_92;
sc_SoftwareWrapLate(l9_102,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_86,l9_103);
float l9_104=l9_101.y;
float l9_105=l9_103;
sc_SoftwareWrapLate(l9_104,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_86,l9_105);
float l9_106=l9_105;
vec3 l9_107=sc_SamplingCoordsViewToGlobal(vec2(l9_102,l9_104),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_108=texture(opacityTex,l9_107.xy,0.0);
vec4 l9_109;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_109=mix(opacityTexBorderColor,l9_108,vec4(l9_106));
}
#else
{
l9_109=l9_108;
...
#endif
float l9_110=l9_59*l9_57.w;
vec4 l9_111;
float l9_112;
if (NODE_38_DROPLIST_ITEM==1)
{
l9_112=l9_110*tempGlobals.VertexColor.w;
l9_111=l9_57*tempGlobals.VertexColor;
}
else
{
l9_112=l9_110;
...
#if (ENABLE_EMISSIVE)
{
vec2 l9_114=N7_getUV(NODE_76_DROPLIST_ITEM);
vec4 l9_115;
#if (emissiveTexLayout==2)
{
bool l9_116=(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_emissiveTex)!=0));
float l9_117=l9_114.x;
sc_SoftwareWrapEarly(l9_117,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).x);
float l9_118=l9_117;
float l9_119=l9_114.y;
sc_SoftwareWrapEarly(l9_119,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).y);
float l9_120=l9_119;
vec2 l9_121;
float l9_122;
...
{
l9_123=ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).x==3;
}
#else
{
l9_123=(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0);
}
#endif
float l9_124=l9_118;
float l9_125=1.0;
sc_ClampUV(l9_124,emissiveTexUvMinMax.x,emissiveTexUvMinMax.z,l9_123,l9_125);
float l9_126=l9_124;
float l9_127=l9_125;
bool l9_128;
#if (SC_USE_CLAMP_TO_BORDER_emissiveTex)
{
l9_128=ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).y==3;
}
#else
{
l9_128=(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0);
}
#endif
float l9_129=l9_120;
float l9_130=l9_127;
sc_ClampUV(l9_129,emissiveTexUvMinMax.y,emissiveTexUvMinMax.w,l9_128,l9_130);
l9_122=l9_130;
...
#endif
vec2 l9_131=sc_TransformUV(l9_121,(int(SC_USE_UV_TRANSFORM_emissiveTex)!=0),emissiveTexTransform);
float l9_132=l9_131.x;
float l9_133=l9_122;
sc_SoftwareWrapLate(l9_132,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).x,l9_116,l9_133);
float l9_134=l9_131.y;
float l9_135=l9_133;
sc_SoftwareWrapLate(l9_134,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).y,l9_116,l9_135);
float l9_136=l9_135;
vec3 l9_137=sc_SamplingCoordsViewToGlobal(vec2(l9_132,l9_134),emissiveTexLayout,emissiveTexGetStereoViewIndex());
vec4 l9_138=texture(emissiveTexArrSC,l9_137,0.0);
vec4 l9_139;
#if (SC_USE_CLAMP_TO_BORDER_emissiveTex)
{
l9_139=mix(emissiveTexBorderColor,l9_138,vec4(l9_136));
}
#else
{
l9_139=l9_138;
...
#else
{
bool l9_140=(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_emissiveTex)!=0));
float l9_141=l9_114.x;
sc_SoftwareWrapEarly(l9_141,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).x);
float l9_142=l9_141;
float l9_143=l9_114.y;
sc_SoftwareWrapEarly(l9_143,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).y);
float l9_144=l9_143;
vec2 l9_145;
float l9_146;
#if (SC_USE_UV_MIN_MAX_emissiveTex)
...
#if (SC_USE_CLAMP_TO_BORDER_emissiveTex)
{
l9_147=ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).x==3;
}
#else
{
l9_147=(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0);
}
#endif
float l9_148=l9_142;
float l9_149=1.0;
sc_ClampUV(l9_148,emissiveTexUvMinMax.x,emissiveTexUvMinMax.z,l9_147,l9_149);
float l9_150=l9_148;
float l9_151=l9_149;
bool l9_152;
#if (SC_USE_CLAMP_TO_BORDER_emissiveTex)
{
l9_152=ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).y==3;
}
#else
{
l9_152=(int(SC_USE_CLAMP_TO_BORDER_emissiveTex)!=0);
}
#endif
float l9_153=l9_144;
float l9_154=l9_151;
sc_ClampUV(l9_153,emissiveTexUvMinMax.y,emissiveTexUvMinMax.w,l9_152,l9_154);
l9_146=l9_154;
...
#endif
vec2 l9_155=sc_TransformUV(l9_145,(int(SC_USE_UV_TRANSFORM_emissiveTex)!=0),emissiveTexTransform);
float l9_156=l9_155.x;
float l9_157=l9_146;
sc_SoftwareWrapLate(l9_156,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).x,l9_140,l9_157);
float l9_158=l9_155.y;
float l9_159=l9_157;
sc_SoftwareWrapLate(l9_158,ivec2(SC_SOFTWARE_WRAP_MODE_U_emissiveTex,SC_SOFTWARE_WRAP_MODE_V_emissiveTex).y,l9_140,l9_159);
float l9_160=l9_159;
vec3 l9_161=sc_SamplingCoordsViewToGlobal(vec2(l9_156,l9_158),emissiveTexLayout,emissiveTexGetStereoViewIndex());
vec4 l9_162=texture(emissiveTex,l9_161.xy,0.0);
vec4 l9_163;
#if (SC_USE_CLAMP_TO_BORDER_emissiveTex)
{
l9_163=mix(emissiveTexBorderColor,l9_162,vec4(l9_160));
}
#else
{
l9_163=l9_162;
...
#endif
bool l9_164=NODE_38_DROPLIST_ITEM==2;
vec3 l9_165;
if (l9_164)
{
l9_165=l9_113+tempGlobals.VertexColor.xyz;
}
else
{
l9_165=l9_113;
...
vec3 l9_166;
if (l9_164||(int(ENABLE_EMISSIVE)!=0))
{
l9_166=ssPow((l9_165*emissiveColor)*vec3(emissiveIntensity),vec3(2.2));
}
else
{
l9_166=l9_165;
}
vec3 l9_167=l9_111.xyz+ssPow((l9_166+vec3(0.0))+vec3(0.0),vec3(0.45454547));
vec4 l9_168=vec4(l9_167.x,l9_167.y,l9_167.z,vec4(0.0).w);
l9_168.w=l9_112;
#if (sc_BlendMode_AlphaTest)
{
if (l9_112<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_112<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_169,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_171;
...
{
l9_173=clamp(l9_112*2.0,0.0,1.0);
}
#else
{
float l9_174;
...
{
l9_174=clamp(dot(l9_168.xyz,vec3(l9_112)),0.0,1.0);
}
#else
{
float l9_175;
...
{
l9_176=(1.0-dot(l9_168.xyz,vec3(0.33333001)))*l9_112;
}
#else
{
float l9_177;
...
{
l9_177=(1.0-clamp(dot(l9_168.xyz,vec3(1.0)),0.0,1.0))*l9_112;
}
#else
{
float l9_178;
...
{
l9_178=clamp(dot(l9_168.xyz,vec3(1.0)),0.0,1.0)*l9_112;
}
#else
{
float l9_179;
#if (sc_BlendMode_Add)
{
l9_179=clamp(dot(l9_168.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_180;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_180=clamp(dot(l9_168.xyz,vec3(1.0)),0.0,1.0)*l9_112;
}
#else
{
float l9_181;
...
{
l9_181=dot(l9_168.xyz,vec3(0.33333001))*l9_112;
}
#else
{
float l9_182;
#if (sc_BlendMode_Min)
{
l9_182=1.0-clamp(dot(l9_168.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_183;
#if (sc_BlendMode_Max)
{
l9_183=clamp(dot(l9_168.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_183=1.0;
...
#endif
l9_171=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_168.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_172);
}
#else
{
vec4 l9_184;
...
#if (sc_FramebufferFetch)
{
l9_186=sc_readFragData0_Platform();
}
#else
{
...
{
l9_188=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_187,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_188=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_187,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_186=l9_188;
}
#endif
vec3 l9_189=mix(l9_186.xyz,definedBlend(l9_186.xyz,l9_168.xyz).xyz,vec3(l9_112));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_191=vec4(mix(vec3(1.0),l9_168.xyz,vec3(l9_112)),l9_112);
}
#else
{
vec4 l9_192;
...
#endif
l9_192=vec4(l9_168.xyz*l9_193,l9_193);
}
#else
{
l9_192=l9_168;
...
vec4 l9_196=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_194,vec4(0.0)));
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_199=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_199).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_200=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_199).xy);
...
#if (sc_OITCompositingPass)
{
vec2 l9_212=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_212).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_217==0)
{
l9_220=texture(sc_OITAlpha0,l9_212);
l9_219=texture(sc_OITDepthLow0,l9_212);
l9_218=texture(sc_OITDepthHigh0,l9_212);
}
else
{
l9_220=vec4(0.0);
...
if (l9_217==1)
{
l9_223=texture(sc_OITAlpha1,l9_212);
l9_222=texture(sc_OITDepthLow1,l9_212);
l9_221=texture(sc_OITDepthHigh1,l9_212);
}
else
{
l9_223=l9_220;
...
vec4 l9_238=texture(sc_OITFilteredDepthBoundsTexture,l9_212);
