...
//spec_const bool sc_ProxyAlphaOne 74 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_V_opacityTex 85 -1
//spec_const int baseTexLayout 86 0
//spec_const int intensityTextureLayout 87 0
//spec_const int opacityTexLayout 88 0
...
vec4 l9_76=texture(opacityTexArrSC,l9_75,0.0);
vec4 l9_77;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
...
#else
{
bool l9_78=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_79=l9_0.x;
sc_SoftwareWrapEarly(l9_79,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_80=l9_79;
float l9_81=l9_0.y;
sc_SoftwareWrapEarly(l9_81,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_82=l9_81;
vec2 l9_83;
float l9_84;
#if (SC_USE_UV_MIN_MAX_opacityTex)
...
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_85=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
...
float l9_86=l9_80;
float l9_87=1.0;
sc_ClampUV(l9_86,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_85,l9_87);
float l9_88=l9_86;
float l9_89=l9_87;
bool l9_90;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_90=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
...
float l9_91=l9_82;
float l9_92=l9_89;
sc_ClampUV(l9_91,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_90,l9_92);
l9_84=l9_92;
...
#endif
vec2 l9_93=sc_TransformUV(l9_83,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_94=l9_93.x;
float l9_95=l9_84;
sc_SoftwareWrapLate(l9_94,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_78,l9_95);
float l9_96=l9_93.y;
float l9_97=l9_95;
sc_SoftwareWrapLate(l9_96,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_78,l9_97);
float l9_98=l9_97;
vec3 l9_99=sc_SamplingCoordsViewToGlobal(vec2(l9_94,l9_96),opacityTexLayout,opacityTexGetStereoViewIndex());
vec4 l9_100=texture(opacityTex,l9_99.xy,0.0);
vec4 l9_101;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_101=mix(opacityTexBorderColor,l9_100,vec4(l9_98));
}
#else
{
l9_101=l9_100;
...
#endif
vec4 l9_102=vec4(l9_2.x,l9_2.y,l9_2.z,vec4(0.0).w);
l9_102.w=l9_52.x;
vec4 l9_103=baseColor*l9_102;
float l9_104=l9_103.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_104<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_104<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_105,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_107;
...
{
l9_109=clamp(l9_104*2.0,0.0,1.0);
}
#else
{
float l9_110;
...
{
l9_110=clamp(dot(l9_103.xyz,vec3(l9_104)),0.0,1.0);
}
#else
{
float l9_111;
...
{
l9_112=(1.0-dot(l9_103.xyz,vec3(0.33333001)))*l9_104;
}
#else
{
float l9_113;
...
{
l9_113=(1.0-clamp(dot(l9_103.xyz,vec3(1.0)),0.0,1.0))*l9_104;
}
#else
{
float l9_114;
...
{
l9_114=clamp(dot(l9_103.xyz,vec3(1.0)),0.0,1.0)*l9_104;
}
#else
{
float l9_115;
#if (sc_BlendMode_Add)
{
l9_115=clamp(dot(l9_103.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_116;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_116=clamp(dot(l9_103.xyz,vec3(1.0)),0.0,1.0)*l9_104;
}
#else
{
float l9_117;
...
{
l9_117=dot(l9_103.xyz,vec3(0.33333001))*l9_104;
}
#else
{
float l9_118;
#if (sc_BlendMode_Min)
{
l9_118=1.0-clamp(dot(l9_103.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_119;
#if (sc_BlendMode_Max)
{
l9_119=clamp(dot(l9_103.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_119=1.0;
...
#endif
l9_107=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_103.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_108);
}
#else
{
vec4 l9_120;
...
#if (sc_FramebufferFetch)
{
l9_122=sc_readFragData0_Platform();
}
#else
{
...
{
l9_124=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_123,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_124=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_123,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_122=l9_124;
}
#endif
vec3 l9_125=mix(l9_122.xyz,definedBlend(l9_122.xyz,l9_103.xyz).xyz,vec3(l9_104));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_127=vec4(mix(vec3(1.0),l9_103.xyz,vec3(l9_104)),l9_104);
}
#else
{
vec4 l9_128;
...
#endif
l9_128=vec4(l9_103.xyz*l9_129,l9_129);
}
#else
{
l9_128=l9_103;
...
vec4 l9_132=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_130,vec4(0.0)));
vec4 l9_133=clamp(l9_132,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_134=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_134-0.0039215689)),min(1.0,l9_134+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_135).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_136=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_135).xy);
float l9_137=packValue(l9_136);
int l9_144=int(l9_133.w*255.0);
float l9_145=packValue(l9_144);
sc_writeFragData0Internal(vec4(packValue(l9_136),packValue(l9_136),packValue(l9_136),packValue(l9_136)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_137,packValue(l9_136),packValue(l9_136),packValue(l9_136)));
sc_writeFragData2(vec4(l9_145,packValue(l9_144),packValue(l9_144),packValue(l9_144)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_148).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_153==0)
{
l9_156=texture(sc_OITAlpha0,l9_148);
l9_155=texture(sc_OITDepthLow0,l9_148);
l9_154=texture(sc_OITDepthHigh0,l9_148);
}
else
{
l9_156=vec4(0.0);
...
if (l9_153==1)
{
l9_159=texture(sc_OITAlpha1,l9_148);
l9_158=texture(sc_OITDepthLow1,l9_148);
l9_157=texture(sc_OITDepthHigh1,l9_148);
}
else
{
l9_159=l9_156;
...
if (any(notEqual(l9_157,vec4(0.0)))||any(notEqual(l9_158,vec4(0.0))))
{
int l9_160[8]=l9_149;
unpackValues(l9_157.w,l9_153,l9_160);
unpackValues(l9_157.z,l9_153,l9_160);
unpackValues(l9_157.y,l9_153,l9_160);
unpackValues(l9_157.x,l9_153,l9_160);
unpackValues(l9_158.w,l9_153,l9_160);
unpackValues(l9_158.z,l9_153,l9_160);
unpackValues(l9_158.y,l9_153,l9_160);
unpackValues(l9_158.x,l9_153,l9_160);
int l9_169[8]=l9_150;
unpackValues(l9_159.w,l9_153,l9_169);
unpackValues(l9_159.z,l9_153,l9_169);
unpackValues(l9_159.y,l9_153,l9_169);
unpackValues(l9_159.x,l9_153,l9_169);
}
l9_153++;
continue;
}
...
vec4 l9_174=texture(sc_OITFilteredDepthBoundsTexture,l9_148);
vec2 l9_175=l9_174.xy;
int l9_176;
#if (sc_SkinBonesCount>0)
{
l9_176=encodeDepth(((1.0-l9_174.x)*1000.0)+getDepthOrderingEpsilon(),l9_175);
}
#else
{
l9_176=0;
...
#endif
int l9_177=encodeDepth(viewSpaceDepth(),l9_175);
vec4 l9_178;
l9_178=l9_133*l9_133.w;
vec4 l9_179;
int l9_180=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_180<8)
{
int l9_181=l9_149[l9_180];
int l9_182=l9_177-l9_176;
bool l9_183=l9_181<l9_182;
bool l9_184;
if (l9_183)
{
l9_184=l9_149[l9_180]>0;
}
else
{
l9_184=l9_183;
...
if (l9_184)
{
vec3 l9_185=l9_178.xyz*(1.0-(float(l9_150[l9_180])/255.0));
l9_179=vec4(l9_185.x,l9_185.y,l9_185.z,l9_178.w);
}
else
{
l9_179=l9_178;
...
#else
{
sc_writeFragData0Internal(l9_132,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
