...
#if (sc_FramebufferFetch)
{
l9_319=sc_readFragData0_Platform();
}
#else
{
vec2 l9_320=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
vec4 l9_321;
#if (sc_ScreenTextureLayout==2)
{
l9_321=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_320,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()),0.0);
}
#else
{
l9_321=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_320,sc_ScreenTextureLayout,sc_ScreenTextureGetStereoViewIndex()).xy,0.0);
}
#endif
l9_319=l9_321;
}
#endif
vec3 l9_322=mix(l9_319.xyz,definedBlend(l9_319.xyz,l9_3.xyz).xyz,vec3(l9_3.w));
vec4 l9_323=vec4(l9_322.x,l9_322.y,l9_322.z,vec4(0.0).w);
l9_323.w=1.0;
l9_318=l9_323;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_324=vec4(mix(vec3(1.0),l9_3.xyz,vec3(l9_3.w)),l9_3.w);
}
#else
{
vec4 l9_325;
...
#endif
l9_325=vec4(l9_3.xyz*l9_326,l9_326);
}
#else
{
l9_325=l9_3;
...
vec4 l9_329=sc_OutputMotionVectorsIfNeeded(varPos,max(l9_327,vec4(0.0)));
vec4 l9_330=clamp(l9_329,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_331=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_331-0.0039215689)),min(1.0,l9_331+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_332=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_332).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_333=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_332).xy);
float l9_334=packValue(l9_333);
int l9_341=int(l9_330.w*255.0);
float l9_342=packValue(l9_341);
sc_writeFragData0Internal(vec4(packValue(l9_333),packValue(l9_333),packValue(l9_333),packValue(l9_333)),sc_UniformConstants.x,sc_ShaderCacheConstant);
sc_writeFragData1(vec4(l9_334,packValue(l9_333),packValue(l9_333),packValue(l9_333)));
sc_writeFragData2(vec4(l9_342,packValue(l9_341),packValue(l9_341),packValue(l9_341)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_345=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_345).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_350==0)
{
l9_353=texture(sc_OITAlpha0,l9_345);
l9_352=texture(sc_OITDepthLow0,l9_345);
l9_351=texture(sc_OITDepthHigh0,l9_345);
}
else
{
l9_353=vec4(0.0);
...
if (l9_350==1)
{
l9_356=texture(sc_OITAlpha1,l9_345);
l9_355=texture(sc_OITDepthLow1,l9_345);
l9_354=texture(sc_OITDepthHigh1,l9_345);
}
else
{
l9_356=l9_353;
...
if (any(notEqual(l9_354,vec4(0.0)))||any(notEqual(l9_355,vec4(0.0))))
{
int l9_357[8]=l9_346;
unpackValues(l9_354.w,l9_350,l9_357);
unpackValues(l9_354.z,l9_350,l9_357);
unpackValues(l9_354.y,l9_350,l9_357);
unpackValues(l9_354.x,l9_350,l9_357);
unpackValues(l9_355.w,l9_350,l9_357);
unpackValues(l9_355.z,l9_350,l9_357);
unpackValues(l9_355.y,l9_350,l9_357);
unpackValues(l9_355.x,l9_350,l9_357);
int l9_366[8]=l9_347;
unpackValues(l9_356.w,l9_350,l9_366);
unpackValues(l9_356.z,l9_350,l9_366);
unpackValues(l9_356.y,l9_350,l9_366);
unpackValues(l9_356.x,l9_350,l9_366);
}
l9_350++;
continue;
}
...
vec4 l9_371=texture(sc_OITFilteredDepthBoundsTexture,l9_345);
vec2 l9_372=l9_371.xy;
int l9_373;
#if (sc_SkinBonesCount>0)
{
l9_373=encodeDepth(((1.0-l9_371.x)*1000.0)+getDepthOrderingEpsilon(),l9_372);
}
#else
{
l9_373=0;
...
#endif
int l9_374=encodeDepth(viewSpaceDepth(),l9_372);
vec4 l9_375;
l9_375=l9_330*l9_330.w;
vec4 l9_376;
int l9_377=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_377<8)
{
int l9_378=l9_346[l9_377];
int l9_379=l9_374-l9_373;
bool l9_380=l9_378<l9_379;
bool l9_381;
if (l9_380)
{
l9_381=l9_346[l9_377]>0;
}
else
{
l9_381=l9_380;
...
if (l9_381)
{
vec3 l9_382=l9_375.xyz*(1.0-(float(l9_347[l9_377])/255.0));
l9_376=vec4(l9_382.x,l9_382.y,l9_382.z,l9_375.w);
}
else
{
l9_376=l9_375;
...
sc_writeFragData0Internal(l9_375,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
...
sc_writeFragData0Internal(l9_330,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
{
sc_writeFragData0Internal(l9_329,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#endif
